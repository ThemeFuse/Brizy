...
export const Icons = {
  ...
  [IconsName.TextAlignCenter]: TextAlignCenter,
  [IconsName.TextAlignLeft]: TextAlignLeft,
  [IconsName.TextAlignRight]: TextAlignRight,
  [IconsName.PlusCircle]: PlusCircle,
  [IconsName.Reverse]: Reverse,
  [IconsName.Duplicate]: Duplicate,
  [IconsName.CheckCircle]: CheckCircle,
  [IconsName.Settings]: Settings,
  [IconsName.Close]: Close,
  [IconsName.StreUp]: StreUp,
  [IconsName.StreDown]: StreDown,
  [IconsName.Circle2]: Circle2,
  [IconsName.CircleRemove]: CircleRemove,
