...
import { AutoCorrectingInputMultiInput } from "../variants";

export default {
  title: "Selection and Input/AutoCorrectingInput/MultiInput",
...
const MultiInputTemplate: ComponentStory<
  typeof AutoCorrectingInputMultiInput
> = (args) => {
