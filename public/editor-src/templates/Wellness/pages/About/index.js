module.exports = {
  ...
  title: "About",
  keywords:
    "about, about us, history, team, Health & Beauty, Medical, Hospital, Clinic, Doctor, Dentist, Wellness",
  cat: [0, 13],
  pro: true,
  resolve: {
    blocks: [
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<h1 class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color8">We are&nbsp;</span><strong class="brz-cp-color8">WellNess</strong><span class="brz-cp-color8"> Clinic</span></h1>'
                          }
                        }
                      ],
                      marginBottom: 0,
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<p class="brz-text-lg-center brz-tp-heading5"><span class="brz-cp-color6">More than 50 experienced doctors and specialists in their fields</span></p>'
                          }
                        }
                      ],
                      marginTop: 0,
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color1">Helping You&nbsp;</span><strong class="brz-cp-color1">Get Better</strong><span class="brz-cp-color1"> Since 2004</span></h2>'
                          }
                        }
                      ],
                      marginBottom: 0
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<p class="brz-text-lg-center brz-tp-subtitle"><span class="brz-cp-color7">More than 50 specialists in their fields are here to aid you.</span></p>'
                          }
                        }
                      ],
                      marginTop: 0
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        ...
                                        imageHeight: 400,
                                        imageSrc:
                                          "a75ee08b873a91145e4ecdc43bf8e6df.jpg",
                                        height: 100,
                                        positionX: 51,
                                        positionY: 88,
                                        imagePopulation: ""
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-paragraph"><span class="brz-cp-color7">Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae adipiscing elit. Vivamus luctus urna sed urna ultricies ac tempor dui sagittis. In condimentum facilisis porta. Sed nec diam eu diam mattis viverra.</span></p>'
                                      }
                                    }
                                  ]
                                }
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<h2 class="brz-mb-lg-0 brz-tp-heading2 brz-text-lg-center"><span class="brz-cp-color2">Meet our&nbsp;</span><strong class="brz-cp-color2">Experienced Team</strong><span class="brz-cp-color2"> of Doctors</span></h2>'
                          }
                        }
                      ],
                      marginBottom: 0,
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<p class="brz-tp-subtitle brz-text-lg-center"><span class="brz-cp-color4">Experienced doctors and Scientist form our medical staff</span></p>'
                          }
                        }
                      ],
                      marginTop: 0
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h5 class="brz-tp-heading5 brz-text-lg-center brz-mt-lg-10 brz-mb-lg-5"><span class="brz-cp-color1">Ph.D. Phillip Sudders</span></h5>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<h2 class="brz-text-lg-center brz-mb-lg-0 brz-tp-heading2"><span class="brz-cp-color3">Check out&nbsp;</span><strong class="brz-cp-color3">Our Services&nbsp;</strong></h2>'
                          }
                        }
                      ],
                      marginBottom: 0,
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<p class="brz-text-lg-center brz-mb-lg-5 brz-tp-subtitle brz-mt-lg-5"><span class="brz-cp-color5">Services from a wide variety of medical fields</span></p>'
                          }
                        }
                      ],
                      marginTop: 0
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h6 class="brz-tp-heading6 brz-mb-lg-0 brz-mt-lg-0 brz-text-lg-center"><span class="brz-cp-color1">Neonatology</span></h6>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h6 class="brz-tp-heading6 brz-mb-lg-0 brz-mt-lg-0 brz-text-lg-center"><span class="brz-cp-color1">Cardiology</span></h6>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h6 class="brz-tp-heading6 brz-mb-lg-0 brz-mt-lg-0 brz-text-lg-center"><span class="brz-cp-color1">Emergency Medicine</span></h6>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h6 class="brz-tp-heading6 brz-text-lg-center brz-mt-lg-0 brz-mb-lg-0"><span class="brz-cp-color1">Oncology</span></h6>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h6 class="brz-tp-heading6 brz-mb-lg-0 brz-mt-lg-0 brz-text-lg-center"><span class="brz-cp-color1">Orthopedics</span></h6>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h6 class="brz-tp-heading6 brz-mb-lg-0 brz-mt-lg-0 brz-text-lg-center"><span class="brz-cp-color1">Surgery</span></h6>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
