module.exports = {
  ...
  title: "Services",
  keywords:
    "services, features, Health & Beauty, Medical, Hospital, Clinic, Doctor, Dentist, Wellness",
  cat: [0, 13],
  pro: true,
  resolve: {
    blocks: [
          ...
          items: [
            {
              ...
              value: {
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<h1 class="brz-text-lg-center brz-tp-heading1"><span class="brz-cp-color8">Wide variety of&nbsp;</span><strong class="brz-cp-color8">Services</strong><span class="brz-cp-color8"> offered</span></h1>'
                          }
                        }
                      ],
                      marginBottom: 0,
                ...
                bgColorHex: "#10838f",
                bgColorOpacity: 0.7600000000000000088817841970012523233890533447265625,
                tempBgColorOpacity: 0.7600000000000000088817841970012523233890533447265625,
                paddingTop: 109,
                paddingBottom: 146,
                bgImageWidth: 1920,
                bgImageHeight: 700,
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<h2 class="brz-tp-heading2 brz-mb-lg-0 brz-text-lg-center"><span class="brz-cp-color1">Check out&nbsp;</span><strong class="brz-cp-color1">Our Services&nbsp;</strong></h2>'
                          }
                        }
                      ],
                      marginBottom: 0,
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<p class="brz-tp-subtitle brz-mb-lg-5 brz-mt-lg-10 brz-text-lg-center"><span class="brz-cp-color5">Services from a wide variety of medical fields</span></p>'
                          }
                        }
                      ],
                      marginTop: 0
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h6 class="brz-text-lg-center brz-mt-lg-0 brz-mb-lg-0 brz-tp-heading6"><span class="brz-cp-color1">Nursery</span></h6>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h6 class="brz-text-lg-center brz-mt-lg-0 brz-mb-lg-0 brz-tp-heading6"><span class="brz-cp-color1">Laboratory</span></h6>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h6 class="brz-text-lg-center brz-mt-lg-0 brz-mb-lg-0 brz-tp-heading6"><span class="brz-cp-color1">Radiography</span></h6>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
