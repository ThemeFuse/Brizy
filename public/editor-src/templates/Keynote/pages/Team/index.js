                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h1 class="brz-text-xs-center brz-text-lg-right brz-mb-lg-0 brz-tp-heading1"><span class="brz-cp-color8">OUR</span></h1>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h1 class="brz-text-xs-center brz-text-lg-left brz-mb-lg-0 brz-tp-heading1"><span class="brz-cp-color8">TEAM</span></h1>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<h2 class="brz-text-xs-center brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color3">THE PEOPLE BEHIND THE CURTAINS</span></h2>'
                          }
                        }
                      ]
                    }
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["image"],
                                        imageSrc:
                                          "ad83cbd0ca71eff06446b718861b3b11.jpg",
                                        imageWidth: 500,
                                        imageHeight: 500,
                                        borderRadiusType: "square",
                                        borderRadius: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h6 class="brz-text-lg-left brz-tp-heading6"><span class="brz-cp-color3">JACK RICHMOND</span></h6>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["image"],
                                        imageSrc:
                                          "eda84c0a1cf46c558b6925c5f8abb2ae.jpg",
                                        imageWidth: 500,
                                        imageHeight: 500,
                                        borderRadiusType: "square",
                                        borderRadius: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h6 class="brz-text-lg-left brz-tp-heading6"><span class="brz-cp-color3">DEANA ABBADI</span></h6>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-subtitle brz-text-lg-left"><span class="brz-cp-color6">Designer, Illustrator &amp; Author</span></p>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["image"],
                                        imageSrc:
                                          "2b0231c05877c1d12c8bc176d0bedee3.jpg",
                                        imageWidth: 500,
                                        imageHeight: 500,
                                        borderRadiusType: "square",
                                        borderRadius: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h6 class="brz-text-lg-left brz-tp-heading6"><span class="brz-cp-color3">RONA THANOS</span></h6>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["image"],
                                        imageSrc:
                                          "cef8436fa8bf35e94bf2b7b57a071097.jpg",
                                        imageWidth: 500,
                                        imageHeight: 500,
                                        borderRadiusType: "square",
                                        borderRadius: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h6 class="brz-text-lg-left brz-tp-heading6"><span class="brz-cp-color3">MATEO WELDT</span></h6>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
