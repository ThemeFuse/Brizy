                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h1 class="brz-text-xs-center brz-text-lg-right brz-mb-lg-0 brz-tp-heading1"><span class="brz-cp-color8">VIEW THE</span></h1>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h1 class="brz-text-xs-center brz-text-lg-left brz-mb-lg-0 brz-tp-heading1"><span class="brz-cp-color8">SCHEDULE</span></h1>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                      ...
                      items: [
                        {
                          ...
                          value: {
                            ...
                            linkExternal:
                              "https://demo.themefuse.com/keynote/?page_id=1235"
                          }
                        }
                      ],
