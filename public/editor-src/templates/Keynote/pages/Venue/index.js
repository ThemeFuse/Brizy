                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h1 class="brz-text-xs-center brz-tp-heading1 brz-mb-lg-0 brz-text-lg-right"><span class="brz-cp-color8">VISIT THE</span></h1>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h1 class="brz-text-xs-center brz-tp-heading1 brz-mb-lg-0 brz-text-lg-left"><span class="brz-cp-color8">LOCATION</span></h1>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h2 class="brz-tp-heading2"><span class="brz-cp-color3">AUDITORIUM PALLADY</span></h2>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-heading5"><span class="brz-cp-color2">An outstanding venue for an outstanding event!</span></p>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-heading5"><span class="brz-cp-color2">40G, Theodor Pallady Blvd., Sector 3, 438529</span></p><p class="brz-tp-heading5"><span class="brz-cp-color2">Bucharest, Romania</span></p>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
