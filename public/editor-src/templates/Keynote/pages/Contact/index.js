                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h1 class="brz-text-xs-center brz-tp-heading1 brz-mb-lg-0 brz-text-lg-right"><span class="brz-cp-color8">GET IN</span></h1>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h1 class="brz-text-xs-center brz-tp-heading1 brz-mb-lg-0 brz-text-lg-left"><span class="brz-cp-color8">TOUCH&nbsp;</span></h1>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">CLAIRE OSBORNE</span></h4>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-paragraph"><span class="brz-cp-color7">Event Coordinator</span></p>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-paragraph brz-text-lg-left"><span class="brz-cp-color3">PHONE:</span><span class="brz-cp-color2"> +1 948 382 593</span></p>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-paragraph"><span class="brz-cp-color3">EMAIL:&nbsp;</span><span class="brz-cp-color2"> claire.osborne@keynote.com</span></p>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
