                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<h1 class="brz-text-xs-center brz-text-lg-center brz-tp-heading1"><span class="brz-cp-color8">Our Projects</span></h1>'
                          }
                        }
                      ],
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h3 class="brz-text-xs-center brz-tp-heading3"><strong class="brz-cp-color8">PROJECTS</strong></h3>'
                                      }
                                    }
                                  ]
                                }
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-paragraph"><span class="brz-cp-color3">MOMBASA, KENYA</span></p>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-paragraph"><span class="brz-cp-color7">Phasellus molestie magna non est bibendum non venenatis nisl tempor. Suspendisse dictum feugiat nisl ut dapibus. Mauris iaculis porttitor posuere. Praesent id metus massa, ut blandit odio. Proin quis tortor orci. Etiam at risus et justo dignissim congue.</span></p>'
                                      }
                                    }
                                  ]
                                }
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        ...
                                        linkExternalBlank: "off",
                                        linkExternal:
                                          "https://demo.themefuse.com/hope/?page_id=1935"
                                      }
                                    }
                                  ],
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">Class Aptent Taciti Sociosqu Ad</span></h4>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<h3 class="brz-text-xs-center brz-text-lg-center brz-tp-heading3"><strong class="brz-cp-color2">4 STRATEGIES WE MAY APPLY</strong></h3>'
                          }
                        }
                      ]
                    }
                                        ...
                                        items: [
                                          ...
                                          },
                                          {
                                            ...
                                            value: {
                                              ...
                                              text:
                                                '<h3 class="brz-tp-heading3"><span class="brz-cp-color2">homes</span></h3>'
                                            }
                                          }
                                        ]
                                      }
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-paragraph"><span class="brz-cp-color2">Duis aliquet egestas purus in blandit. Curabitur vulputate, ligula lacinia scelerisque tempor, lacus lacus ornare ante, ac egestas est urna sit avmet arcu. Class aptent taciti sociosqu ad litora torquent per conubia nostra ipsum.</span></p>'
                                      }
                                    }
                                  ],
                                  marginLeft: 30,
                                        ...
                                        items: [
                                          ...
                                          },
                                          {
                                            ...
                                            value: {
                                              ...
                                              text:
                                                '<h3 class="brz-tp-heading3"><span class="brz-cp-color2">healthcare</span></h3>'
                                            }
                                          }
                                        ]
                                      }
                                        ...
                                        items: [
                                          ...
                                          },
                                          {
                                            ...
                                            value: {
                                              ...
                                              text:
                                                '<h3 class="brz-tp-heading3"><span class="brz-cp-color2">education</span></h3>'
                                            }
                                          }
                                        ]
                                      }
                                        ...
                                        items: [
                                          ...
                                          },
                                          {
                                            ...
                                            value: {
                                              ...
                                              text:
                                                '<h3 class="brz-tp-heading3"><span class="brz-cp-color2">religion</span></h3>'
                                            }
                                          }
                                        ]
                                      }
