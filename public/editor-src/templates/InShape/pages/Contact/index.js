module.exports = {
  ...
  title: "Contact",
  keywords:
    "contact, location, address, in shape, Health & Beauty, Sport, fitness, trainer",
  cat: [0, 13, 14],
  pro: true,
  resolve: {
    blocks: [
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-subtitle brz-text-lg-center brz-text-xs-center"><span class="brz-cp-color3">WHERE TO FIND US</span></p>'
                                      }
                                    }
                                  ]
                                }
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h2 class="brz-text-xs-center brz-text-lg-center brz-tp-heading2"><strong class="brz-cp-color8">Fitness Center Location</strong></h2>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-paragraph"><span class="brz-cp-color2">ADDRESS:</span></p>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-paragraph"><span class="brz-cp-color2">OPENING HOURS:</span></p>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-paragraph"><strong class="brz-cp-color2">040 658.684.744</strong></p><p class="brz-tp-paragraph"><strong class="brz-cp-color2">035 536.733.567</strong></p>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
