module.exports = {
  ...
  title: "Galery",
  keywords:
    "offers, features, promos, discounts, rewards, gallery, grid, images, Hotel, Spa, Restaurant, Travel, Vacation, apartments, rooms, suites, houses",
  cat: [0, 2],
  pro: true,
  resolve: {
    blocks: [
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<h2 class="brz-text-xs-center brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color2">Image Gallery</span></h2>'
                          }
                        }
                      ],
                      marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        ...
                                        imageHeight: 1000,
                                        imageSrc:
                                          "6de48ed0af0a73688154010eca5dba3e.jpg",
                                        height: 123,
                                        positionX: 50,
                                        positionY: 50,
                                        mobileHeight: 100,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        ...
                                        imageHeight: 1000,
                                        imageSrc:
                                          "7c7aab5ecf97fa0449cc75493330f36f.jpg",
                                        height: 123,
                                        positionX: 50,
                                        positionY: 50,
                                        mobileHeight: 100,
