module.exports = {
  ...
  title: "Dining",
  keywords:
    "dining, Hotel, Spa, Restaurant, Travel, Vacation, apartments, rooms, suites, houses",
  cat: [0, 2],
  pro: true,
  resolve: {
    blocks: [
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<h1 class="brz-tp-heading1"><span class="brz-cp-color2">Restaurant &amp; Bar</span></h1>'
                          }
                        }
                      ],
                      marginBottom: 0,
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<p class="brz-tp-subtitle"><strong class="brz-cp-color3">VESTIBULUM ANTE IPSUM PRIMIS IN FAUCIBUS ORCI</strong></p>'
                          }
                        }
                      ],
                      animationName: "fadeInUp",
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-subtitle"><span class="brz-cp-color7">FUSION CUISINE &amp; GOURMET</span></p>'
                                      }
                                    }
                                  ]
                                }
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h3 class="brz-tp-heading3"><span class="brz-cp-color2">Lighthouse Restaurant</span></h3>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-text-lg-right brz-tp-subtitle brz-text-xs-left"><span class="brz-cp-color7">COCKTAILS &amp; REFRESHMENTS</span></p>'
                                      }
                                    }
                                  ]
                                }
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h3 class="brz-text-xs-left brz-text-lg-right brz-tp-heading3"><span class="brz-cp-color2">Beach Bar &amp; Bistro</span></h3>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        ...
                                        imageHeight: 1000,
                                        imageSrc:
                                          "bcefdc5800ba5a34f492c10ebc7ea388.jpg",
                                        height: 123,
                                        positionX: 50,
                                        positionY: 50,
                                        mobileHeight: 100,
