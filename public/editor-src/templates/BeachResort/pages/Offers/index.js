module.exports = {
  ...
  title: "Offers",
  keywords:
    "Hotel, Spa, Restaurant, Travel, Vacation, apartments, rooms, suites, houses, offers, features, promos, discounts, rewards",
  cat: [0, 2],
  pro: true,
  resolve: {
    blocks: [
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<h2 class="brz-text-xs-center brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color2">Island Resort</span></h2>'
                          }
                        }
                      ],
                      marginBottom: 0,
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<p class="brz-text-lg-center brz-tp-subtitle brz-text-xs-center"><span class="brz-cp-color7">NULLA AT NULLA JUSTO, EGET LUCTUS TORTOR. NULLA FACILISI.</span></p>'
                          }
                        }
                      ],
                      animationName: "fadeInUp",
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">Snorkel &amp; Scuba</span></h4>'
                                      }
                                    }
                                  ],
                                  paddingType: "ungrouped",
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        ...
                                        imageHeight: 355,
                                        imageSrc:
                                          "8967b69afa7d37a086ea8b71d45603fe.jpg",
                                        height: 100,
                                        positionX: 50,
                                        positionY: 50,
                                        imagePopulation: ""
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">Save on yacht renting</span></h4>'
                                      }
                                    }
                                  ],
                                  paddingType: "ungrouped",
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-abovetitle"><span style="opacity: 0.8;" class="brz-cp-color1">20% OFF RENTING YACHTS</span></p>'
                                      }
                                    }
                                  ],
                                  paddingType: "ungrouped",
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        ...
                                        imageHeight: 355,
                                        imageSrc:
                                          "bac5c2210cb876b54183a7e2d50da738.jpg",
                                        height: 100,
                                        positionX: 50,
                                        positionY: 50,
                                        imagePopulation: ""
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">Room Service Discount</span></h4>'
                                      }
                                    }
                                  ],
                                  paddingType: "ungrouped",
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        ...
                                        imageHeight: 360,
                                        imageSrc:
                                          "48c71277ba5b3971ac160d7623f2288e.jpg",
                                        height: 100,
                                        positionX: 50,
                                        positionY: 50,
                                        imagePopulation: ""
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">Free 3rd Night</span></h4>'
                                      }
                                    }
                                  ],
                                  paddingType: "ungrouped",
