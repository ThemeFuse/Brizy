                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<h1 class="brz-tp-heading1"><span class="brz-cp-color2">Room Types</span></h1>'
                          }
                        }
                      ],
                      marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        ...
                                        imageHeight: 360,
                                        imageSrc:
                                          "5009ef6e34510a13f5e0384cc3991586.jpg",
                                        height: 100,
                                        positionX: 50,
                                        positionY: 50,
                                        imagePopulation: ""
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-text-lg-center brz-tp-subtitle"><strong class="brz-cp-color1">ONE BEDROOM VILLA</strong></p>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-text-lg-center brz-tp-heading5"><span class="brz-cp-color6">from $149/ night</span></p>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-subtitle brz-text-lg-center"><strong class="brz-cp-color1">OCEAN-VIEW ONE BEDROOM VILLA</strong></p>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-heading5 brz-text-lg-center"><span class="brz-cp-color6">from $189/ night</span></p>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        ...
                                        imageHeight: 360,
                                        imageSrc:
                                          "9446fed5affa12384d80a409f9334104.jpg",
                                        height: 100,
                                        positionX: 50,
                                        positionY: 50,
                                        imagePopulation: ""
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-subtitle brz-text-lg-center"><strong class="brz-cp-color1">TWO BEDROOM VILLA</strong></p>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-tp-heading5 brz-text-lg-center"><span class="brz-cp-color6">from $229/ night</span></p>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        ...
                                        imageHeight: 360,
                                        imageSrc:
                                          "4a25ca09739503a0da2b74eb20f50e7f.jpg",
                                        height: 100,
                                        positionX: 50,
                                        positionY: 50
                                      }
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-text-lg-center brz-tp-subtitle"><strong class="brz-cp-color1">THREE BEDROOM VILLA</strong></p>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-text-lg-center brz-tp-heading5"><span class="brz-cp-color6">from $349/ night</span></p>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        ...
                                        imageHeight: 360,
                                        imageSrc:
                                          "d0d06a084dc67c8fb0966835ba580fbb.jpg",
                                        height: 100,
                                        positionX: 50,
                                        positionY: 50,
                                        imagePopulation: ""
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-text-lg-center brz-tp-subtitle"><strong class="brz-cp-color1">GRAND PENTHOUSE</strong></p>'
                                      }
                                    }
                                  ],
                                  marginBottom: 0,
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-text-lg-center brz-tp-heading5"><span class="brz-cp-color6">from $489/ night</span></p>'
                                      }
                                    }
                                  ],
                                  marginTop: 0,
