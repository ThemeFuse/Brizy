                                ...
                                items: [
                                    {
                                        ...
                                        value: {
                                            ...
                                            text: "<h2 class=\"brz-text-lg-center brz-tp-heading2\"><span class=\"brz-cp-color8\">Our Process</span></h2>"
                                        }
                                    }
                                ]
                            }
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<h5 class=\"brz-tp-heading5 brz-text-xs-center\"><span class=\"brz-cp-color8\">Concept</span></h5>"
                                                                }
                                                            }
                                                        ]
                                                    }
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<h5 class=\"brz-tp-heading5 brz-text-xs-center\"><span class=\"brz-cp-color8\">Creation</span></h5>"
                                                                }
                                                            }
                                                        ]
                                                    }
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<h5 class=\"brz-tp-heading5 brz-text-xs-center\"><span class=\"brz-cp-color8\">Testing</span></h5>"
                                                                }
                                                            }
                                                        ]
                                                    }
