                                ...
                                items: [
                                    {
                                        ...
                                        value: {
                                            ...
                                            text: "<h2 class=\"brz-tp-heading2 brz-text-lg-center\"><span class=\"brz-cp-color2\">Services We Can Help You With</span></h2>"
                                        }
                                    }
                                ]
                            }
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<h4 class=\"brz-tp-heading4 brz-text-lg-center\"><span class=\"brz-cp-color2\">Web Design</span></h4>"
                                                                }
                                                            }
                                                        ]
                                                    }
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<h4 class=\"brz-tp-heading4 brz-text-lg-center\"><span class=\"brz-cp-color2\">Development</span></h4>"
                                                                }
                                                            }
                                                        ]
                                                    }
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<h4 class=\"brz-tp-heading4 brz-text-lg-center\"><span class=\"brz-cp-color2\">Consulting</span></h4>"
                                                                }
                                                            }
                                                        ]
                                                    }
