module.exports = {
  ...
  thumbnailHeight: 720,
  title: "Contact",
  keywords: "contact, location, address, college, Education, Teaching, School",
  cat: [0, 6],
  pro: true,
  resolve: {
    blocks: [
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<h1 class="brz-text-xs-center brz-text-lg-center brz-tp-heading1"><strong class="brz-cp-color8"><em>Contact Us</em></strong></h1>'
                          }
                        }
                      ],
                      marginBottom: 0,
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<p class="brz-text-lg-center brz-tp-subtitle brz-text-xs-center"><span class="brz-cp-color8">LOREM IPSUM DOLOR AMET CONSECTEUS</span></p>'
                          }
                        }
                      ],
                      marginTop: 0,
                      ...
                      items: [
                        {
                          ...
                          value: {
                            _styles: ["richText"],
                            text:
                              '<h3 class="brz-text-xs-center brz-tp-heading3 brz-text-lg-center"><span class="brz-cp-color2">Send us a message</span></h3>'
                          }
                        }
                      ]
                    }
                                  ...
                                  items: [
                                    {
                                      ...
                                      value: {
                                        _styles: ["richText"],
                                        text:
                                          '<p class="brz-text-lg-center brz-tp-paragraph brz-text-xs-center"><span class="brz-cp-color7">In pellentesque faucibus vestibulum. Nulla at nulla justo, eget luctus tortor. Nulla facilisi. Duis aliquet egestas purus in bla ndit. Curabitur vulputate, ligula lacinia scelerisque tempor, lacus lacus ornare ante, ac egestas est urna sit amet arcu. Class aptent taciti sociosqu ad litora torquent per conubia nostra.</span></p>'
                                      }
                                    }
                                  ]
                                }
                            ...
                            items: [
                              ...
                              },
                              {
                                ...
                                value: {
                                  ...
                                  hoverBgColorOpacity: 0.9499999999999999555910790149937383830547332763671875,
                                  hoverBorderColorOpacity: 0,
                                  tempBorderRadius: 0,
