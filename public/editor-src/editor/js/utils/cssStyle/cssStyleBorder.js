...
export function cssStyleBorderImportant({
  v,
  device,
  state,
  prefix = "",
  ...
  if (emptyUndefined) r = "";
    ...
    r = `border:${borderTopWidth}px ${borderStyle} ${borderColor}!important;`;
  else if (noEmptyUngrouped)
    r = `border-width:${borderTopWidth}px ${borderRightWidth}px ${borderBottomWidth}px ${borderLeftWidth}px!important;border-style:${borderStyle}!important;border-color:${borderColor}!important;`;
  else if (empty && normalByHoverNoEmptyUngrouped)
    r = `border:0px ${hoverBorderStyle} ${hoverBorderColor}!important;`;
  else r = `border:0px solid ${borderColor}!important;`;
