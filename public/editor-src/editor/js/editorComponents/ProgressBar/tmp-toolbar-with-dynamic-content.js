...
export function getItems({ v, device }) {
  ...
  const richTextDC = getDynamicContentChoices("richText");
  const textDC = richTextDC.length
    ? [{ value: "", title: t("Inline text") }, ...richTextDC]
    : [];
      ...
      options: [
        {
          ...
          devices: "desktop",
          choices: [
            { value: "style1", title: t("Style 1") },
            { value: "style2", title: t("Style 2") }
          ]
        },
        {
          id: "percentage",
