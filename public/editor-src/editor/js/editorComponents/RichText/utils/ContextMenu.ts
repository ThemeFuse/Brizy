...
const patchCustomValue = (values: Value, v: Value) => {
  const {
    ...
    textBgColorHex,
    textBgColorOpacity,
    imageSrc = v.bgImageSrc,
    imageFileName = v.bgImageFileName,
    imageExtension = v.bgImageExtension,
    imagePositionX = v.bgImagePositionX,
    imagePositionY = v.bgImagePositionY,
    imageWidth = v.bgImageWidth,
    imageHeight = v.bgImageHeight
  } = values;
  ...
  const bgImage = {
    bgImageExtension: imageExtension,
    bgImageFileName: imageFileName,
    bgImageHeight: imageHeight,
    bgImageSrc: imageSrc,
    bgImageWidth: imageWidth,
    bgPositionX: imagePositionX,
    bgPositionY: imagePositionY
  };
