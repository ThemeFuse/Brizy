...
import {
  toolbarElementImageGalleryFilterAfterSpacing,
  toolbarElementImageGalleryFilterSpacing,
  toolbarElementImageGalleryStyle
} from "visual/utils/toolbar/toolbarElementImageGallery";
  ...
  return [
    {
      ...
      options: [
        ...
        toolbarElementImageGalleryFilterSpacing({ v, device, state: "normal" }),
        toolbarElementImageGalleryFilterAfterSpacing({
          v,
          device,
          state: "normal"
