...
export class EcwidSearch extends EditorComponent<Value> {
  ...
  getClassName() {
    return this.getCSSClassnames({
      ...
      stylesFn: style,
      extraClassNames: ["brz-ecwid-wrapper", "brz-ecwid-search-wrapper"]
    });
  }
                                                                                      ...
                                                                                      {({
                                                                                        ...
                                                                                        return (
                                                                                          <Toolbar
                                                                                            ...
                                                                                            selector=".ec-filters__products .grid-product .grid-product__price-compare"
                                                                                            selectorSearchStrategy="dom-tree"
                                                                                          >
                                                                                            {({
                                                                                              open: openSalePrice,
                                                                                              ...
                                                                                              return (
                                                                                                <Toolbar
                                                                                                  ...
                                                                                                  selector=".ec-filters__products .grid-product .grid-product__label .ec-label.label--notice"
                                                                                                  selectorSearchStrategy="dom-tree"
                                                                                                >
                                                                                                  {({
                                                                                                                      ...
                                                                                                                      onClickCapture={(
                                                                                                                        ...
                                                                                                                        onClickCapture(
                                                                                                                          ...
                                                                                                                          [
                                                                                                                            ...
                                                                                                                            {
                                                                                                                              selector:
                                                                                                                                ".ec-filters__products .grid-product .grid-product__price-compare",
                                                                                                                              fn: openSalePrice
                                                                                                                            },
                                                                                                                            {
                                                                                                                              selector:
