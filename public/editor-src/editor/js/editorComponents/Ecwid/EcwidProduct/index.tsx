...
import * as toolbarQtyMinMax from "./toolbarQtyMinMax";
...
export class EcwidProduct extends EditorComponent<Value> {
  ...
  renderForEdit(v: Value): React.ReactNode {
    ...
    return (
      <Toolbar
        {...this.makeToolbarPropsFromConfig2(toolbarQtyMinMax, sidebarDisable)}
        selector=".details-product-purchase__qty  .details-product-purchase__qty-note"
        selectorSearchStrategy="dom-tree"
      >
        {({ open: openQtyMinMax, ref: qtyMinMaxRef }) => {
          return (
            <Toolbar
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        onClickCapture={(
                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                          if (
                                                                                                                                                                                                                                                                                                            (
                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                              ".details-product-purchase__qty  .details-product-purchase__qty-note"
                                                                                                                                                                                                                                                                                                            )
                                                                                                                                                                                                                                                                                                          ) {
                                                                                                                                                                                                                                                                                                            openQtyMinMax(
                                                                                                                                                                                                                                                                                                              e.nativeEvent
