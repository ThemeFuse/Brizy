...
const getToolbar = v => {
  ...
  const { hex: subMenuHoverBorderColorHex } = getOptionColor(
    v,
                          ...
                          onChange: ({
                            ...
                            return {
                              ...
                              subMenuHoverBorderColorHex:
                                ...
                                v.subMenuHoverBorderColorHex
                                  ? hex
                                  : v.subMenuHoverBorderColorHex,

                              subMenuHoverBorderColorOpacity:
                                v.subMenuBorderColorOpacity ===
                                v.subMenuHoverBorderColorOpacity
                                  ? hex
                                  : v.subMenuHoverBorderColorOpacity,
                        ...
                        },
                        {
                          ...
                          onChange: subMenuBorderColorPalette => ({
                            ...
                            subMenuHoverBorderColorPalette:
                              v.subMenuBorderColorPalette ===
                              v.subMenuHoverBorderColorPalette
                                ? subMenuBorderColorPalette
                                : v.subMenuHoverBorderColorPalette,
              ...
              options: [
                {
                  ...
                  tabs: [
                    ...
                    },
                    {
                      ...
                      options: [
                        {
                          id: "subMenuHoverBorderColor",
                          type: "colorPicker",
                          position: 10,
                          value: {
                            hex: subMenuHoverBorderColorHex,
                            opacity: v.subMenuHoverBorderColorOpacity
                          },
                          onChange: ({
                            hex,
                            opacity,
                            ...
                            opacity =
                              hex !== v.subMenuHoverBorderColorHex &&
                              v.subMenuHoverBorderColorOpacity === 0
                                ? v.subMenuTempHoverBorderColorOpacity
                                : opacity;

                            return {
                              subMenuHoverBorderColorHex: hex,
                              subMenuHoverBorderColorOpacity: opacity,
                              subMenuHoverBorderColorPalette:
                                isChanged === "hex"
                                  ? ""
                                  : v.subMenuHoverBorderColorPalette,
                              ...
                              // Temporary Value chnges
                              subMenuTempHoverBorderColorOpacity:
                                opacity > 0 && opacityDragEnd
                                  ? opacity
                                  : v.subMenuTempHoverBorderColorOpacity
                            };
                        ...
                        {
                          id: "subMenuHoverBorderColorPalette",
                          type: "colorPalette",
                          position: 20,
                          value: v.subMenuHoverBorderColorPalette,
                          onChange: subMenuHoverBorderColorPalette => ({
                            subMenuHoverBorderColorPalette,
                        ...
                        {
                          id: "subMenuHoverBorderColorFields",
                          type: "colorFields",
                          position: 30,
                          value: {
                            hex: subMenuHoverBorderColorHex,
