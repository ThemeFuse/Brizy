...
import { ecwidComponentsManifest } from "./Ecwid/export";
import { ministryBrandsComponentsManifest } from "./MinistryBrands/export";
import { shopifyComponentsManifest } from "./Shopify/export";
...
export const editorComponentsManifest: Record<string, ComponentExport> = {
  ...
  // Shopify
  ...shopifyComponentsManifest,

  // MinistryBrands
  ...ministryBrandsComponentsManifest,

  // Ecwid
  ...ecwidComponentsManifest
};
