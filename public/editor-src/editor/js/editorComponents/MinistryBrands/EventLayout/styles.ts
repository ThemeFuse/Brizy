...
export function style(
  ...
  const styles: {
    ...
    ".brz && .brz-eventLayout--filters:hover .brz-eventLayout--filters-form-selectWrapper":
      {
        standart: [
    ...
    ".brz && .brz-eventLayout--filters:hover .brz-eventLayout--filters-form-selectWrapper::after":
      {
    ...
    ".brz && .brz-eventLayout--filters:hover .brz-eventLayout--filters-form-selectWrapper select option":
      {
    ...
    ".brz && .brz-eventLayout--filters:hover input": {
      standart: [
        "cssStyleMinistryElementFiltersTypography",
        "cssStyleMinistryElementFiltersInputColor"
      ],
    ...
    ".brz && .brz-eventLayout--filters:hover fieldset": {
      standart: [
        "cssStyleMinistryElementFiltersBorder",
        "cssStyleMinistryElementFiltersBorderRadius",
        "cssStyleMinistryElementFiltersInputBgColor",
    ...
    ".brz && .brz-eventLayout--filters:hover input::placeholder": {
      standart: ["cssStyleMinistryElementFiltersInputColor"],
      interval: [
        "cssStyleHoverTransition",
        "cssStylePropertyHoverTransitionColor"
    ...
    ".brz && .brz-eventLayout--filters:hover button": {
      standart: ["cssStyleMinistryElementFiltersInputColor"],
      interval: [
        "cssStyleHoverTransition",
        "cssStylePropertyHoverTransitionColor"
