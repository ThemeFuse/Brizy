...
export const getItems: GetItems<Value, Props> = ({
  ...
  const pageChoices = getChoicesById(ekklesia?.pages);
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  helper: {
                    content: t(
                      'URL of event detail page. If used will add a link to the heading and image to take the user to the event detail page. Requires the "Event Detail" widget to be placed on a page and that page url/slug placed in this field.'
                    )
                  }
                }
              ]
