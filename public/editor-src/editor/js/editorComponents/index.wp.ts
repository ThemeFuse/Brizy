...
import(
  // @ts-expect-error: FileTypes scss?chunk=main.editor&onlyEditor=true
  /* webpackChunkName: "main.editor" */ "sass/main.editor.wp.scss?chunk=main.editor&onlyEditor=true"
);
...
function getShortcodes(config: ConfigCommon) {
  return {
    ...
    ...(hasSidebars(config)
      ? {
          WPSidebar: {
            id: ElementTypes.WPSidebar,
            component: WPSidebar
          }
        }
      : {}),
    WPCustomShortcode: {
      id: ElementTypes.WPCustomShortcode,
      component: WPCustomShortcode
    },
    WPPostNavigation: {
      id: ElementTypes.WPPostNavigation,
      component: WPPostNavigation
    },
    WPBreadcrumbs: {
      id: ElementTypes.WPBreadcrumbs,
      component: WPBreadcrumbs
    },
    WPPostInfo: {
      id: ElementTypes.WPPostInfo,
      component: WPPostInfo
    },
    Search: {
      id: ElementTypes.Search,
      component: Search
    },
    ...(pluginActivated(config, "woocommerce")
      ? {
          WOOProducts: {
            id: ElementTypes.WOOProducts,
            component: WOOProducts
          },
          WOOProductPage: {
            id: ElementTypes.WOOProductPage,
            component: WOOProductPage
          },
          WOOCategories: {
            id: ElementTypes.WOOCategories,
            component: WOOCategories
          },
          WOOPages: {
            id: ElementTypes.WOOPages,
            component: WOOPages
          },
          WOOExcerpt: {
            id: ElementTypes.WOOExcerpt,
            component: WOOExcerpt
          },
          WOOGallery: {
            id: ElementTypes.WOOGallery,
            component: WOOGallery
          },
          WOOAddToCart: {
            id: ElementTypes.WOOAddToCart,
            component: WOOAddToCart
          },
          WOOCart: {
            id: ElementTypes.WOOCart,
            component: WOOCart
          },
          WOOSku: {
            id: ElementTypes.WOOSku,
            component: WOOSku
          },
          WOOStock: {
            id: ElementTypes.WOOStock,
            component: WOOStock
          },
          WOOPrice: {
            id: ElementTypes.WOOPrice,
            component: WOOPrice
          },
          WOOAttributes: {
            id: ElementTypes.WOOAttributes,
            component: WOOAttributes
          },
          WOOProductMeta: {
            id: ElementTypes.WOOProductMeta,
            component: WOOProductMeta
          },
          WOORating: {
...
// Mock variables to avoid webpack warning import
