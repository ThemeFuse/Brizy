...
export class Alpha extends Component {
  ...
  render() {
    ...
    return (
      <div
        className="color-picker-alpha-body"
        style={{ borderRadius: this.props.radius }}
      >
        <div className="color-picker-alpha-checkboard">
          <Checkboard renderers={this.props.renderers} />
        </div>
        <div className="color-picker-alpha-gradient" style={gradientStyles} />
        <div
          className="color-picker-alpha-container"
          ref={container => (this.container = container)}
          onMouseDown={this.handleMouseDown}
          onTouchMove={this.handleChange}
          onTouchStart={this.handleChange}
        >
          <div className="color-picker-alpha-pointer" style={pointerStyles}>
            {this.props.pointer ? (
