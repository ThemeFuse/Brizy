...
export const Header = (props: Props): ReactElement => {
  ...
  const parentWindowDocument = window.parent.document.body;
  ...
  const renderHeader = useCallback(() => {
    return (
      <>
        ...
        {url && opened && (
          <Portal node={parentWindowDocument}>
            <div className="brz-ed-sidebar__video-help">
              <HelpVideo opened onClose={handleClick} url={url} />
            </div>
          </Portal>
        )}
      </>
