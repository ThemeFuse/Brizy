// This file must be replaces with existing one for popup 2 witf name PromptAddPopup
...
class PromptAddPopupOptionType extends React.Component {
  ...
  handleEdit = () => {
    ...
    SectionPopup2Instances.get(popupKey).open();
  ...
  handleEditLegacy = () => {
    ...
    SectionPopup2Instances.get(value).open();
