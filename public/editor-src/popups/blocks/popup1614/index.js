module.exports = {
  ...
  resolve: {
    ...
    "value": {
                                            ...
                                            "items": [
                                                {
                                                    ...
                                                    "value": {
                                                        ...
                                                        "text": "<h3 class=\"brz-mt-lg-10 brz-text-lg-center brz-tp-heading3 brz-mt-xs-0\"><span class=\"brz-cp-color8\">Subscribe to newsletter</span></h3>"
                                                    }
                                                }
                                            ]
                                        }
                                            ...
                                            "items": [
                                                {
                                                    ...
                                                    "value": {
                                                        ...
                                                        "text": "<p class=\"brz-mb-lg-10 brz-tp-paragraph brz-text-lg-center\"><span class=\"brz-cp-color6\" style=\"opacity: 0.8;\">Enter your email to receive our newsletter, so you can stay in the loop with our latest promos.</span></p>"
                                                    }
                                                }
                                            ],
                                            "marginType": "grouped",
        ...
        "popupId": "muucnetmoklsskbntczmuqttbsxpqyafszki",
