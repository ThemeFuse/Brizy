module.exports = {
  ...
  resolve: {
    ...
    value: {
                        ...
                        items: [
                          {
                            ...
                            value: {
                              _styles: ["richText"],
                              text:
                                '<h3 class="brz-tp-heading3 brz-text-xs-center"><span class="brz-cp-color2">This is a pop-up builder.</span></h3>'
                            }
                          }
                        ]
                      }
                        ...
                        items: [
                          {
                            ...
                            value: {
                              _styles: ["richText"],
                              text:
                                '<p class="brz-mb-lg-5 brz-tp-paragraph brz-text-xs-center"><span class="brz-cp-color7">You can create any structure you want by using the same tools as in the regular workflow. Add buttons and forms or anything else you\'d want.</span></p>'
                            }
                          }
                        ],
      ...
      popupId: "mgcdihbcvpmzuvbkkvlbhbedjlxabejrjqzr",
