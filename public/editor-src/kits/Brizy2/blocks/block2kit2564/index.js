                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle brz-text-lg-left"><span class="brz-cp-color8" style="opacity: 1;">TRANSFORM B2C E-SERVICES</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-mb-lg-20 brz-mt-lg-10 brz-tp-heading2 brz-text-lg-left"><span class="brz-cp-color8">You can\u2019t use up creativity. The more you use, the more you have. </span></h1>'
                                  }
                                }
                              ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h4 class="brz-mt-lg-5 brz-mb-lg-15 brz-tp-heading4"><span class="brz-cp-color8">Innovative Features </span></h4><p class="brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.8;"><span>Nor could I any way get rid of the dangerous liabilities which the hempen.</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-mt-lg-5 brz-tp-heading4 brz-mb-lg-15"><span class="brz-cp-color8">Creative Solutions</span></h4><p class="brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.8;"><span>But how did so clumsy and weighty a mass as that same hook get fixed in that hole?</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-mb-lg-15 brz-tp-heading4 brz-mt-lg-5"><span class="brz-cp-color8">Stylish Motivations</span></h4><p class="brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.8;"><span>I have hinted that I would often jerk poor Queequeg from between the whale and the ship.</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
