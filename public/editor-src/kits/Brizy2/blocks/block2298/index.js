                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color2">You become what you believe.</span></h2>'
                      }
                    }
                  ],
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-subtitle"><span class="brz-cp-color2">If you are in the market for a computer, there are a number of factors to consider. Will it be used for your home, your office or perhaps even your home.</span></p>'
                      }
                    }
                  ],
                                                ...
                                                items: [
                                                  ...
                                                  },
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<h6 class="brz-tp-heading6 brz-mb-lg-10"><span class="brz-cp-color2">Fast Transfers From Anywhere In The World</span></h6><p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>There\u2019s a quick and easy way to help your kids become happier.</span></span><strong class="brz-cp-color7"><span> </span></strong></p>'
                                                    }
                                                  }
                                                ]
                                              }
                                                ...
                                                items: [
                                                  ...
                                                  },
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<h6 class="brz-tp-heading6 brz-mb-lg-10"><span class="brz-cp-color2">Purchase Codes In 43 Different Currencies</span></h6><p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>Whether you barbecue on a popularly priced grill.</span></span></p>'
                                                    }
                                                  }
                                                ]
                                              }
                                                ...
                                                items: [
                                                  ...
                                                  },
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<h6 class="brz-tp-heading6 brz-mb-lg-10"><span class="brz-cp-color2">Secure &amp; Reliable Every Single Time</span></h6><p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>Benjamin Franklin, inventor, statesman, writer, publisher.</span></span></p><p class="brz-tp-button"><span class="brz-cp-color7"><span> </span></span></p>'
                                                    }
                                                  }
                                                ]
                                              }
