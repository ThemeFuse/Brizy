                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color8">Our awesome team</span></h1>'
                      }
                    }
                  ]
                }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-tp-heading6"><span class="brz-cp-color8">Ashley Richadson</span></h6>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-left brz-tp-paragraph"><span class="brz-cp-color6" style="opacity: 0.75;"><span>Creative Director</span></span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
