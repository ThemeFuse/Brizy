                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-abovetitle"><span class="brz-cp-color7" style="opacity: 0.6;">THE TEAM</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-text-xs-center brz-tp-heading3"><span class="brz-cp-color2">Lois Daniel</span></h3>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-xs-center"><span class="brz-cp-color7">"Good management is the art of making problems so interesting and their solutions so constructive"</span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-tp-heading3 brz-text-xs-center"><span class="brz-cp-color2">Jay Peters</span></h3>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-tp-heading3 brz-text-xs-center"><span class="brz-cp-color2">Harriet Houston</span></h3>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-text-xs-center brz-tp-heading3"><span class="brz-cp-color2">Shawn Lawson</span></h3>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
