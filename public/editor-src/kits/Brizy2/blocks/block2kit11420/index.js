                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-text-xs-center brz-tp-heading5"><span class="brz-cp-color8"><span>\u201cIt\'s your place in the world; it\'s your life. Go on and do all you can with it, and make it the life you want to live.\u201d</span></span></h5>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h6 class="brz-tp-heading6 brz-text-xs-center"><span class="brz-cp-color6" style="opacity: 0.75;">Angel Cunningham</span></h6>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-text-xs-center brz-tp-heading5"><span class="brz-cp-color8"><span>\u201cRemember that not getting what you want is sometimes a wonderful stroke of luck and genius.\u201d</span></span></h5>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h6 class="brz-tp-heading6 brz-text-xs-center"><span class="brz-cp-color6" style="opacity: 0.75;">Johanna Watts</span></h6>'
                                              }
                                            }
                                          ]
                                        }
