                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">Believe you can and you\u2019re halfway there</span></h4>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span style="opacity: 0.6;" class="brz-cp-color8">Proper cookery renders good food material more digestible. When scientifically done, cooking changes each of the food elements, with the exception of fats.</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">Everything you\u2019ve ever wanted is on the other side of fear</span></h4>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span style="opacity: 0.6;" class="brz-cp-color8">Homeopathy is a safe, natural form of medicine, based on the practice of treating like with like. Homeopathy is derived from the Greek words homios.</span></p>'
                                  }
                                }
                              ]
                            }
