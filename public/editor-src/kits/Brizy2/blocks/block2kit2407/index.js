                                    ...
                                    items: [
                                      {
                                        ...
                                        value: {
                                          _styles: ["richText"],
                                          text:
                                            '<p class="brz-mb-sm-0 brz-tp-heading5 brz-mb-lg-30 brz-mb-xs-0"><span class="brz-cp-color2"><span>\u201cHaving used discount toner cartridges for twenty years, there have been a lot of changes in the toner cartridge market.\u201d</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
                                          ...
                                          items: [
                                            ...
                                            },
                                            {
                                              ...
                                              value: {
                                                ...
                                                text:
                                                  '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">Leon Rivera</span></h4><p class="brz-tp-heading6"><span class="brz-cp-color2"><span>Art Director</span></span><strong class="brz-cp-color2"><span> </span></strong></p>'
                                              }
                                            }
                                          ]
                                        }
                                    ...
                                    items: [
                                      {
                                        ...
                                        value: {
                                          _styles: ["richText"],
                                          text:
                                            '<p class="brz-tp-heading5"><span class="brz-cp-color2">\u201cAmazing experience i love it a lot. Thanks to the team that dreams come true, great! I really appreciate their professional approach\u201d</span></p>'
                                        }
                                      }
                                    ]
                                  }
                                          ...
                                          items: [
                                            ...
                                            },
                                            {
                                              ...
                                              value: {
                                                ...
                                                text:
                                                  '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">Rosetta Kelley</span></h4><p class="brz-tp-heading6"><span class="brz-cp-color2"><span>Customer </span></span></p>'
                                              }
                                            }
                                          ]
                                        }
