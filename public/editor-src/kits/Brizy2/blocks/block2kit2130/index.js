                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color2">Every Great Business Starts with an Idea</span></h2>'
                      }
                    }
                  ],
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-subtitle brz-text-lg-center"><span class="brz-cp-color7">When I stand before God at the end of my life, I would hope that I would not have a single bit of talent left and could say, I used everything you gave me.</span></p>'
                      }
                    }
                  ],
                  tabletPaddingType: "ungrouped",
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color2">There are no traffic jams the extra mile</span></h2>'
                      }
                    }
                  ],
                  tabletPaddingType: "ungrouped",
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-subtitle"><span class="brz-cp-color7">This is the spot to learn how to build apps. You\u2019ll learn the language, tools, and necessary concepts to get your app out the door.</span></p>'
                      }
                    }
                  ],
                  tabletPaddingType: "ungrouped",
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-tp-heading2 brz-text-lg-center"><span class="brz-cp-color2">Characteristics Of Success</span></h2>'
                      }
                    }
                  ],
                  tabletPaddingType: "ungrouped",
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-subtitle brz-text-lg-center"><span class="brz-cp-color7">High-fidelity wireframes are often used for documenting because they incorporate a level of detail that more closely matches the design of the actual webpage, thus taking longer </span></p>'
                      }
                    }
                  ],
                  tabletPaddingType: "ungrouped",
