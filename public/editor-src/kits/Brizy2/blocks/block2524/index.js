                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-tp-heading5 brz-text-lg-left brz-text-xs-left"><span class="brz-cp-color2">Company</span></h5>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-tp-heading5 brz-text-lg-right brz-text-xs-right"><span class="brz-cp-color2"><span>Phone</span></span></h5>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-text-lg-right brz-tp-heading5 brz-text-xs-right"><span class="brz-cp-color2"><span>Budget</span></span></h5>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-tp-heading5 brz-text-lg-right brz-text-xs-right"><span class="brz-cp-color2"><span>Date</span></span></h5>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-heading5 brz-text-lg-left"><span class="brz-cp-color2">Toybikes</span></p>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-text-lg-right brz-tp-heading5 brz-text-xs-right"><span class="brz-cp-color2"><span>+1-202-555-0140</span></span></p>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-text-lg-right brz-tp-heading5 brz-text-xs-right"><span class="brz-cp-color2"><span>$38 283</span></span></p>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-text-lg-right brz-tp-heading5 brz-text-xs-right"><span class="brz-cp-color2"><span>May 13, 2018</span></span></p>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-heading5 brz-text-lg-right brz-text-xs-right"><span class="brz-cp-color2"><span>$38 283</span></span></p>'
                                              }
                                            }
                                          ]
                                        }
