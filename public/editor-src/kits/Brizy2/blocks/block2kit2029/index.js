                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-tp-heading3 brz-text-lg-center"><span class="brz-cp-color2">Ageing Skin Care Doesn\u2019t Hurt</span></h3>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color7">Long years ago, you have to wear two sets of eye glasses, then doctors discovered.</span></p>'
                                  }
                                }
                              ],
                              tabletPaddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-tp-heading3 brz-text-lg-center"><span class="brz-cp-color8" style="text-shadow: rgba(0, 0, 0, 0.29) 0px 1px 1px;">The Best Wireless Earbuds</span></h3>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color8" style="text-shadow: rgba(0, 0, 0, 0.3) 0px 1px 1px;"><span>Computer users and programmers have become so accustomed to using Windows.</span></span></p>'
                                  }
                                }
                              ],
                              tabletPaddingType: "ungrouped",
