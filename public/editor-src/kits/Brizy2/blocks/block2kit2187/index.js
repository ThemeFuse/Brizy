                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-tp-heading1"><span class="brz-cp-color2">$35 932</span></h1>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">The Universe Through A Child\u2019s Eyes</span></h4>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>For most of us, the idea of astronomy is something we directly connect to \u201cstargazing\u201d, telescopes and seeing magnificent displays in the heavens. And to be sure, that is the exciting area of astronomy that accounts for its huge popularity.</span></span></p>'
                                  }
                                }
                              ]
                            }
