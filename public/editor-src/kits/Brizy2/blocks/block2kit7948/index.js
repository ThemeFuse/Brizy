                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h3 class="brz-tp-heading3 brz-text-lg-center"><span class="brz-cp-color8">Parties and family gatherings are popular this time of year. Whether you\u2019re celebrating an anniversary, a birthday</span></h3>'
                      }
                    }
                  ],
