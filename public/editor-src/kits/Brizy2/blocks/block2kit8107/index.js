                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-mt-lg-10 brz-mb-lg-10 brz-mb-xs-0 brz-mt-xs-0"><span class="brz-cp-color8">Cultivate real-time markets</span></h5>'
                                  }
                                }
                              ],
                              marginType: "grouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color6" style="opacity: 0.75;"><span>We must now retrace our way a little. It was mentioned that upon first breaking ground in the whale\'s back.</span></span></p>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-mb-lg-10 brz-mt-lg-10 brz-tp-heading5 brz-mt-xs-0 brz-mb-xs-0"><span class="brz-cp-color8">Scale killer paradigms</span></h5>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color6" style="opacity: 0.75;"><span>It was inserted there by my particular friend Queequeg, whose duty it was, as harpooneer, to descend.</span></span></p>'
                                  }
                                }
                              ],
                              mobileMarginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-mb-lg-10 brz-mt-lg-10 brz-tp-heading5 brz-mt-xs-0 brz-mb-xs-0"><span class="brz-cp-color8">Drive e-services</span></h5>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color6" style="opacity: 0.75;"><span>So down there, some ten feet below the level of the deck, the poor harpooneer flounders about.</span></span></p>'
                                  }
                                }
                              ],
                              mobileMarginTopSuffix: "px",
