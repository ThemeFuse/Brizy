                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2 brz-text-lg-center"><span class="brz-cp-color8">Get started with 14 days trial</span></h2>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle brz-text-lg-center"><span class="brz-cp-color6" style="opacity: 0.75;">If you want to take your cooking skills up another notch then it might be time to look at changing to a gas stove.</span></p>'
                                  }
                                }
                              ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h4 class="brz-mb-lg-0 brz-tp-heading4"><span class="brz-cp-color8">Phone</span></h4><p class="brz-tp-heading5"><span class="brz-cp-color6" style="opacity: 0.75;"><span>129-828-7534</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-mb-lg-0 brz-tp-heading4"><span class="brz-cp-color8">Address</span></h4><p class="brz-tp-heading5"><span class="brz-cp-color6" style="opacity: 0.75;"><span>710 Russel Station Suite 315</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h4 class="brz-text-xs-left brz-tp-heading4"><strong class="brz-cp-color8">Socials</strong></h4>'
                                              }
                                            }
                                          ],
