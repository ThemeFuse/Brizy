                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-text-lg-center brz-tp-heading3"><span class="brz-cp-color8">Exploit holistic niches</span></h3>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-subtitle"><span class="brz-cp-color8" style="opacity: 0.6;">Going Wireless With Your Headphones</span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-tp-heading3 brz-text-lg-center"><span class="brz-cp-color8">Scale killer paradigms</span></h3>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-subtitle"><span class="brz-cp-color8" style="opacity: 0.6;">Thousands Now Adware Removal Who Never</span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
