                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-mt-xs-10 brz-tp-heading3"><span class="brz-cp-color2">Got some ideas for a project?</span></h3>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-mb-xs-10 brz-tp-heading3"><span class="brz-cp-color2">Drop us a line will be glad to here from you </span></h3>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
