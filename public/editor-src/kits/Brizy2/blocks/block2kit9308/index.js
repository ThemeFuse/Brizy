                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle brz-text-xs-center"><span class="brz-cp-color6" style="opacity: 0.7;">FINANCIAL ADVISER</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-text-xs-center brz-tp-heading1"><span class="brz-cp-color8"><span>Time to invest wisely</span></span></h1>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-paragraph"><span class="brz-cp-color6" style="opacity: 0.75;"><span>If you are in the market for a computer, there are a number of factors to consider. Will it be used for your home, your office or perhaps even your home.</span></span></p>'
                                  }
                                }
                              ]
                            }
