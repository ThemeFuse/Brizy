                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-tp-heading2"><span class="brz-cp-color2">Build your own dreams, or someone else will hire you to build theirs.</span></h2>'
                      }
                    }
                  ],
                  paddingType: "ungrouped",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-tp-heading5 brz-text-lg-center"><span class="brz-cp-color8"><span>01</span></span></h5>'
                                              }
                                            }
                                          ]
                                        }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-tp-heading6"><span class="brz-cp-color2">Optimize ubiquitous action-items</span></h6>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mb-xs-20 brz-tp-paragraph"><span class="brz-cp-color7"><span>There\u2019s a quick and easy way to help your kids become happier.</span></span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-text-lg-center brz-tp-heading5"><span class="brz-cp-color8"><span>02</span></span></h5>'
                                              }
                                            }
                                          ]
                                        }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-tp-heading6"><span class="brz-cp-color2">Innovate killer webservices</span></h6>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mb-xs-20 brz-tp-paragraph"><span class="brz-cp-color7"><span>Whether you barbecue on a popularly priced grill.</span></span></p>'
                                  }
                                }
                              ],
                              mobileMarginType: "grouped"
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-tp-heading5 brz-text-lg-center"><span class="brz-cp-color8"><span>03</span></span></h5>'
                                              }
                                            }
                                          ]
                                        }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-tp-heading6"><span class="brz-cp-color2">Drive compelling web</span></h6>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mb-xs-20 brz-tp-paragraph"><span class="brz-cp-color7"><span>Benjamin Franklin, inventor, statesman, writer, publisher.</span></span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-text-lg-center brz-tp-heading5"><span class="brz-cp-color8"><span>04</span></span></h5>'
                                              }
                                            }
                                          ]
                                        }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-tp-heading6"><span class="brz-cp-color2">Morph efficient systems</span></h6>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mb-xs-0 brz-tp-paragraph"><span class="brz-cp-color7"><span>Benjamin Franklin, inventor, tatesman, writer, publisher.</span></span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
