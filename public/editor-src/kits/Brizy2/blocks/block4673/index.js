                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-abovetitle"><span class="brz-cp-color7" style="opacity: 0.7;">3 STEP GUIDE FOR BUSINESS OWNERS&nbsp;</span></p>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading2 brz-text-lg-center brz-mb-lg-20"><span class="brz-cp-color2">Understand What the Metrics Tell you</span></h1>'
                      }
                    }
                  ],
                  marginType: "grouped"
