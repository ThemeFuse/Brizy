                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-text-xs-center brz-tp-heading2"><strong class="brz-cp-color8">Last workshop stuff</strong></h2>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-text-lg-right brz-tp-abovetitle"><strong style="opacity: 0.7;" class="brz-cp-color6">GREAT UPDATES</strong></p>'
                                  }
                                }
                              ]
                            }
