                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h3 class="brz-tp-heading3 brz-mb-lg-20"><span class="brz-cp-color8">Bringing the ideal product to market with us</span></h3><p class="brz-mb-lg-10 brz-tp-paragraph brz-mt-lg-10"><span class="brz-cp-color6" style="opacity: 0.75;"><span>Without a doubt there is something very relaxing and pleasurable.</span></span></p>'
                                        }
                                      },
                                      {
                                        type: "Cloneable",
