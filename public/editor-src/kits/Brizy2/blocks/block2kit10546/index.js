                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-text-xs-center brz-tp-heading2"><span class="brz-cp-color8">How to build &amp; publish landing pages</span></h2>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-subtitle"><span class="brz-cp-color8" style="opacity: 0.8;"><span>In order to succeed, your desire for success should be greater than your fear of failure. This webinar solves everhything.</span></span></p>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-abovetitle"><span style="opacity: 0.75;" class="brz-cp-color6"><span>JOIN OUR SPEAKERS FOR THIS WEBINAR:</span></span></p>'
                                  }
                                }
                              ]
                            }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-abovetitle brz-text-xs-center"><span class="brz-cp-color8" style="opacity: 1;"><span>MARK HENDRIX</span></span></p>'
                                              }
                                            }
                                          ],
                                          tabletMarginTopSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-mb-xs-20 brz-text-xs-center brz-tp-paragraph brz-mb-sm-17"><span style="opacity: 0.75;" class="brz-cp-color6"><span>Mark is a web specialist and marketer with 12 years of experience</span></span></p>'
                                              }
                                            }
                                          ],
                                          marginTopSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-abovetitle brz-text-xs-center"><span style="opacity: 1;" class="brz-cp-color8"><span>JENNA HORTENSE</span></span></p>',
                                                customCSS: ""
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-text-xs-center brz-tp-paragraph"><span style="opacity: 0.75;" class="brz-cp-color6"><span>Jenna has built millions of landing</span></span><span style="opacity: 0.75;" class="brz-cp-color6"><span> </span></span><span style="opacity: 0.75;" class="brz-cp-color6"><span>pages for important clients</span></span></p>',
                                                customCSS: ""
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-abovetitle brz-text-xs-center"><span class="brz-cp-color8" style="opacity: 1;"><span>MICAH HILL</span></span></p>',
                                                customCSS: ""
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-text-xs-center brz-tp-paragraph"><span style="opacity: 1;" class="brz-cp-color8"><span>One of the leading marketers and copyrighters</span></span></p>',
                                                customCSS: ""
                                              }
                                            }
                                          ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-paragraph brz-text-lg-center"><span style="opacity: 0.7;" class="brz-cp-color8"><span>By signing up you agree to Terms of Service.</span></span></p>'
                                  }
                                }
                              ]
                            }
