                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-tp-heading6 brz-text-lg-center"><span class="brz-cp-color8">Frances Wagner</span></h6>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-abovetitle"><span class="brz-cp-color6" style="opacity: 0.7;">HEAD OF PR</span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-text-lg-center brz-tp-heading6"><span class="brz-cp-color8">Maurice Smith</span></h6>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle brz-text-lg-center"><span class="brz-cp-color6" style="opacity: 0.7;">CREATIVE DIRECTOR</span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color7">\u201cThe most beautiful experience we can have is the mysterious. It is the fundamental emotion that stands at the cradle of true art and true science.\u201d Albert Einstein, The World as I See It, 1931 The debate between realism and anti-realism is, at least, a century old.</span></p>'
                                              }
                                            }
                                          ]
                                        }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-text-lg-center brz-tp-heading6"><span class="brz-cp-color8">Matilda Ellis</span></h6>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle brz-text-lg-center"><span class="brz-cp-color6" style="opacity: 0.7;">ART DIRECTOR</span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
