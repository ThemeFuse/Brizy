                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h3 class="brz-mb-lg-10 brz-tp-heading3"><span class="brz-cp-color2">Engage synergistic portals &amp; users</span></h3><p class="brz-mt-lg-0 brz-tp-paragraph brz-mb-lg-0"><span class="brz-cp-color7"><span>Many of us are so used to working on a computer desktop that when.</span></span></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 25
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h3 class="brz-mb-lg-10 brz-tp-heading3"><span class="brz-cp-color2">Create compelling websites</span></h3><p class="brz-mt-lg-0 brz-mb-lg-0 brz-tp-paragraph"><span class="brz-cp-color7"><span>When I was just starting 6th grade I got my first job. Paperboy!</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
