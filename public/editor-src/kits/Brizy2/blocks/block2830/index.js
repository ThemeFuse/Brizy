                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-text-xs-right brz-text-lg-right brz-tp-heading5"><span class="brz-cp-color2"><span>Date</span></span></h5>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-text-lg-left brz-tp-heading5"><span class="brz-cp-color8">Toybikes</span></p>'
                                              }
                                            }
                                          ]
                                        }
