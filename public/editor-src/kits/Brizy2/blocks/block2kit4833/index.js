                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-abovetitle brz-text-lg-center"><span style="opacity: 0.75;" class="brz-cp-color6"><span>GET THE MOST DOWNLOADED EBOOK OF 2019</span></span></p>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-text-lg-center brz-tp-heading1"><span class="brz-cp-color8"><span>How to Make Your App a Hit With Users</span></span></h1>'
                      }
                    }
                  ]
                }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-abovetitle"><span class="brz-cp-color6" style="opacity: 0.75;"><span>THIS COMPREHENSIVE EBOOK WILL COVER:</span></span></p>'
                                              }
                                            }
                                          ]
                                        }
                                                ...
                                                items: [
                                                  ...
                                                  },
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<p class="brz-tp-paragraph"><span class="brz-cp-color8"><span>Insight into why Enterprises love SaaS + mobility + open APIs</span></span></p>'
                                                    }
                                                  }
                                                ],
                                                iconSpacing: 10
                                                ...
                                                items: [
                                                  ...
                                                  },
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<p class="brz-tp-heading6"><span class="brz-cp-color8"><span>Tips to expand your addressable market without additional resources</span></span></p>'
                                                    }
                                                  }
                                                ],
                                                iconSpacing: 10
                                                ...
                                                items: [
                                                  ...
                                                  },
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<p class="brz-tp-heading6"><span class="brz-cp-color8"><span>How to make your SaaS application and API "Plug and Play"</span></span></p>'
                                                    }
                                                  }
                                                ],
                                                iconSpacing: 10
                                                ...
                                                items: [
                                                  ...
                                                  },
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<p class="brz-tp-heading6"><span class="brz-cp-color8"><span>How to provide sticky, best in class SaaS applications</span></span></p>'
                                                    }
                                                  }
                                                ],
                                                iconSpacing: 10
