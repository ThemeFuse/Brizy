                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color8">Pricing Plans</span></h1>'
                      }
                    }
                  ],
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-subtitle"><span class="brz-cp-color8" style="opacity: 0.6;">Choosing The Best Audio Player Software For Your Computer</span></p>'
                      }
                    }
                  ]
                }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2 brz-text-lg-center"><span class="brz-cp-color8">Beginner</span></h2>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color8"><span>$25.99</span></span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-subtitle"><span class="brz-cp-color8" style="opacity: 0.7;">3k Users per month</span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<p class="brz-tp-paragraph"><span class="brz-cp-color8">Auto update mode</span></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<p class="brz-tp-paragraph"><span class="brz-cp-color8">Online operator 24/7</span></p>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<p class="brz-tp-paragraph"><span class="brz-cp-color8">International posting </span></p>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<p class="brz-tp-paragraph"><span class="brz-cp-color8">Unique newsletters all</span></p>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<p class="brz-tp-paragraph"><span class="brz-cp-color8">20 Design templates</span></p>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2 brz-text-lg-center"><span class="brz-cp-color8">Intermediate</span></h2>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading2 brz-text-lg-center"><span class="brz-cp-color8"><span>$69.50</span></span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle brz-text-lg-center"><span class="brz-cp-color8" style="opacity: 0.7;">5k Users per month</span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.6;"><span>Request Free Trial</span></span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.6;">Request Free Trial</span></p>'
                                  }
                                }
                              ],
                              showOnMobile: "off"
