                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle"><span class="brz-cp-color2">TRAVELING FOR BUSINESS</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-lh-lg-1_3 brz-lh-sm-im-1_3 brz-lh-xs-im-1_3 brz-fs-lg-75 brz-fs-sm-im-69 brz-ls-lg-m_1_5 brz-ls-sm-im-m_1 brz-ls-xs-im-m_1 brz-ff-overpass brz-fw-lg-700 brz-fw-sm-im-700 brz-fw-xs-im-700 brz-fs-xs-63"><span class="brz-cp-color2"><span>Best Street Coffee Shops</span></span></h1>'
                                  }
                                }
                              ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h6 class="brz-tp-heading6 brz-mb-lg-10"><span class="brz-cp-color8"><span>Apply Rules </span></span></h6><p class="brz-tp-paragraph"><span class="brz-cp-color8"><span>If the voltage changes by a large enough</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h6 class="brz-tp-heading6 brz-mb-lg-10"><span class="brz-cp-color8"><span>Implement Next</span></span></h6><p class="brz-tp-paragraph"><span class="brz-cp-color8"><span>Technologies that open gates to your mind</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<p class="brz-mb-lg-10 brz-tp-heading6"><span class="brz-cp-color8"><span>New Generation</span></span></p><p class="brz-tp-paragraph"><span class="brz-cp-color8"><span>Open discussion about new trends</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
