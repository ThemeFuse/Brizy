                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h3 class="brz-tp-heading3"><span class="brz-cp-color2">Startup</span></h3>'
                                              }
                                            }
                                          ],
                                          marginBottomSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-text-xs-right brz-tp-heading3 brz-text-lg-right"><span class="brz-cp-color2">$29</span></p>'
                                              }
                                            }
                                          ],
                                          marginTopSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading6"><span class="brz-cp-color2">Best option for small businesses, start ups and personal projects</span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color2"><span>20 Design templates</span></span></h5>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color2"><span>35 Vector Icons</span></span></h5>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color2"><span>Slider Compatibility</span></span></h5>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-xs-center brz-tp-heading4 brz-text-sm-center"><span class="brz-cp-color8">01</span></h4>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-text-sm-center brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.6;"><span>Usage of the Internet is becoming more common due to rapid advancement.</span></span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-xs-center brz-tp-heading4 brz-text-sm-center"><span class="brz-cp-color8">02</span></h4>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-text-sm-center brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.6;"><span>All the rumors have finally died down and many skeptics have tightened their lips.</span></span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-xs-center brz-tp-heading4 brz-text-sm-center"><span class="brz-cp-color8">03</span></h4>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-text-sm-center brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.6;"><span>Research in advertising is done in order to produce better advertisements.</span></span></p>'
                                  }
                                }
                              ]
                            }
