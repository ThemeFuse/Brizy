                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<h3 class=\"brz-tp-heading3 brz-text-xs-center\"><span class=\"brz-cp-color2\">Get Started For Free</span></h3>"
                                                                }
                                                            }
                                                        ]
                                                    }
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<p class=\"brz-text-xs-center brz-tp-button brz-text-lg-center brz-text-sm-center\"><em class=\"brz-cp-color7\" style=\"opacity: 0.6;\">By signing up you agree to Terms of Service.</em></p>"
                                                                }
                                                            }
                                                        ],
                                                        "marginTopSuffix": "px",
                                                                                ...
                                                                                "items": [
                                                                                    {
                                                                                        ...
                                                                                        "value": {
                                                                                            ...
                                                                                            "text": "<p class=\"brz-text-sm-center brz-tp-heading3 brz-text-xs-center\"><span class=\"brz-cp-color8\">Join the Thousands Listening to our Podcast</span></p>"
                                                                                        }
                                                                                    }
                                                                                ],
                                                                                ...
                                                                                "items": [
                                                                                    {
                                                                                        ...
                                                                                        "value": {
                                                                                            ...
                                                                                            "text": "<p class=\"brz-text-xs-center brz-text-lg-right brz-tp-heading6 brz-text-sm-center\"><span class=\"brz-cp-color2\"><span>\u201cExcellent &amp; fun. Can\u2019t wait for next show\u201c</span></span></p>"
                                                                                        }
                                                                                    }
                                                                                ],
                                                                                "marginBottomSuffix": "px",
                                                                                ...
                                                                                "items": [
                                                                                    {
                                                                                        ...
                                                                                        "value": {
                                                                                            ...
                                                                                            "text": "<p class=\"brz-text-sm-center brz-text-xs-center brz-text-lg-right brz-tp-abovetitle\"><span class=\"brz-cp-color7\">SYLVIA MARTEM</span></p>"
                                                                                        }
                                                                                    }
                                                                                ],
                                                                                "marginTopSuffix": "px",
