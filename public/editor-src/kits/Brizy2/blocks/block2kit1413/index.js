                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2 brz-text-xs-center"><span class="brz-cp-color2"><span>Many Useful Components</span></span></h2>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle brz-text-xs-center"><span class="brz-cp-color7"><span>Are you considering buying a compatible inkjet cartridge for your printer? There are many good companies like Canon, Epson, Dell.</span></span></p>'
                                  }
                                }
                              ]
                            }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-tp-heading5"><span class="brz-cp-color2">Retina Ready</span></h5>'
                                              }
                                            }
                                          ],
                                          marginType: "grouped",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color7">Order works on devices support-ing Retina Display. Feel the clarity in each pixel.</span></p>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-tp-heading5"><span class="brz-cp-color2">Clear Grid</span></h5>',
                                                customCSS: ""
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color7">Components and blocks are fixed to the common and popular 12 Grid system.</span></p>'
                                              }
                                            }
                                          ]
                                        }
