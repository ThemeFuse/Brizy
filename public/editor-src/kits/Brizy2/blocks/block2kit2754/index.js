                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle"><span class="brz-cp-color8" style="opacity: 0.6;">NEW UPDATES</span></p>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2"><span class="brz-cp-color8">Innovate bleeding-edge solutions easily</span></h2>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.6;">It is a good idea to think of your PC as an office. It stores files, programs, pictures. This can be compared to an actual office\u2019s files, machines and decorations. The operating system is the that was slow and inefficient. </span></p>'
                                  }
                                }
                              ]
                            }
