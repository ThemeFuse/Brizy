                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-tp-heading1"><span class="brz-cp-color2">Aussie Chef Shares Culinary Secrets With Americans</span></h1>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-left brz-tp-subtitle"><span class="brz-cp-color7">There are many ways chocolate makes people happy and one of the worthiest is a tour that has been described as the \u201cchocolate lover\u2019s dream.\u201d</span></p>'
                                  }
                                }
                              ],
