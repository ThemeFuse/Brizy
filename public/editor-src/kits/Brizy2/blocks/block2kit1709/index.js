                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-tp-heading5"><span class="brz-cp-color8">Morph efficient</span></h5>'
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color6" style="opacity: 0.75;"><span>Tonight half of southern Japan is hunched down awaiting the arrival of the typhoon.</span></span></p>'
                                              }
                                            }
                                          ],
                                          marginType: "grouped",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-tp-heading5"><span class="brz-cp-color8">Matrix dynamic</span></h5>'
                                              }
                                            }
                                          ],
                                          mobileMarginTopSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color6" style="opacity: 0.75;"><span>The disadvantages are the physical constraints of the user having to hold the handheld.</span></span></p>'
                                              }
                                            }
                                          ],
                                          marginType: "grouped",
