module.exports = {
  ...
  keywords: "button,call to action,icons",
  cat: [5590],
  type: 1,
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<h2 class=\"brz-tp-heading2 brz-text-lg-center\"><span class=\"brz-cp-color8\">Start Creating Your Site</span></h2>"
                                                                }
                                                            }
                                                        ]
                                                    }
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<p class=\"brz-text-lg-center brz-tp-subtitle\"><span class=\"brz-cp-color8\">You can never cross the ocean until you have the courage to lose sight of the shore - Christopher Columbus</span></p>"
                                                                }
                                                            }
                                                        ],
                                                        "marginTopSuffix": "px",
