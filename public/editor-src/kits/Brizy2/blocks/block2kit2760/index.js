                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2 brz-text-lg-center"><span class="brz-cp-color8">Start Creating Your Site</span></h2>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-subtitle"><span class="brz-cp-color8">You can never cross the ocean until you have the courage to lose sight of the shore - Christopher Columbus</span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
