                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color8">Check out what clients say</span></h1>'
                      }
                    }
                  ]
                }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-heading5"><span class="brz-cp-color8"><span>\u201cAmazing experience i love it a lot. Thanks to the team dreams come true, great! I really super appreciate there approach om\u201d</span></span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-tp-heading6 brz-text-xs-center"><span class="brz-cp-color8">Lassy Chester,</span></h6>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-paragraph"><span class="brz-cp-color8">Art Director</span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
