                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-left brz-tp-abovetitle"><span class="brz-cp-color7" style="opacity: 0.7;">OPTIMIZE UBIQUITOUS ACTION-ITEMS</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-tp-heading1 brz-text-lg-left"><span class="brz-cp-color2">In order to succeed, your desire for success should be greater than your fear of failure.</span></h1>'
                                  }
                                }
                              ],
                                                ...
                                                items: [
                                                  ...
                                                  },
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<h6 class="brz-tp-heading6 brz-mb-lg-10"><span class="brz-cp-color2">Secure &amp; Reliable Every Single Time</span></h6><p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>Benjamin Franklin, inventor, statesman, writer, publisher.</span></span><strong class="brz-cp-color7" style="opacity: 0.7;"><span> </span></strong></p>'
                                                    }
                                                  }
                                                ]
                                              }
