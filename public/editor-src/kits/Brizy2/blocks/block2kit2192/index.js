                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2"><span class="brz-cp-color2">Las Vegas How To Have Non Gambling Related Fun</span></h2>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5"><span class="brz-cp-color7">Information design is the presentation\u2014placement and prioritization of information in a way that facilitates understanding. Information design is effectively for clear communication.</span></h5>'
                                  }
                                }
                              ],
                              showOnTablet: "on",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h3 class="brz-tp-heading3"><span class="brz-cp-color2">Email</span></h3>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-tp-heading5"><span class="brz-cp-color2"><span>spinka.ashlee@yahoo.com</span></span></h5>'
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-tp-heading5"><span class="brz-cp-color2"><span>christine.bechtelar@keshawn.tv</span></span></h5>'
                                              }
                                            }
                                          ],
                                          marginBottomSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-tp-heading5"><span class="brz-cp-color2"><span>rowe_maymie@hettinger.com</span></span></h5>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h3 class="brz-tp-heading3"><span class="brz-cp-color2">Addresses</span></h3>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-tp-heading5"><span class="brz-cp-color2"><span>9750 Bogan Row</span></span></h5>'
                                              }
                                            }
                                          ],
                                          marginBottomSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-tp-heading5"><span class="brz-cp-color2"><span>5908 Powlowski Villages</span></span></h5>'
                                              }
                                            }
                                          ],
                                          marginBottomSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-tp-heading5"><span class="brz-cp-color2"><span>002 Gutkowski Turnpike</span></span></h5>'
                                              }
                                            }
                                          ]
                                        }
