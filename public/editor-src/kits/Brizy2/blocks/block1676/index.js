                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-mb-lg-30 brz-text-lg-center brz-tp-subtitle brz-mb-xs-20"><span class="brz-cp-color7"><span>Few would argue that, despite the advancements of feminism over the past three decades, women still face a double standard.</span></span></p>'
                      }
                    }
                  ],
