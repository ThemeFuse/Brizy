                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2 brz-text-xs-center"><span class="brz-cp-color2">How to build &amp; publish landing pages</span></h2>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-subtitle"><span class="brz-cp-color2" style="opacity: 0.8;"><span>In order to succeed, your desire for success should be greater than your fear of failure. This webinar solves everhything.</span></span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle brz-text-xs-center"><span class="brz-cp-color7" style="opacity: 0.8;">JOIN OUR SPEAKERS FOR THIS WEBINAR:</span></p>'
                                  }
                                }
                              ]
                            }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-abovetitle brz-text-xs-center"><span class="brz-cp-color2" style="opacity: 0.8;">MARK HENDRIX</span></p>'
                                              }
                                            }
                                          ],
                                          tabletMarginTopSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-mb-sm-17 brz-tp-paragraph brz-text-xs-center brz-mb-xs-20"><span class="brz-cp-color7" style="opacity: 0.6;"><span>Mark is a web specialist and marketer with 12 years of experience</span></span></p>'
                                              }
                                            }
                                          ],
                                          marginTopSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-abovetitle brz-text-xs-center"><span class="brz-cp-color2" style="opacity: 0.8;">JENNA HORTENSE</span></p>',
                                                customCSS: ""
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph brz-text-xs-center"><span class="brz-cp-color7" style="opacity: 0.6;">Jenna has built millions of landing pages for important clients</span></p>',
                                                customCSS: ""
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-abovetitle brz-text-xs-center"><span class="brz-cp-color2" style="opacity: 0.8;">MICAH HILL</span></p>',
                                                customCSS: ""
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph brz-text-xs-center"><span class="brz-cp-color7" style="opacity: 0.6;">One of the leading marketers and copyrighters</span></p>',
                                                customCSS: ""
                                              }
                                            }
                                          ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph brz-text-xs-center"><span class="brz-cp-color7" style="opacity: 0.7;">By signing up you agree to Terms of Service.</span></p>'
                                  }
                                }
                              ]
                            }
