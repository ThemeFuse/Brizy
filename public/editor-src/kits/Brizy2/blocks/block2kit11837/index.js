                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle"><span class="brz-cp-color6" style="opacity: 0.7;">LASSY CHESTER / CLIENT</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2"><span class="brz-cp-color8">\u201cAmazing experience i love it a lot. Thanks to the team that dreams come true, great! I really appreciate their work\u201d </span></h2>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    ...
                                    imageWidth: 653,
                                    imageHeight: 725,
                                    imageSrc: "d03-Img-Watch-Minimal.jpg",
                                    height: 80,
                                    positionX: 50,
                                    positionY: 50,
                                    imagePopulation: "",
