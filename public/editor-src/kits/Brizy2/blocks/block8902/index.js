module.exports = {
  ...
  keywords: "button,features,image,slider",
  cat: [5584],
  type: 1,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-xs-center brz-tp-heading4"><span class="brz-cp-color3">Contemporary</span></h4>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4 brz-text-xs-center"><span class="brz-cp-color8">Augmented Reality</span></h4>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4 brz-text-xs-center"><span class="brz-cp-color8">Visual Arts</span></h4>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4 brz-text-xs-center"><span class="brz-cp-color8">Features</span></h4>',
                                    customCSS: ""
                                  }
                                }
                              ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h3 class="brz-tp-heading3"><span class="brz-cp-color2">Innovate bleeding-edge solutions</span></h3>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>When it comes to Inflammatory Bowel Disorder (IBD), most people are aware of ulcerative colitis. This is a disorder...</span></span></p>'
                                              }
                                            }
                                          ]
                                        }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4 brz-text-xs-center"><span class="brz-cp-color8">Contemporary</span></h4>'
                                  }
                                }
                              ],
                              tabletMarginType: "grouped"
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-xs-center brz-tp-heading4"><span class="brz-cp-color3">Augmented Reality</span></h4>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    ...
                                    imageWidth: 1410,
                                    imageHeight: 1214,
                                    imageSrc: "d03-Img-Headphones-1.jpg",
                                    height: 53,
                                    positionX: 50,
                                    positionY: 50,
                                    imagePopulation: "",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-xs-center brz-tp-heading4"><span class="brz-cp-color3">Visual Arts</span></h4>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-xs-center brz-tp-heading4"><span class="brz-cp-color3">Features</span></h4>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    ...
                                    imageWidth: 1214,
                                    imageHeight: 922,
                                    imageSrc: "d03-Img-Ice-Cold-Drink.jpg",
                                    height: 60,
                                    positionX: 50,
                                    positionY: 50,
                                    imagePopulation: "",
