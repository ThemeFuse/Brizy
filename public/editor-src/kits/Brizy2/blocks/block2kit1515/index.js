                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-mb-lg-10 brz-tp-heading4 brz-mt-lg-8"><span class="brz-cp-color2">Reach Ever Further</span></h4><p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>I have hinted that I would often jerk poor Queequeg from between the whale.</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-mt-lg-8 brz-mb-lg-10 brz-tp-heading4"><span class="brz-cp-color2"><span>Exploit Niches</span></span></h4><p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>In the tumultuous business of cutting-in and attending to a whale, there is much running backwards and forwards among the crew.</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-mt-lg-8 brz-mb-lg-10 brz-tp-heading4"><span class="brz-cp-color2"><span>Chat Platforms</span></span></h4><p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>I have hinted that I would often jerk poor Queequeg from between the whale.</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
