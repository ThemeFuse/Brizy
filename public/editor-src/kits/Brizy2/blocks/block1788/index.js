                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-mt-xs-10 brz-tp-heading4"><span class="brz-cp-color2">Learn the Most In-Demand Job Skill - Coding</span></h4>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-mb-xs-20"><span class="brz-cp-color7"><span>Do you remember the story of \u201cThe Wizard of Oz\u201d? In this story we saw the characters of Dorothy.</span></span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-mt-xs-10 brz-tp-heading4"><span class="brz-cp-color2">Design Popups that Boost Your Client\u2019s Conversions</span></h4>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-mb-xs-20"><span class="brz-cp-color7"><span>Many people were hoping that if the Democrats won control of Congress they would reverse the online</span></span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-mt-xs-10 brz-tp-heading4"><span class="brz-cp-color2">Web Performance Mini Series: Animations</span></h4>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-mb-xs-20"><span class="brz-cp-color7"><span>Some people find it hard to find the right perfume. This may smell good when this is sprayed into the air.</span></span></p>'
                                  }
                                }
                              ]
                            }
