                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h3 class="brz-tp-heading3 brz-text-lg-center"><span class="brz-cp-color8">Check out what clients say</span></h3>'
                      }
                    }
                  ],
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-subtitle brz-text-lg-center"><span class="brz-cp-color6" style="opacity: 0.75;"><span>The $79 iWork \u201908 appears to be a good deal for anyone needing</span></span></p>'
                      }
                    }
                  ],
                  marginTopSuffix: "px",
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      _styles: ["richText"],
                                                      text:
                                                        '<h5 class="brz-tp-heading5"><span class="brz-cp-color8">Frances Wagner</span></h5>',
                                                      customCSS: ""
                                                    }
                                                  }
                                                ],
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      _styles: ["richText"],
                                                      text:
                                                        '<p class="brz-tp-heading6"><span class="brz-cp-color6"><span>Corporate Accountant</span></span></p>'
                                                    }
                                                  }
                                                ],
                                                marginTopSuffix: "px",
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      _styles: ["richText"],
                                                      text:
                                                        '<h5 class="brz-tp-heading5"><span class="brz-cp-color8">Lassy Chester</span></h5>',
                                                      customCSS: ""
                                                    }
                                                  }
                                                ],
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      _styles: ["richText"],
                                                      text:
                                                        '<p class="brz-tp-heading6"><span class="brz-cp-color8"><span>Corporate Accountant</span></span></p>',
                                                      customCSS: ""
                                                    }
                                                  }
                                                ],
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      _styles: ["richText"],
                                                      text:
                                                        '<h5 class="brz-tp-heading5"><strong class="brz-cp-color2">Matilda Ellis</strong></h5>',
                                                      customCSS: ""
                                                    }
                                                  }
                                                ],
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      _styles: ["richText"],
                                                      text:
                                                        '<h5 class="brz-tp-heading6"><span class="brz-cp-color2">Art Director</span></h5>',
                                                      customCSS: ""
                                                    }
                                                  }
                                                ],
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      _styles: ["richText"],
                                                      text:
                                                        '<h5 class="brz-tp-heading5"><strong class="brz-cp-color8">Lassy Chester</strong></h5>',
                                                      customCSS: ""
                                                    }
                                                  }
                                                ],
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      _styles: ["richText"],
                                                      text:
                                                        '<h5 class="brz-tp-heading6"><span class="brz-cp-color8">Corporate Accountant</span></h5>',
                                                      customCSS: ""
                                                    }
                                                  }
                                                ],
