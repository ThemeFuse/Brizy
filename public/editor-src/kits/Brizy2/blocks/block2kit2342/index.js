                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5"><span class="brz-cp-color2">Startup</span></h5>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-left brz-text-xs-left brz-tp-heading2"><span class="brz-cp-color2">$29/mon.</span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-left brz-text-xs-left brz-tp-heading2"><span class="brz-cp-color2">$35/mon.</span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5"><span class="brz-cp-color2">Professional</span></h5>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-left brz-text-xs-left brz-tp-heading2"><span class="brz-cp-color2"><span>$67/mon.</span></span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-paragraph"><span style="opacity: 0.7;" class="brz-cp-color2">Limited offer, save 20% for annual plan only till 30 of March</span></p>'
                      }
                    }
                  ],
