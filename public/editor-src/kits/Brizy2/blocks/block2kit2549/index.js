                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle"><span style="opacity: 0.8;" class="brz-cp-color6">FASHION OUTLET</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-tp-heading1"><span class="brz-cp-color8">Travel Gear &amp; Fashion</span></h1>'
                                  }
                                }
                              ],
                              mobileMarginType: "grouped"
