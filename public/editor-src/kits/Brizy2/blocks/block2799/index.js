                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5"><span class="brz-cp-color8">Startup</span></h5>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading2 brz-text-xs-left brz-text-lg-left"><span class="brz-cp-color8">$29/mon.</span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color8"><span>Auto update mode</span></span></h5>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color8"><span>Online operator 24/7</span></span></h5>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5"><span class="brz-cp-color2">Medium</span></h5>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-left brz-text-xs-left brz-tp-heading2"><span class="brz-cp-color2"><span>$35/mon.</span></span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5"><span class="brz-cp-color8">Professional</span></h5>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading2 brz-text-xs-left brz-text-lg-left"><span class="brz-cp-color8"><span>$67/mon.</span></span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-paragraph"><span style="opacity: 0.6;" class="brz-cp-color8">Limited offer, save 20% for annual plan only till 30 of March</span></p>'
                      }
                    }
                  ],
                  mobilePaddingType: "ungrouped",
