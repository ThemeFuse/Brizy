                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-text-xs-center brz-tp-heading2"><span class="brz-cp-color2">Time to invest wisely</span></h2>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle brz-text-xs-center"><span class="brz-cp-color7">If you are in the market for a computer, there are a number of factors to consider.</span></p>'
                                  }
                                }
                              ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h6 class="brz-text-xs-justify brz-tp-heading6"><span class="brz-cp-color2"><span>Innovate bleeding-edge solutions</span></span></h6>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h6 class="brz-tp-heading6"><span class="brz-cp-color2"><span>Brand web-enabled schemas</span></span></h6>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h6 class="brz-tp-heading6"><span class="brz-cp-color2"><span>Cultivate real-time markets</span></span></h6>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
