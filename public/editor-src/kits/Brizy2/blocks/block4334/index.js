                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-text-xs-center brz-tp-heading1"><span class="brz-cp-color2">Get ready!&nbsp;We\'re opening soon\u2026</span></h1>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-subtitle"><span class="brz-cp-color8">Subscribe to get a coupon code for 20% off your first purchase or scan the QR code on the right:</span></p>'
                                  }
                                }
                              ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<p class="brz-tp-heading5"><span class="brz-cp-color8">Impressively Quick</span></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.8;"><span>Allergies and chemical sensitivities are a symptom of a compromised immune system. Simple &amp; efficient.</span></span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<p class="brz-tp-heading5"><span class="brz-cp-color8">The Start-up</span></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.8;"><span>Candida overgrowth in the body may be the precursor to immune function causing all kinds of illness.</span></span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<p class="brz-tp-heading5"><span class="brz-cp-color8">Our Benefits</span></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.8;"><span>Parties and family gatherings are popular this time of year. Whether you\u2019re celebrating.</span></span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
