                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-tp-heading6"><span class="brz-cp-color2">Fast Response</span></h6>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color7">Reality is also transforming the world of education, where content may be accessed by scanning or</span></p>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-tp-heading6"><span class="brz-cp-color2">Minimal Design</span></h6>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color7">The disadvantages are the all physical constraints of the user having to hold the handheld device.</span></p>'
                                  }
                                }
                              ],
                              mobileMarginType: "grouped"
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-mb-sm-10"><span class="brz-cp-color7"><span>A precursor technology to new tech reality, heads-up displays were first developed for pilots, so it\u2019s super amazing and really important</span></span></p>'
                                  }
                                }
                              ]
                            }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h6 class="brz-tp-heading6"><span class="brz-cp-color2">Layla Robinson</span></h6>'
                                              }
                                            }
                                          ],
                                          marginBottomSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-abovetitle"><span class="brz-cp-color7" style="opacity: 0.7;">ARCHITECT</span></p>'
                                              }
                                            }
                                          ],
                                          mobileMarginType: "grouped",
