                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-text-lg-center brz-tp-heading1"><span class="brz-cp-color8">5 Reasons To Purchase Desktop Computers</span></h1>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-subtitle"><span class="brz-cp-color8" style="opacity: 0.6;">Do you know what could beat the exciting feeling of having a new computer? Make your own PC!</span></p>'
                      }
                    }
                  ],
