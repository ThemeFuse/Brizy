                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-tp-heading1 brz-text-xs-center"><span class="brz-cp-color8">Best Headphones For Audiophiles</span></h1>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle brz-text-xs-center"><span class="brz-cp-color8">Usage of the Internet is becoming more common due to rapid advancement of technology and the power of globalization.</span></p>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-paragraph brz-text-lg-right"><span class="brz-cp-color6">Headset No Longer Wired For Sound</span></p>'
                                  }
                                }
                              ]
                            }
