      ...
      items: [
        {
          ...
          value: {
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color2">How to generate new sales by nurturing stale leads</span></p>'
                      }
                    }
                  ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-tp-heading6"><span class="brz-cp-color2"><span>We all have stale contacts in our lists</span></span></h6>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color7" style="opacity: 0.8;">\u201cConversion rates have been going up 12% since we moved our entire platform to these guys! Definately recommended\u201d</span></p>'
                                  }
                                }
                              ],
                              tabletPaddingType: "ungrouped",
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<p class="brz-tp-paragraph"><span class="brz-cp-color7" style="opacity: 0.8;">How to nurture leads and convert with up to 3x better rates</span></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<p class="brz-tp-paragraph"><span class="brz-cp-color7" style="opacity: 0.8;">Maximise lifecycle sales and conversions</span></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<p class="brz-tp-paragraph"><span class="brz-cp-color7" style="opacity: 0.8;">Leave less on the table. Every lead is a good lead!</span></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle"><span class="brz-cp-color7" style="opacity: 0.8;">ON THE CALL:</span></p>'
                                  }
                                }
                              ]
                            }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-heading6"><span class="brz-cp-color2">Edward Burns</span></p>'
                                              }
                                            }
                                          ],
                                          marginBottomSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color7" style="opacity: 0.8;"><span>Marketing Lead, Gofre</span></span></p>'
                                              }
                                            }
                                          ],
                                          marginTopSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-heading6"><span class="brz-cp-color2">Mabelle Perry</span></p>'
                                              }
                                            }
                                          ],
                                          marginBottomSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color7">Copyrighter, Morandis</span></p>'
                                              }
                                            }
                                          ],
                                          marginTopSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-heading6"><span class="brz-cp-color2">Lola Franklin</span></p>'
                                              }
                                            }
                                          ],
                                          marginBottomSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color7">Content Manager, Flystag</span></p>'
                                              }
                                            }
                                          ],
                                          marginTopSuffix: "px",
            ...
            bgImageWidth: 1440,
            bgImageHeight: 880,
            bgImageSrc: "d08-d08-background15.jpg",
            bgColorOpacity: 0,
            tempBgColorOpacity: 1,
            borderRadius: 0,
            borderTopLeftRadius: 0,
