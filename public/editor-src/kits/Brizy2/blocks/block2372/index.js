                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h3 class="brz-tp-heading3"><strong class="brz-cp-color2">Company</strong></h3>'
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-heading3 brz-text-lg-right brz-text-xs-right"><strong class="brz-cp-color2">$99</strong></p>'
                                              }
                                            }
                                          ],
                                          marginTopSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading6"><span class="brz-cp-color2">Best option for companies and corporations  who want to have all</span></p>'
                                  }
                                }
                              ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color2">Auto update mode</span></h5>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color2">Online operator 24/7</span></h5>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color2">International posting</span></h5>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color2">Unique newsletters</span></h5>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color2">20 Design templates</span></h5>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color2">35 Vector Icons</span></h5>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color2">Slider Compatibility</span></h5>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h3 class="brz-tp-heading3"><strong class="brz-cp-color8">Startup</strong></h3>'
                                              }
                                            }
                                          ],
                                          marginBottomSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-heading3 brz-text-lg-right brz-text-xs-right"><strong class="brz-cp-color8">$29</strong></p>'
                                              }
                                            }
                                          ],
                                          marginTopSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading6"><span class="brz-cp-color8">Best option for small businesses, start ups and personal projects</span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color8">Auto update mode</span></h5>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color8">Online operator 24/7</span></h5>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color8">International posting</span></h5>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color8">Unique newsletters</span></h5>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-sm-center brz-tp-heading4 brz-text-xs-center"><strong class="brz-cp-color2">01</strong></h4>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-sm-center brz-tp-subtitle brz-text-xs-center"><span class="brz-cp-color7"><span>Usage of the Internet is becoming more common due to rapid advancement.</span></span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-sm-center brz-tp-heading4 brz-text-xs-center"><strong class="brz-cp-color2">02</strong></h4>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-sm-center brz-tp-subtitle brz-text-xs-center"><span class="brz-cp-color7"><span>All the rumors have finally died down and many skeptics have tightened their lips.</span></span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-sm-center brz-tp-heading4 brz-text-xs-center"><strong class="brz-cp-color2">03</strong></h4>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-sm-center brz-tp-subtitle brz-text-xs-center"><span class="brz-cp-color7"><span>Research in advertising is done in order to produce better advertisements.</span></span></p>'
                                  }
                                }
                              ]
                            }
