                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-text-lg-center brz-tp-heading3"><span class="brz-cp-color8">Ageing Skin Care Doesn\u2019t Hurt</span></h3>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-center"><span class="brz-cp-color6" style="opacity: 0.75;"><span>Long years ago, you have to wear two sets of eye glasses, then doctors discovered.</span></span></p>'
                                  }
                                }
                              ],
                              tabletPaddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-text-lg-center brz-tp-heading3"><span class="brz-cp-color2" style="text-shadow: rgba(0, 0, 0, 0.29) 0px 0px 0px;">The Best Wireless Earbuds</span></h3>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-center"><span style="text-shadow: rgba(0, 0, 0, 0.3) 0px 0px 0px;" class="brz-cp-color2"><span>Computer users and programmers have become so accustomed to using Windows.</span></span></p>'
                                  }
                                }
                              ],
                              tabletPaddingType: "ungrouped",
