                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle"><span class="brz-cp-color8" style="opacity: 0.6;">FEATURED STORY</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color8" style="opacity: 0.6;">You may be a skillful, effective employer but if you don\u2019t trust your personnel and the opposite, then the chances of improving and expanding the business you deal with, are extremely limited. </span></h4>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2"><span class="brz-cp-color8">As we grow, we do so in fits and starts, lurching forward then back, sometimes looking more like clowns than seekers.</span></h2>'
                                  }
                                }
                              ],
                              showOnTablet: "on"
