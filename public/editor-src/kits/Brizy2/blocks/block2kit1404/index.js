                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-abovetitle brz-text-lg-center"><span class="brz-cp-color7" style="opacity: 0.7;">HOW TO BUILD YOUR BUSINESS</span></p>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color2">Cultivate integrated markets</span></h1>'
                      }
                    }
                  ],
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-subtitle"><span class="brz-cp-color7">Do you want to download free song for ipod? If so, reading this article could save you from getting in to a lot of trouble!</span></p>'
                      }
                    }
                  ],
                  marginRightSuffix: "%",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-text-lg-left brz-tp-heading5"><span class="brz-cp-color2">Free Trial</span></h5>'
                                  }
                                }
                              ],
                              marginLeftSuffix: "px",
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h6 class="brz-tp-heading6"><span class="brz-cp-color7"><span>Requires Mac OS X 10.9+ or Windows 10</span></span></h6>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h6 class="brz-tp-heading6"><span class="brz-cp-color7"><span>Unlimited access</span></span></h6>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h6 class="brz-tp-heading6"><span class="brz-cp-color7"><span>Uninstall steps here if you don\u2019t like it</span></span></h6>'
                                        }
                                      }
                                    ]
                                  }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-text-lg-left brz-tp-heading5"><span class="brz-cp-color2">Professional</span></h5>'
                                  }
                                }
                              ],
                              marginLeftSuffix: "px",
