                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1"><span class="brz-cp-color8">We Craft Super Mobile Apps</span></h1>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-subtitle"><span style="opacity: 0.75;" class="brz-cp-color6"><span>Over 92% of computers are infected with Adware and spyware. Such software is rarely accompanied by uninstall utility and even when it is it almost always leaves broken Windows Registry keys behind it.</span></span></p>'
                      }
                    }
                  ],
                  marginRightSuffix: "%",
