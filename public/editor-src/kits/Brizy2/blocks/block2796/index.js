                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2"><span class="brz-cp-color8">Check our pricing options </span></h2>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.6;"><span>When you browse through videos at YouTube, which do you usually click first: one with around 10 views or one with around 75,000 views?</span></span></p>'
                                  }
                                }
                              ]
                            }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">Phone</span></h4><p class="brz-tp-heading5"><span class="brz-cp-color8" style="opacity: 0.6;"><span>129-828-7534</span></span><strong class="brz-cp-color8" style="opacity: 0.6;"><span> </span></strong></p>'
                                        }
                                      }
                                    ]
                                  }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h3 class="brz-tp-heading3"><span class="brz-cp-color8">Company</span></h3>'
                                              }
                                            }
                                          ],
                                          marginBottomSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-text-xs-right brz-tp-heading3 brz-text-lg-right"><span class="brz-cp-color8">$99</span></p>'
                                              }
                                            }
                                          ],
                                          marginTopSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading6"><span class="brz-cp-color6">Best option for companies and corporations who want to have all</span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color8">20 Design templates</span></h5>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color8">35 Vector Icons</span></h5>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5"><span class="brz-cp-color8">Slider Compatibility</span></h5>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
