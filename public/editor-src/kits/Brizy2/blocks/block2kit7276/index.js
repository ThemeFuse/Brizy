                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2"><span class="brz-cp-color8">Target integrated users</span></h2>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color6" style="opacity: 1;"><span>If you are looking for a new way to promote your business that won\u2019t cost you more money, maybe printing is one of the options you won\u2019t resist. Printing is a widely use process in making printed.</span></span></p>'
                                  }
                                }
                              ]
                            }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h4 class="brz-tp-heading5"><span class="brz-cp-color8">Address</span></h4>'
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color6" style="opacity: 0.75;">548 Kacey Green Apt. 275</span></p><p class="brz-tp-paragraph brz-text-lg-left"><span class="brz-cp-color6" style="opacity: 0.75;">Manhattan, NY City</span></p>'
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h4 class="brz-tp-heading5"><span class="brz-cp-color8">Email</span></h4>'
                                              }
                                            }
                                          ],
                                          marginBottomSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph brz-text-lg-left"><span class="brz-cp-color3">reichel_arlene@gmail.com</span></p>'
                                              }
                                            }
                                          ],
                                          tabletMarginType: "grouped",
