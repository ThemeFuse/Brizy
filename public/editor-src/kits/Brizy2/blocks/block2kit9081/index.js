                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-left brz-tp-abovetitle"><span class="brz-cp-color6" style="opacity: 0.75;">NEW DECO IDEAS</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-text-lg-left brz-tp-heading2"><span class="brz-cp-color8">Decorate For Less With Art Posters &amp; Tasty Accesories</span></h2>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-left brz-tp-subtitle"><span class="brz-cp-color6" style="opacity: 0.75;"><span>Differentiate and you stand out in a very crowded marketplace. Present your uniquen emphasize</span></span></p>'
                                  }
                                }
                              ]
                            }
