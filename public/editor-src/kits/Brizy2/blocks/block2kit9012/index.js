                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-mt-lg-10 brz-tp-heading4 brz-mt-xs-0 brz-mt-sm-0"><span class="brz-cp-color8">Addiction When Gambling</span></h4>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><span class="brz-cp-color6" style="opacity: 0.75;"><span>Optimize next-generation bandwidth</span></span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-mt-lg-10 brz-tp-heading4 brz-mt-xs-0 brz-mt-sm-0"><span class="brz-cp-color8">No Longer Wired For Sound</span></h4>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><span class="brz-cp-color6" style="opacity: 0.75;"><span>Expedite innovative deliverables</span></span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-mt-lg-10 brz-tp-heading4 brz-mt-xs-0 brz-mt-sm-0"><span class="brz-cp-color8">Looking For Printing Solutions</span></h4>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><span class="brz-cp-color6" style="opacity: 0.75;"><span>Deliver customized e-business</span></span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
