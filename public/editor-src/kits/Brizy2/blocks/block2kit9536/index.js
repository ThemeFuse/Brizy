                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle brz-text-lg-left"><span class="brz-cp-color6" style="opacity: 0.75;">OPTIMIZE UBIQUITOUS ACTION-ITEMS</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-text-lg-left brz-tp-heading1"><span class="brz-cp-color8">In order to succeed, your desire for success should be greater than your fear of failure.</span></h1>'
                                  }
                                }
                              ],
