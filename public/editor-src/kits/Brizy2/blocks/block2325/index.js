                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2"><span class="brz-cp-color2">Check our pricing options </span></h2>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>When you browse through videos at YouTube, which do you usually click first: one with around 10 views or one with around 75,000 views?</span></span></p>'
                                  }
                                }
                              ]
                            }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">Phone</span></h4><p class="brz-tp-heading5"><span class="brz-cp-color7"><span>129-828-7534</span></span><strong class="brz-cp-color7"><span> </span></strong></p>'
                                        }
                                      }
                                    ]
                                  }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h3 class="brz-tp-heading3"><span class="brz-cp-color8">Startup</span></h3>'
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-text-xs-right brz-text-lg-right brz-tp-heading3"><span class="brz-cp-color8">$29</span></p>'
                                              }
                                            }
                                          ],
                                          marginTopSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h3 class="brz-tp-heading3"><span class="brz-cp-color2">Company</span></h3>'
                                              }
                                            }
                                          ],
                                          marginBottomSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-text-xs-right brz-text-lg-right brz-tp-heading3"><span class="brz-cp-color2">$99</span></p>'
                                              }
                                            }
                                          ],
                                          marginTopSuffix: "px",
