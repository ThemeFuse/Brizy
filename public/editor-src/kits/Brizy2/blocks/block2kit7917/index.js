                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-abovetitle brz-text-lg-center"><span class="brz-cp-color6" style="opacity: 0.7;">STAY IN TOUCH WITH OUR LATEST NEWS</span></p>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color8">Last Minute Festive Packages From Superbreak Sign-up</span></h1>'
                      }
                    }
                  ],
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-mt-lg-20 brz-tp-paragraph"><span class="brz-cp-color6" style="opacity: 0.75;"><span>Attention! Offer expires in 30 days. Make sure not to miss this opportunity</span></span></p>'
                      }
                    }
                  ],
                  mobilePaddingType: "ungrouped",
