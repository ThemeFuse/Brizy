                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-abovetitle"><span class="brz-cp-color6" style="opacity: 0.75;">HOW TO BUILD YOUR BUSINESS</span></p>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-text-lg-center brz-tp-heading1"><span class="brz-cp-color8"><span>Cultivate integrated markets</span></span></h1>'
                      }
                    }
                  ],
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-subtitle brz-text-lg-center"><span class="brz-cp-color6" style="opacity: 0.75;"><span>Do you want to download free song for ipod? If so, reading this article could save you from getting in to a lot of trouble!</span></span></p>'
                      }
                    }
                  ],
                  marginRightSuffix: "%",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-lg-left"><span class="brz-cp-color8">Free Trial</span></h5>'
                                  }
                                }
                              ],
                              marginLeftSuffix: "px",
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h6 class="brz-tp-heading6"><span class="brz-cp-color8"><span>Requires Mac OS X 10.9+ or Windows 10</span></span></h6>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h6 class="brz-tp-heading6"><span class="brz-cp-color8"><span>Unlimited access</span></span></h6>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h6 class="brz-tp-heading6"><span class="brz-cp-color8"><span>Uninstall steps here if you don\u2019t like it</span></span></h6>'
                                        }
                                      }
                                    ]
                                  }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-lg-left"><span class="brz-cp-color8">Professional</span></h5>'
                                  }
                                }
                              ],
                              marginLeftSuffix: "px",
