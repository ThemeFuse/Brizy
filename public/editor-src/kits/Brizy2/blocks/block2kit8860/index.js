                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-mb-lg-10 brz-tp-heading4 brz-mt-lg-8"><span class="brz-cp-color8"><span>Reach Ever Further</span></span></h4><p class="brz-tp-paragraph"><span class="brz-cp-color6" style="opacity: 0.75;"><span>I have hinted that I would often jerk poor Queequeg from between the whale.</span></span></p>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-mt-lg-8 brz-mb-lg-10 brz-tp-heading4"><span class="brz-cp-color8">Chat Platforms</span></h4><p class="brz-tp-paragraph"><span class="brz-cp-color6" style="opacity: 0.75;"><span>I have hinted that I would often jerk poor Queequeg from between the whale.</span></span></p>',
                                          customCSS: ""
                                        }
                                      }
                                    ],
