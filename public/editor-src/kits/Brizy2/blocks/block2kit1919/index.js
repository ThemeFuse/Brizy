                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color2">Get started with 14 days trial</span></h2>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-subtitle"><span class="brz-cp-color7">If you want to take your cooking skills up another notch then it might be time to look at changing to a gas stove.</span></p>'
                                  }
                                }
                              ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h4 class="brz-mb-lg-0 brz-tp-heading4"><span class="brz-cp-color2">Phone</span></h4><p class="brz-tp-heading5"><span class="brz-cp-color7"><span>129-828-7534</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-mb-lg-0 brz-tp-heading4"><span class="brz-cp-color2">Address</span></h4><p class="brz-tp-heading5"><span class="brz-cp-color7"><span>710 Russel Station Suite 315</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h4 class="brz-text-xs-left brz-tp-heading4"><span class="brz-cp-color2">Socials</span></h4>'
                                              }
                                            }
                                          ],
