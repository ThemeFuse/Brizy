                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color2">Meet our team</span></h2>'
                      }
                    }
                  ]
                }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-tp-heading6"><span class="brz-cp-color2">Harriet Houston</span></h6>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color2">Creative Director</span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-tp-heading6"><span class="brz-cp-color2">Lois Daniel</span></h6>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-tp-heading6"><span class="brz-cp-color2">Jay Peters</span></h6>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-tp-heading6"><span class="brz-cp-color2">Shawn Lawson</span></h6>',
                                    customCSS: ""
                                  }
                                }
                              ],
