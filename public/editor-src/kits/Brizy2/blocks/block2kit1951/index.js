                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-mt-sm-0 brz-mt-xs-0 brz-tp-heading4 brz-mt-lg-10"><span class="brz-cp-color2">Addiction When Gambling</span></h4>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><span class="brz-cp-color7">Optimize next-generation bandwidth</span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-mt-sm-0 brz-mt-xs-0 brz-tp-heading4 brz-mt-lg-10"><span class="brz-cp-color2">No Longer Wired For Sound</span></h4>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><span class="brz-cp-color7">Expedite innovative deliverables</span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-mt-sm-0 brz-mt-xs-0 brz-tp-heading4 brz-mt-lg-10"><span class="brz-cp-color2">Looking For Printing Solutions</span></h4>'
                                  }
                                }
                              ],
                              marginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><span class="brz-cp-color7">Deliver customized e-business</span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
