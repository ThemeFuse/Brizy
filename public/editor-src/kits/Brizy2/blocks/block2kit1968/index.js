                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2 brz-text-xs-center"><strong class="brz-cp-color2">Last workshop stuff</strong></h2>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle brz-text-lg-right brz-text-xs-center"><strong class="brz-cp-color7" style="opacity: 0.7;">GREAT UPDATES</strong></p>'
                                  }
                                }
                              ]
                            }
