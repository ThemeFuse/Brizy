                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-tp-heading2 brz-text-lg-center"><span class="brz-cp-color8">Our offices</span></h2>'
                      }
                    }
                  ],
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-subtitle brz-text-lg-center"><span class="brz-cp-color6" style="opacity: 0.75;">Contact one of our departments to talk to us</span></p>'
                      }
                    }
                  ],
                  marginType: "grouped",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h4 class="brz-mt-lg-10 brz-tp-heading4 brz-mb-lg-10 brz-mt-xs-0 brz-mb-xs-0"><span class="brz-cp-color8">Tel Aviv</span></h4>'
                                              }
                                            }
                                          ],
                                          paddingType: "grouped",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h6 class="brz-tp-heading6"><span class="brz-cp-color6" style="opacity: 0.75;"><span>renner_malvina@hotmail.com</span></span></h6>'
                                              }
                                            }
                                          ],
                                          paddingType: "grouped",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h6 class="brz-tp-heading6"><span class="brz-cp-color6" style="opacity: 0.75;"><span>368-757-5918</span></span></h6>'
                                              }
                                            }
                                          ],
                                          paddingType: "grouped",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h4 class="brz-mt-lg-10 brz-tp-heading4 brz-mb-lg-10 brz-mt-xs-0 brz-mb-xs-0"><span class="brz-cp-color8">Sydney</span></h4>'
                                              }
                                            }
                                          ],
                                          paddingType: "grouped",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h6 class="brz-tp-heading6"><span class="brz-cp-color6" style="opacity: 0.75;"><span>melissa_bashirian@hotmail.com</span></span></h6>'
                                              }
                                            }
                                          ],
                                          paddingType: "grouped",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h6 class="brz-tp-heading6"><span class="brz-cp-color6" style="opacity: 0.75;"><span>076-443-3098</span></span></h6>'
                                              }
                                            }
                                          ],
                                          paddingType: "grouped",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h4 class="brz-mb-lg-10 brz-tp-heading4 brz-mt-lg-10 brz-mt-xs-0 brz-mb-xs-0"><span class="brz-cp-color8" style="opacity: 1;">Moscow</span></h4>'
                                              }
                                            }
                                          ],
                                          paddingType: "grouped",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h6 class="brz-tp-heading6"><span class="brz-cp-color6" style="opacity: 0.75;"><span>mark-nodine@demand.com</span></span></h6>'
                                              }
                                            }
                                          ],
                                          paddingType: "grouped",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h6 class="brz-tp-heading6"><span class="brz-cp-color6" style="opacity: 0.75;"><span>178-575-8478</span></span></h6>'
                                              }
                                            }
                                          ],
                                          paddingType: "grouped",
