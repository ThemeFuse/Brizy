                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-xs-center brz-tp-heading4"><span class="brz-cp-color2">Augmented Reality</span></h4>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-xs-center brz-tp-heading4"><span class="brz-cp-color2">Visual Arts</span></h4>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-xs-center brz-tp-heading4"><span class="brz-cp-color2">Features</span></h4>',
                                    customCSS: ""
                                  }
                                }
                              ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h3 class="brz-tp-heading3"><span class="brz-cp-color8">Innovate bleeding-edge solutions</span></h3>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color6">When it comes to Inflammatory Bowel Disorder (IBD), most people are aware of ulcerative colitis. This is a disorder...</span></p>'
                                              }
                                            }
                                          ]
                                        }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-xs-center brz-tp-heading4"><span class="brz-cp-color2">Contemporary</span></h4>'
                                  }
                                }
                              ],
                              tabletMarginType: "grouped"
