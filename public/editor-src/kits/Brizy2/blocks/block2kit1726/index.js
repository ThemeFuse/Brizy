                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><strong class="brz-cp-color2">Design Popups that Boost Your Client\u2019s Conversions</strong></h4>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><strong class="brz-cp-color2">Learn the Most In-Demand Job Skill - Coding</strong></h4>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><strong class="brz-cp-color2">Web Performance Mini Series: Animations</strong></h4>'
                                  }
                                }
                              ]
                            }
