                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-tp-heading1 brz-text-xs-center"><span class="brz-cp-color2">The Best Solutions</span></h1>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-xs-center brz-tp-subtitle"><span class="brz-cp-color2"><span>For Your Cloud Management &amp; Collaboration</span></span></h4>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
