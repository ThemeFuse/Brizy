                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h3 class="brz-text-lg-center brz-tp-heading3"><span class="brz-cp-color2">Check out what clients say</span></h3>'
                      }
                    }
                  ],
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-subtitle"><span class="brz-cp-color7">The $79 iWork \u201908 appears to be a good deal for anyone needing</span></p>'
                      }
                    }
                  ],
                  marginTopSuffix: "px",
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      _styles: ["richText"],
                                                      text:
                                                        '<h5 class="brz-tp-heading5"><span class="brz-cp-color2">Frances Wagner</span></h5>',
                                                      customCSS: ""
                                                    }
                                                  }
                                                ],
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      _styles: ["richText"],
                                                      text:
                                                        '<p class="brz-tp-heading6"><span class="brz-cp-color2"><span>Corporate Accountant</span></span></p>'
                                                    }
                                                  }
                                                ],
                                                marginTopSuffix: "px",
