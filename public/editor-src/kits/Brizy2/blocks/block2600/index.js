                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-tp-heading2 brz-text-lg-center"><span class="brz-cp-color8">Deliver 24/7 supply-chains</span></h2>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-subtitle"><span class="brz-cp-color8" style="opacity: 0.6;">People are wanting to fly to international destinations for vacations but planning a holiday getaway can easily turn.</span></p>'
                      }
                    }
                  ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-xs-center"><span class="brz-cp-color8">Envisioneer magnetic synergies</span></h5>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-xs-center"><span class="brz-cp-color8" style="opacity: 0.6;">Looking cautiously round, to ascertain that they were not overheard, the two hags cowered nearer to the fire, and chuckled heartily</span></p>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-xs-center"><span class="brz-cp-color8">Drive dot-com e-services</span></h5>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-xs-center"><span class="brz-cp-color8" style="opacity: 0.6;">She gave my mother such a turn, that I have always been convinced I am indebted to Miss Betsey for having been born on a Friday.</span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-xs-center"><span class="brz-cp-color8">Utilize customized content</span></h5>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.6;">Thus much I thought proper to tell you in relation to yourself, and to the trust I reposed in you.</span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-xs-center"><span class="brz-cp-color8">Engage synergistic portals</span></h5>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.6;">This I have produced as a scantling of Jack\u2019s great eloquence and the force of his reasoning upon such abstruse matters.</span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
