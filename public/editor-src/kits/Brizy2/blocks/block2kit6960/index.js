                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-tp-heading3 brz-mt-xs-10"><span class="brz-cp-color8">Got some ideas for a project?</span></h3>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-tp-heading3 brz-mb-xs-10"><span class="brz-cp-color8">Drop us a line will be glad to here from you </span></h3>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
