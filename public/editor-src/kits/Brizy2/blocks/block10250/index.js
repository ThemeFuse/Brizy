                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-abovetitle"><span style="opacity: 0.75;" class="brz-cp-color6"><span>3 STEP GUIDE FOR BUSINESS OWNERS&nbsp;</span></span></p>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-mb-lg-20 brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color8">Understand What the Metrics Tell you</span></p>'
                      }
                    }
                  ],
                  marginType: "grouped"
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-abovetitle brz-text-lg-center"><span class="brz-cp-color7" style="opacity: 0.8;"><span>TRUSTED BY:</span></span></p>'
                      }
                    }
                  ]
                }
