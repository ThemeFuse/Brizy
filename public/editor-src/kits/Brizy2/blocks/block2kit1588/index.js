                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h3 class="brz-tp-heading3"><span class="brz-cp-color2">Having a baby can be a nerve wracking experience for new parents \u2013 not the nine months of pregnancy.</span></h3>'
                      }
                    }
                  ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5"><span class="brz-cp-color2">Architect web-enabled</span></h5>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-mb-xs-15"><span class="brz-cp-color7"><span>We must now retrace our way a little. It was mentioned that upon first breaking ground in the whale\'s back.</span></span></p>'
                                  }
                                }
                              ],
                              marginType: "grouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-mb-xs-15"><span class="brz-cp-color7"><span>But this was not the only jamming jeopardy he was exposed to.</span></span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5"><span class="brz-cp-color2">Transform B2C e-services</span></h5>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-mb-xs-15"><span class="brz-cp-color7"><span>I have hinted that I would often jerk poor Queequeg from between the whale and the ship.</span></span></p>',
                                    customCSS: ""
                                  }
                                }
                              ],
