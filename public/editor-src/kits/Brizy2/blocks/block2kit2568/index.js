                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2"><span class="brz-cp-color8">Give your clients the best possible experience</span></h2>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><span class="brz-cp-color8" style="opacity: 0.6;">The world has become so fast paced that people don\u2019t want to stand by reading a page of info</span></p>'
                                  }
                                }
                              ]
                            }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">Exportable Data Sets</span></h4>'
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.61;">Adwords Keyword research for beginners When you embark on your first PPC journey.</span></p>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.6;">Photographs are a way of preserving a moment in our lives for the rest of our lives. Many of us have.</span></p>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">Content Customization</span></h4>'
                                              }
                                            }
                                          ],
                                          marginBottomSuffix: "px",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.6;">Adwords Keyword research for beginners When you embark on your first PPC journey.</span></p>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">Automation Workflows</span></h4>'
                                              }
                                            }
                                          ],
                                          marginBottomSuffix: "px",
