                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-abovetitle"><span class="brz-cp-color8" style="opacity: 0.6;">TIPS &amp; TRICKS</span></p>'
                      }
                    }
                  ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-tp-heading3"><span class="brz-cp-color8">Ever heard of the Fuller Brush Man? You know, those legendary guys who came.</span></h3>'
                                  }
                                }
                              ]
                            }
