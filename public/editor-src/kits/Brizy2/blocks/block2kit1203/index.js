                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle"><span class="brz-cp-color7" style="opacity: 0.6;">INNOVATIVE DESIGN</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-tp-heading1"><span class="brz-cp-color2">Binary watch face smart watch because why not</span></h1>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle brz-mt-lg-10 brz-mb-lg-20"><span class="brz-cp-color7"><span>Before cell phones became so popular, watches were much more attractive to carry around because they are the most convenient way to keep track of the time. </span></span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
