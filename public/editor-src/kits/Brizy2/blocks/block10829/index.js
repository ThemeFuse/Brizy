                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2 brz-text-sm-center brz-text-xs-center"><span class="brz-cp-color8">Dream team</span></h2>'
                                  }
                                }
                              ]
                            }
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<h6 class="brz-text-sm-center brz-text-lg-left brz-tp-heading6 brz-text-xs-center"><span class="brz-cp-color8">Ashley Richadson</span></h6>',
                                                      customCSS: ""
                                                    }
                                                  }
                                                ],
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<p class="brz-text-xs-center brz-text-lg-left brz-tp-paragraph brz-text-sm-center"><span class="brz-cp-color6" style="opacity: 0.75;"><span>Creative Director</span></span></p>',
                                                      customCSS: ""
                                                    }
                                                  }
                                                ],
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<h6 class="brz-text-sm-center brz-tp-heading6 brz-text-lg-left brz-text-xs-center"><span class="brz-cp-color8">Ashley Richadson</span></h6>',
                                                      customCSS: ""
                                                    }
                                                  }
                                                ],
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<p class="brz-text-xs-center brz-text-sm-center brz-tp-paragraph brz-text-lg-left"><span class="brz-cp-color6" style="opacity: 0.75;"><span>Creative Director</span></span></p>',
                                                      customCSS: ""
                                                    }
                                                  }
                                                ],
