                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color2">Grow Your Business Like A Garden</span></h1>'
                      }
                    }
                  ],
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color7" style="opacity: 0.8;"><span>Monetize Your Live Broadcasts &amp; Grow Your Audience</span></span></p>'
                      }
                    }
                  ],
                  mobilePaddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-mb-xs-0 brz-mb-lg-20 brz-tp-heading5 brz-mb-sm-10 brz-mt-sm-10"><span class="brz-cp-color2"><span>Let us show you how our platform can help your business. Schedule a free demo below:</span></span></h5>'
                                  }
                                }
                              ]
                            }
                                                ...
                                                items: [
                                                  ...
                                                  },
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<p class="brz-tp-button"><span class="brz-cp-color2">Live Chat To Support Team</span></p>'
                                                    }
                                                  }
                                                ],
                                                iconSpacing: 10
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-button brz-text-lg-right brz-text-sm-left"><em class="brz-cp-color7" style="opacity: 0.75;">or call 1800 532 234</em></p>'
                                              }
                                            }
                                          ],
