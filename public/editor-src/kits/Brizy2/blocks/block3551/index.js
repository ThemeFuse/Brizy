                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h4 class="brz-tp-heading4"><span class="brz-cp-color8"><span>Basic</span></span></h4>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 30
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-tp-heading4"><span class="brz-cp-color8"><span>Startup</span></span></h4>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 30
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">Premium</span></h4>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 30
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">Pro</span></h4>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 30
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.6;">If you need Full Support, Mobile Version and Custom Domain, but you don\u2019t want spent much, Basic plan \u2014 is what you are looking for!</span></p>'
                                  }
                                }
                              ]
                            }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-text-xs-left brz-tp-heading1 brz-text-lg-right"><span class="brz-cp-color2"><span>$58</span></span></p>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-heading3"><span class="brz-cp-color2">/ mon.</span></p>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color2">- 20% with annual</span></p>'
                                              }
                                            }
                                          ]
                                        }
