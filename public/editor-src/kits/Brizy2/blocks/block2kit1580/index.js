                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-mt-xs-0 brz-mb-xs-0 brz-mb-lg-10 brz-mt-lg-10 brz-tp-heading5"><span class="brz-cp-color2">Cultivate real-time markets</span></h5>'
                                  }
                                }
                              ],
                              marginType: "grouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color7">We must now retrace our way a little. It was mentioned that upon first breaking ground in the whale\'s back.</span></p>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-mb-xs-0 brz-mt-xs-0 brz-tp-heading5 brz-mt-lg-10 brz-mb-lg-10"><span class="brz-cp-color2">Scale killer paradigms</span></h5>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>It was inserted there by my particular friend Queequeg, whose duty it was, as harpooneer, to descend.</span></span></p>'
                                  }
                                }
                              ],
                              mobileMarginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-mb-xs-0 brz-mt-xs-0 brz-tp-heading5 brz-mt-lg-10 brz-mb-lg-10"><span class="brz-cp-color2">Drive e-services</span></h5>',
                                    customCSS: ""
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color7">So down there, some ten feet below the level of the deck, the poor harpooneer flounders about.</span></p>'
                                  }
                                }
                              ],
                              mobileMarginTopSuffix: "px",
