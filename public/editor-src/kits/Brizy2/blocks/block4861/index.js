                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color2">The only marketing tool you\u2019ll ever need. Let\'s get started!</span></h2>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color7">Thinking about overseas adventure travel? Have you put any thought into the best places to go when it comes to overseas adventure travel?&nbsp;</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-text-lg-center brz-tp-heading5"><span class="brz-cp-color3"><span>Start with Lesson #1: Capture More Leads</span></span></h5>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-heading6"><span class="brz-cp-color2">What People Are Saying:</span></p>'
                                  }
                                }
                              ]
                            }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph brz-text-xs-center"><span class="brz-cp-color7"><span>\u201cAmazing features and fast support! Recommended\u201d</span></span></p>'
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-text-xs-center brz-tp-heading6"><span class="brz-cp-color2">Tara Cunningham</span></p>'
                                              }
                                            }
                                          ],
                                          marginTopSuffix: "px",
