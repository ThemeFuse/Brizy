                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-text-lg-center brz-tp-heading1"><span class="brz-cp-color2">Check out what clients say</span></h1>'
                      }
                    }
                  ]
                }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading5 brz-text-xs-center"><span class="brz-cp-color2"><span>\u201cAmazing experience i love it a lot. Thanks to the team dreams come true, great! I really super appreciate there approach om\u201d</span></span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-text-xs-center brz-tp-heading6"><span class="brz-cp-color2">Lassy Chester,</span></h6>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-xs-center"><span class="brz-cp-color2">Art Director</span></p>'
                                  }
                                }
                              ],
                              marginTopSuffix: "px",
