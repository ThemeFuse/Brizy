                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-text-xs-center brz-tp-heading2"><span class="brz-cp-color8">Pricing Plans</span></h2>'
                      }
                    }
                  ]
                }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-text-lg-left brz-tp-heading5"><span class="brz-cp-color8">Startup</span></h5>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-text-xs-right brz-tp-paragraph"><span class="brz-cp-color8" style="opacity: 0.6;"><span>Unlimited Storage, Priority chat, Smart Sync and lots of other features. Great for small businesses</span></span></p>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-text-lg-left brz-tp-heading5"><span class="brz-cp-color8">Medium</span></h5>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-text-lg-left brz-tp-heading5"><span class="brz-cp-color8">Pro</span></h5>'
                                              }
                                            }
                                          ]
                                        }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h5 class="brz-text-lg-left brz-tp-heading5"><span class="brz-cp-color8">Premium</span></h5>'
                                              }
                                            }
                                          ]
                                        }
