                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h3 class="brz-mb-lg-10 brz-tp-heading3"><span class="brz-cp-color8">Engage synergistic portals &amp; users</span></h3><p class="brz-mt-lg-0 brz-tp-paragraph brz-mb-lg-0"><span class="brz-cp-color6" style="opacity: 0.75;"><span>Many of us are so used to working on a computer desktop that when.</span></span></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 25
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h3 class="brz-tp-heading3 brz-mb-lg-10"><span class="brz-cp-color8">Create compelling websites</span></h3><p class="brz-tp-paragraph brz-mb-lg-0 brz-mt-lg-0"><span class="brz-cp-color6" style="opacity: 0.75;"><span>When I was just starting 6th grade I got my first job. Paperboy!</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
