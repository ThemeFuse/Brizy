                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color8">Reinvent open-source architectures</span></h2>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-mb-xs-20 brz-tp-subtitle brz-text-lg-center brz-mb-lg-30"><span class="brz-cp-color6" style="opacity: 0.75;"><span>Few would argue that, despite the advancements of feminism over the past three decades, women still face a double standard.</span></span></p>'
                      }
                    }
                  ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color8"><span>Reinvent B2C deliverables</span></span></p>'
                                              }
                                            }
                                          ],
                                          tabletMarginType: "grouped",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color8"><span>Morph impactful interfaces</span></span></p>',
                                                customCSS: ""
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color8"><span>Brand bleeding-edge web-readiness</span></span></p>'
                                              }
                                            }
                                          ],
                                          tabletMarginType: "grouped"
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color8"><span>Synthesize open-source e-commerce</span></span></p>',
                                                customCSS: ""
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color8"><span>Cultivate back-end methodologies</span></span></p>',
                                                customCSS: ""
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph"><span class="brz-cp-color8"><span>Reinvent open-source architectures</span></span></p>',
                                                customCSS: ""
                                              }
                                            }
                                          ],
