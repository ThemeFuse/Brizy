                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color2">Happiness is not something readymade. It comes from your own actions.</span></h2>'
                      }
                    }
                  ],
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-subtitle brz-text-lg-center"><span class="brz-cp-color7">If you are in the market for a computer, there are a number of factors to consider.</span></p>'
                      }
                    }
                  ],
                  marginType: "grouped",
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h6 class="brz-tp-heading6 brz-mb-lg-20"><span class="brz-cp-color2"><span>Purchase Codes In 43 Different Currencies</span></span></h6><p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>Whether you barbecue on a popularly priced grill.</span></span><strong class="brz-cp-color7" style="opacity: 0.7;"><span> </span></strong></p>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h6 class="brz-tp-heading6 brz-mb-lg-20"><span class="brz-cp-color2">Secure &amp; Reliable Every Single Time</span></h6><p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>Benjamin Franklin, inventor, statesman, writer, publisher.</span></span><strong class="brz-cp-color7" style="opacity: 0.7;"><span> </span></strong></p>'
                                        }
                                      }
                                    ]
                                  }
