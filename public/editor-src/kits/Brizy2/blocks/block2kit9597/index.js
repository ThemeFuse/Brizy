                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-tp-heading3"><span class="brz-cp-color8">There are advances being made in science and technology everyday, and a good example of this.</span></h3>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color6" style="opacity: 0.75;"><span>Wireframes are generally created by business analysts, user experience designers, developers, visual designers, and by those with expertise</span></span></p>'
                                  }
                                }
                              ]
                            }
