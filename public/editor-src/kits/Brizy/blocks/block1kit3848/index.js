                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-left brz-tp-heading1"><strong class="brz-cp-color2">Proin Quis Tortor Orci. Etiam At Risus</strong></p>'
                                  }
                                }
                              ]
                            }
                                                ...
                                                items: [
                                                  ...
                                                  },
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<p class="brz-tp-paragraph"><span style="opacity: 0.5;" class="brz-cp-color7">14 Commnents&nbsp;</span></p>'
                                                    }
                                                  }
                                                ],
                                                iconSpacing: 12
                                                ...
                                                items: [
                                                  ...
                                                  },
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<p class="brz-tp-paragraph"><span style="opacity: 0.5;" class="brz-cp-color7">August 28, 2018</span></p>'
                                                    }
                                                  }
                                                ],
                                                iconSpacing: 12
                                                ...
                                                items: [
                                                  ...
                                                  },
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<p class="brz-tp-paragraph"><span style="opacity: 0.5;" class="brz-cp-color7">by&nbsp;Lilia Bastian</span></p>'
                                                    }
                                                  }
                                                ],
                                                iconSpacing: 12
