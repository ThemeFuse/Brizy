                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-text-xs-center brz-fs-lg-80 brz-fs-xs-34 brz-lh-xs-1_3 brz-lh-lg-1_3 brz-text-lg-center brz-ff-montserrat brz-ls-lg-m_3"><span class="brz-cp-color3" style="opacity: 1;"><span>Websites&nbsp;Fast &amp; Easy</span></span></h1><p class="brz-text-xs-center brz-fs-lg-80 brz-fs-xs-34 brz-lh-xs-1_3 brz-lh-lg-1_3 brz-text-lg-center brz-ff-montserrat brz-ls-lg-m_3"><span class="brz-cp-color8" style="opacity: 1;"><span>Only&nbsp;With Our Builder</span></span></p>'
                      }
                    }
                  ],
