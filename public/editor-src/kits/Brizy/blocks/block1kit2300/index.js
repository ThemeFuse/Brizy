                  ...
                  items: [
                    {
                      ...
                      value: {
                        ...
                        bgImageHeight: 1280,
                        bgImageSrc:
                          "7d9dcd3af23f8f0b4a4452b0aa5eb7a9738127fb.jpeg",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">Complexity Made Easy</span></h4>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">Web Design, Reinvented</span></h4>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">Premade items</span></h4>'
                                  }
                                }
                              ]
                            }
