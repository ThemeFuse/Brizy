                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-fw-xs-700 brz-fs-xs-40 brz-fs-sm-60 brz-text-lg-center brz-lh-lg-1_3 brz-ls-lg-m_1_5 brz-ff-montserrat brz-fw-lg-900 brz-mb-lg-20 brz-mt-lg-20 brz-fs-lg-94 brz-fw-sm-700 brz-mb-xs-10"><span class="brz-cp-color2">Why I Love Night Photography</span></p>'
                      }
                    }
                  ]
                }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading3"><span class="brz-cp-color2">The world looks different at night</span></p>'
                                  }
                                }
                              ]
                            }
