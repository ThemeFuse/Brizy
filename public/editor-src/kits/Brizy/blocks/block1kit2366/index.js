                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-text-lg-center brz-tp-heading1"><span class="brz-cp-color8">Read Our Best Articles</span></h1>'
                      }
                    }
                  ]
                }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">Strangest things happen to those...</span></h4>'
                                  }
                                }
                              ]
                            }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<p class="brz-tp-button brz-mt-lg-0"><span class="brz-cp-color3">11 APR 2016</span></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-subtitle"><em class="brz-cp-color8">Eliza Watkins</em></p>'
                                              }
                                            }
                                          ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-text-lg-left brz-tp-heading4"><span class="brz-cp-color8">Stylistically different way of life</span></h4>'
                                  }
                                }
                              ]
                            }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<p class="brz-tp-button brz-mt-lg-0"><span class="brz-cp-color3">15 APR 2016</span></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                ...
                                                borderRadius: 33,
                                                imageSrc:
                                                  "44bfd64f6fa3e3c3b2ae97933480e434802706d6.jpeg",
                                                mobileResize: 100
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-subtitle"><em class="brz-cp-color8">Simon Jonesy</em></p>'
                                              }
                                            }
                                          ],
                                          tabletMarginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">A day in the life of a developer</span></h4>'
                                  }
                                }
                              ]
                            }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<p class="brz-tp-button brz-mt-lg-0"><span class="brz-cp-color3">06 MAY 2016</span></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                ...
                                                borderRadius: 33,
                                                imageSrc:
                                                  "a825647d9c9c8f4acb4e35dfcafd05aff836ed17.jpeg",
                                                mobileResize: 100
                                              }
                                            }
                                          ],
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-subtitle"><em class="brz-cp-color8">Roberta Frinci</em></p>'
                                              }
                                            }
                                          ],
                                          tabletMarginBottomSuffix: "px",
