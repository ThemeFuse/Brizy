                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-text-lg-left brz-lh-lg-1_3 brz-lh-xs-1_3 brz-fs-xs-34 brz-ls-lg-m_1_5 brz-ff-montserrat brz-fs-lg-80 brz-fs-sm-50"><strong style="color: rgb(255, 255, 255);">Start reading quality&nbsp;</strong><strong class="brz-cp-color3">news</strong><strong style="color: rgb(255, 255, 255);"> &amp;&nbsp;</strong><strong class="brz-cp-color3">articles</strong><strong style="color: rgb(255, 255, 255);">.</strong></p>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading6 brz-text-xs-center"><span style="opacity: 0.74; color: rgb(255, 255, 255);">Subscribe to our newsletter feed and receive all the news instantly</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mb-lg-10 brz-tp-heading6 brz-text-lg-center brz-mt-lg-10"><span class="brz-cp-color5">SIGN UP FOR FREE</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-center brz-mb-lg-10 brz-mt-lg-10 brz-text-xs-center"><em class="brz-cp-color7">By clicking "Sign up" you agree to our&nbsp;</em><em style="color: rgb(255, 255, 255);">Terms of Service.</em></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
