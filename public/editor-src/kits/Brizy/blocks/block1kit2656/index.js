                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle brz-text-xs-center"><span class="brz-cp-color3">OUR REVIEWS</span></p>'
                                  }
                                }
                              ],
                              marginBottom: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-tp-heading3 brz-text-xs-center"><span class="brz-cp-color2">What People Say</span></h3>'
                                  }
                                }
                              ],
                              marginBottom: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    ...
                                    borderRadius: 50,
                                    imageSrc:
                                      "6d84655d57a770a1f234604e937e5d65c589739f.jpeg"
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle brz-text-xs-center"><span class="brz-cp-color3">JASON SWARTZMAN</span></p>'
                                  }
                                }
                              ],
                              marginBottom: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-xs-center"><span class="brz-cp-color7" style="background-color: transparent;">Designer &amp; Editor</span></p>'
                                  }
                                }
                              ],
                              marginTop: 5
