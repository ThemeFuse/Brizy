                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-tp-heading3"><span class="brz-cp-color2">The world looks different at night</span></h3>'
                                  }
                                }
                              ]
                            }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<h6 class="brz-text-lg-center brz-tp-heading6"><span class="brz-cp-color2">Jason Swartzman</span></h6>'
                                              }
                                            }
                                          ]
                                        }
