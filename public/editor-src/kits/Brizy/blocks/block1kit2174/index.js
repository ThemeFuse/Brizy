                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle"><span class="brz-cp-color7">OUR WORK</span></p>'
                                  }
                                }
                              ],
                              marginBottom: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-text-lg-left brz-tp-heading2"><span class="brz-cp-color2">Featured Projects</span></h2>'
                                  }
                                }
                              ]
                            }
                  ...
                  items: [
                    {
                      ...
                      value: {
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4 brz-text-lg-left"><span class="brz-cp-color8">Create your own universe</span></h4>'
                                  }
                                }
                              ]
                            }
                        ...
                        bgImageHeight: 1285,
                        bgImageSrc:
                          "c4c77a95a5537c16e86fd6004eae0822d11df86e.jpeg",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "a20461183372f00d92b6b520beb854eb867aa1ee.jpeg",
                                    imageWidth: 1920,
                                    imageHeight: 1280,
                                    height: 90,
                                    mobileHeight: 60,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-abovetitle"><span class="brz-cp-color7">COOL WORKPLACE&nbsp;</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "b3abf13e188a7fa7928019ce19c4a63437ddd7e9.jpeg",
                                    imageWidth: 1920,
                                    imageHeight: 1280,
                                    height: 90,
                                    zoom: 100,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-abovetitle"><span class="brz-cp-color7">BLOG FROM ANYWHERE</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "4cf15b3702562e0847a258349d1ebca52da65a76.jpeg",
                                    imageWidth: 1920,
                                    imageHeight: 1280,
                                    height: 90,
                                    zoom: 100,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-abovetitle"><span class="brz-cp-color7">WORK FROM HOME</span></p>'
                                  }
                                }
                              ]
                            }
