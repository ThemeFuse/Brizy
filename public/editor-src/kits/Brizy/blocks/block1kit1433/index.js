                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color2"><span>Easy to&nbsp;</span></span><strong class="brz-cp-color2"><span>Create</span></strong><span class="brz-cp-color2"><span> amazing websites</span></span></h1>'
                      }
                    }
                  ],
                  paddingType: "ungrouped",
