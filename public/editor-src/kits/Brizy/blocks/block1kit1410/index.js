                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-fw-xs-im-400 brz-fw-sm-im-400 brz-fw-lg-400 brz-ft-google brz-ff-montserrat brz-text-lg-left brz-lh-lg-1_3 brz-lh-xs-1_3 brz-fs-xs-34 brz-ls-lg-m_1_5 brz-fs-lg-80"><span class="brz-cp-color8"><span>Seize </span></span><strong class="brz-cp-color8"><span><span>Cutting-edge </span></span></strong><span class="brz-cp-color8"><span>Interfaces</span></span></h1>'
                      }
                    }
                  ],
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-subtitle"><em class="brz-cp-color3">No coding skills required, you only need to know how to use the mouse and keyboard.</em></p>'
                      }
                    }
                  ]
                }
