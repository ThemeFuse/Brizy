                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mb-lg-20 brz-mt-lg-20 brz-tp-heading1 brz-text-lg-center brz-lh-xs-1_3 brz-fs-xs-34"><strong style="color: rgb(255, 255, 255);">10 Questions About Tokyo Night Life</strong></p>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    ...
                                    borderRadius: 85,
                                    imageSrc:
                                      "9fe5a56c95e31a33d94bdc8aa0b6a8c77694678d.jpeg",
                                    height: 100,
                                    positionX: 50,
                                    positionY: 50,
                                    imagePopulation: "",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-button brz-mb-lg-0 brz-mt-lg-10"><span class="brz-cp-color7">RAMIRA LOPEZ</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mb-lg-0 brz-mt-lg-0 brz-tp-paragraph brz-text-lg-center brz-text-xs-center"><em class="brz-cp-color4" style="opacity: 0.75;">Author &amp; Co-founder</em></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading4 brz-text-lg-center"><span class="brz-cp-color2">Are Yokocho &amp; Izakaya alleyways worth it for bar Hopping in Tokyo?</span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
