                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-subtitle"><em class="brz-cp-color7" style="background-color: transparent;">Modern websites are complex beasts. With this you can enjoy the building process!</em></p>'
                      }
                    }
                  ]
                }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-mb-lg-10 brz-tp-heading4"><span class="brz-cp-color2" style="opacity: 1;"><span>Drag &amp; Drop</span></span></h4><p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>No matter if you\'ve used a visual page builder before, with this you\'ll be a pro the second you start using it.</span></span></p>',
                                          customCSS: ""
                                        }
                                      },
                                      {
