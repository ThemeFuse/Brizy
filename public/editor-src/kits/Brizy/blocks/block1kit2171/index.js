                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-abovetitle"><span class="brz-cp-color3">OUR WORK</span></p>'
                      }
                    }
                  ],
                  marginBottom: 0,
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-tp-heading2 brz-text-lg-left"><span class="brz-cp-color8">Featured Projects</span></h2>'
                      }
                    }
                  ],
                  marginLeft: 15
                  ...
                  items: [
                    {
                      ...
                      value: {
                        ...
                        bgImageHeight: 1285,
                        bgImageSrc:
                          "ea944af6d6e6cabf8d5e7dc90f4bd798f00dad86.jpeg",
