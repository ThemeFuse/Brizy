                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-text-lg-center brz-tp-heading1 brz-mb-lg-10"><span style="opacity: 1;" class="brz-cp-color8">Team Members</span></h1>'
                      }
                    }
                  ],
                  marginBottom: 20,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "f93ae059a73542da720cbb0f351013b31a0c1630.jpeg",
                                    imageWidth: 360,
                                    imageHeight: 260,
                                    positionY: 42,
                                    mobilePositionY: 42,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-abovetitle"><span class="brz-cp-color3">MICAH SINGLETOM</span></p>'
                                  }
                                }
                              ],
                              marginTop: 25
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-fs-lg-16 brz-fw-400 brz-ff-noto_serif brz-text-lg-center"><span class="brz-cp-color7">Loves to design interfaces and create amazing UX</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "30c553b534542e28167effcd81b99dfbb8aae738.jpeg",
                                    imageWidth: 360,
                                    imageHeight: 260,
                                    customCSS: "",
                                    imageBrightness: 100,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-abovetitle"><span class="brz-cp-color3">SANDRA BOLDAM</span></p>'
                                  }
                                }
                              ],
                              marginTop: 25
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-ff-noto_serif brz-fw-400 brz-fs-lg-16"><span class="brz-cp-color7">Copyrighter by nature, gets creative with words.</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-abovetitle"><span class="brz-cp-color3">CATHIE JONES</span></p>'
                                  }
                                }
                              ],
                              marginTop: 25
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-fs-lg-16 brz-fw-400 brz-ff-noto_serif brz-text-lg-center"><span class="brz-cp-color7">Photographer and video editor extraordinaire</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "c24b2274fd54ecff7ba0575db9d79ce36224bee4.jpeg",
                                    imageWidth: 360,
                                    imageHeight: 260,
                                    customCSS: "",
                                    imageBrightness: 100,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-abovetitle"><span class="brz-cp-color3">MARK FAYDRIN</span></p>'
                                  }
                                }
                              ],
                              marginTop: 25
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-ff-noto_serif brz-fw-400 brz-fs-lg-16"><span class="brz-cp-color7">Creative Director, spends all day mixing concepts.</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "c754e032abb01ed3cdce6a77f5e86fe3e0211f2d.jpeg",
                                    imageWidth: 360,
                                    imageHeight: 260,
                                    customCSS: "",
                                    imageBrightness: 100,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-abovetitle"><span class="brz-cp-color3">ANTHONY MYERS</span></p>'
                                  }
                                }
                              ],
                              marginTop: 25
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-fs-lg-16 brz-fw-400 brz-ff-noto_serif brz-text-lg-center"><span class="brz-cp-color7">He is the youngest Art Director in our company</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "239305e39d687da309ec7cb8ab385594aea0340b.jpeg",
                                    imageWidth: 360,
                                    imageHeight: 260,
                                    customCSS: "",
                                    imageBrightness: 100,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-abovetitle"><span class="brz-cp-color3">STELLAN GIBBS</span></p>'
                                  }
                                }
                              ],
                              marginTop: 25
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-ff-noto_serif brz-fw-400 brz-fs-lg-16"><span class="brz-cp-color7">Has been for years a great source of quality ideas</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0,
