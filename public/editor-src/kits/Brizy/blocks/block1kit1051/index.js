module.exports = {
  ...
  keywords: "features,Gallery,grid,icon box,icons,images,services,three columns",
  cat: [4447],
  type: 1,
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<h2 class=\"brz-text-lg-left brz-tp-heading2\"><span class=\"brz-cp-color8\">Our Studio</span></h2>"
                                                                }
                                                            }
                                                        ]
                                                    }
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<p class=\"brz-tp-subtitle\"><em class=\"brz-cp-color7\" style=\"background-color: transparent;\">With it you can enjoy creating, building your dream website!</em></p>"
                                                                }
                                                            }
                                                        ],
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<h5 class=\"brz-tp-heading5 brz-text-lg-center\"><strong class=\"brz-cp-color8\">Vector Icons &amp; Shapes</strong></h5>"
                                                                }
                                                            }
                                                        ],
                                                        "marginTop": 0,
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<p class=\"brz-tp-paragraph brz-text-lg-center\"><span class=\"brz-cp-color7\"><span>It is a front-end page builder where what you see is what you get.</span></span></p>"
                                                                }
                                                            }
                                                        ],
                                                        "marginRight": 15,
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<h5 class=\"brz-text-lg-center brz-tp-heading5\"><strong class=\"brz-cp-color8\">No Coding Skills Required</strong></h5>"
                                                                }
                                                            }
                                                        ],
                                                        "marginTop": 0,
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<p class=\"brz-text-lg-center brz-tp-paragraph\"><span class=\"brz-cp-color7\">Let's not get technical! Create up-to-date designs without writing any code.</span></p>"
                                                                }
                                                            }
                                                        ],
                                                        "marginRight": 15,
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<h5 class=\"brz-tp-heading5 brz-text-lg-center\"><strong class=\"brz-cp-color8\">Latest Web Technologies</strong></h5>"
                                                                }
                                                            }
                                                        ],
                                                        "marginTop": 0,
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<p class=\"brz-tp-paragraph brz-text-lg-center\"><span class=\"brz-cp-color7\">Every editing option iswell-thought to make it easy for you to work with.</span></p>"
                                                                }
                                                            }
                                                        ],
                                                        "marginRight": 15,
