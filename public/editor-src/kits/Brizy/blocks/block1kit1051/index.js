                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><em style="background-color: transparent;" class="brz-cp-color7">With Brizy you can enjoy creating, building your dream website!</em></p>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color7">Brizy is a front-end page builder where what you see is what you get.</span></p>'
                                  }
                                }
                              ],
                              marginRight: 15,
