                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<h6 class=\"brz-text-lg-center brz-tp-heading6\"><span class=\"brz-cp-color3\">Sarah Sharpe</span></h6>"
                                                                }
                                                            }
                                                        ],
                                                        marginBottom: 0,
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<p class=\"brz-text-lg-center brz-tp-paragraph brz-mb-lg-10\"><span class=\"brz-cp-color8\">Creative Director</span></p>"
                                                                }
                                                            }
                                                        ],
                                                        marginTop: 0,
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<h6 class=\"brz-tp-heading6 brz-text-lg-center\"><span class=\"brz-cp-color3\">Johnny Lucas</span></h6>"
                                                                }
                                                            }
                                                        ],
                                                        marginBottom: 0,
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<p class=\"brz-tp-paragraph brz-text-lg-center brz-mb-lg-10\"><span class=\"brz-cp-color8\">Lead Designer</span></p>"
                                                                }
                                                            }
                                                        ],
                                                        marginTop: 0,
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<h6 class=\"brz-text-lg-center brz-tp-heading6\"><span class=\"brz-cp-color3\">Amanda Feros</span></h6>"
                                                                }
                                                            }
                                                        ],
                                                        marginBottom: 0,
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<p class=\"brz-text-lg-center brz-tp-paragraph brz-mb-lg-10\"><span class=\"brz-cp-color8\">Marketing Expert</span></p>"
                                                                }
                                                            }
                                                        ],
                                                        marginTop: 0,
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<h6 class=\"brz-tp-heading6 brz-text-lg-center\"><span class=\"brz-cp-color3\">Dobrin Lovik</span></h6>"
                                                                }
                                                            }
                                                        ],
                                                        marginBottom: 0,
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<p class=\"brz-tp-paragraph brz-text-lg-center brz-mb-lg-10\"><span class=\"brz-cp-color8\">Manager CEO</span></p>"
                                                                }
                                                            }
                                                        ],
                                                        marginTop: 0,
