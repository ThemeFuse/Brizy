module.exports = {
  ...
  keywords:
    "button,call to action,cover,features,header,hero,icon box,icons,image background,services,three columns",
  cat: [4395, 100],
  type: 1,
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-text-lg-center brz-tp-heading1 brz-mb-lg-0"><span class="brz-cp-color8">Build Websites Fast &amp; Easy</span></h1>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-mt-lg-20 brz-mb-lg-20 brz-tp-subtitle brz-text-lg-center brz-mb-xs-10"><em class="brz-cp-color7">Create up-to-date designs without writing a single line of code. Build clean, minimalistic, beautifully crafted websites perfectly fit for any device.</em></p>'
                      }
                    }
                  ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h5 class="brz-tp-heading5 brz-mb-lg-10"><span style="opacity: 1;" class="brz-cp-color8">Strategy &amp; Planning</span></h5><p class="brz-tp-paragraph"><span class="brz-cp-color7">Every text, image, icon or button can be edited or replaced simply by selecting.</span></p>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5 brz-mb-lg-10"><span class="brz-cp-color8" style="opacity: 1;"><span>Release &amp; Marketing</span></span></h5><p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>This will shorten the time needed to build your dream website. It\u2019s easy!</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5 brz-mb-lg-10"><span style="opacity: 1;" class="brz-cp-color8">Design &amp; Development</span></h5><p class="brz-tp-paragraph"><span class="brz-cp-color7">Every editing option is extremely well-thought to make it easy for you to find.</span></p>'
                                        }
                                      }
                                    ]
                                  }
