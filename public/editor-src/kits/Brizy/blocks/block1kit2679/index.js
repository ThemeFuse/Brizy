                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color8">Meet Our Team</span></h1>'
                      }
                    }
                  ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    ...
                                    borderRadius: 48,
                                    imageSrc:
                                      "2b35bd7748df8e310f208615e03aeb00372013d7.jpeg"
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    ...
                                    borderRadius: 48,
                                    imageSrc:
                                      "1a102b459b8476f6fdb093e6e013d374f364829c.jpeg"
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-lg-center"><span class="brz-cp-color8">Mary Jane Strode</span></h5>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    ...
                                    borderRadius: 48,
                                    imageSrc:
                                      "c8682deba2ac36ae7623190c598bbbdddb8b03be.jpeg"
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-lg-center"><span class="brz-cp-color8">Susan Whiting</span></h5>'
                                  }
                                }
                              ]
                            }
