                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading4"><span class="brz-cp-color1">Daytime is boring to me</span></p>'
                                  }
                                }
                              ]
                            }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-button"><span class="brz-cp-color7" style="opacity: 0.52;">TIPS &amp; TRICKS</span></p>'
                                              }
                                            }
                                          ]
                                        }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-subtitle"><em class="brz-cp-color1">\u201cNever doubt that a small group of thoughtful, committed, citizens can change the world. Indeed, it is the only thing that ever has.\u201d</em></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<ul><li class="brz-bcp-color7 brz-text-lg-center brz-tp-subtitle">Margaret Mead</li></ul>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading4"><span class="brz-cp-color2">Night Photography isn\'t for everyone</span></p>'
                                  }
                                }
                              ]
                            }
