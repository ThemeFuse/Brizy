                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2"><span class="brz-cp-color8">Design Reinvented</span></h2>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color7" style="background-color: transparent;"><span>It is a front-end page builder where what you see is what you get. We designed it so you can be in complete control of your website.</span></span></p>'
                                  }
                                }
                              ],
                              marginRight: 80
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h6 class="brz-tp-heading6 brz-mt-lg-8"><span class="brz-cp-color8">What you see is what you get</span></h6>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 22
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h6 class="brz-tp-heading6 brz-mt-lg-8"><span class="brz-cp-color8">No skills or coding required</span></h6>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 22
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h6 class="brz-mt-lg-8 brz-tp-heading6"><span class="brz-cp-color8">No more buffering - it\'s lightning fast</span></h6>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 22
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-button"><span style="background-color: transparent;" class="brz-cp-color8">SOLUTION ONE</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color3">$ 30</span></h2><p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color7">/ month</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color8">Pages:</span><span class="brz-cp-color2">&nbsp;</span><span class="brz-cp-color7">Unlimited</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color8">Visitors:</span><span class="brz-cp-color2">&nbsp;</span><span class="brz-cp-color7">Unlimited</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color8">Integration:&nbsp;</span><span class="brz-cp-color7">Basic</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-button"><span style="background-color: transparent;" class="brz-cp-color8">SOLUTION TWO</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color3">$ 80</span></h2><p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color7">/ month</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color8">Pages:&nbsp;</span><span class="brz-cp-color7">Unlimited</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color8">Integration:</span><span class="brz-cp-color2">&nbsp;</span><span class="brz-cp-color7">Advanced</span></p>'
                                  }
                                }
                              ]
                            }
