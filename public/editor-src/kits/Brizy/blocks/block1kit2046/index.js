module.exports = {
  ...
  keywords: "button,call to action,news,text",
  cat: [4533, 100],
  type: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2"><span class="brz-cp-color2">Website hosting reviews free website hosting comparison</span></h2>'
                                  }
                                }
                              ]
                            }
