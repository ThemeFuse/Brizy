                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<p class=\"brz-mb-lg-20 brz-text-xs-center brz-text-lg-left brz-tp-subtitle brz-mb-sm-0 brz-mb-xs-0\"><em class=\"brz-cp-color3\">Beautiful pages with just clicks &amp; drags&nbsp;</em></p>"
                                                                }
                                                            }
                                                        ],
                                                        "marginTop": 5,
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<p class=\"brz-mb-lg-20 brz-text-xs-center brz-text-lg-left brz-tp-subtitle brz-mb-xs-15 brz-mb-sm-0\"><em class=\"brz-cp-color3\">We designed it so you can be in control</em></p>"
                                                                }
                                                            }
                                                        ],
                                                        "marginTop": 5,
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<p class=\"brz-mb-lg-20 brz-text-xs-center brz-tp-paragraph brz-mb-xs-15 brz-mb-sm-0\"><span class=\"brz-cp-color7\">No more buffering - create, style and enjoy. Our user interface was built on React - the most efficient JavaScript library. We guarantee you will love the difference in performance. You can even start from scratch and build your own items.</span></p>"
                                                                }
                                                            }
                                                        ]
                                                    }
