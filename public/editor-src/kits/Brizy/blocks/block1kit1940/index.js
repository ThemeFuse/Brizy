                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mb-lg-20 brz-tp-paragraph brz-text-lg-left brz-mt-lg-10"><em class="brz-cp-color6">Discover the personal story and rollercoaster feelings that flood you in when dealing with relationship troubles and how to get back.</em></p>'
                                  }
                                }
                              ]
                            }
