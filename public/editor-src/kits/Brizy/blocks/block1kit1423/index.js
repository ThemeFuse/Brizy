                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-text-lg-center brz-tp-heading1"><span class="brz-cp-color2">Creating&nbsp;</span><strong class="brz-cp-color2">Stunning Websites</strong><span class="brz-cp-color2"> Fast, Visually, Only Drag &amp; Drops</span></h1>'
                      }
                    }
                  ],
