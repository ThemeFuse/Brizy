                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1 brz-text-lg-center"><span style="background-color: transparent;" class="brz-cp-color8">Our Statistics&nbsp;</span></h1>'
                      }
                    }
                  ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<p class="brz-mt-sm-0 brz-tp-paragraph brz-mt-lg-13 brz-text-lg-left brz-mt-xs-5"><span class="brz-cp-color7">You can become a User today</span></p>'
                                        }
                                      }
                                    ]
                                  }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-heading4"><span class="brz-cp-color7">USERS</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-heading4"><span class="brz-cp-color7">BACKERS</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading4 brz-text-lg-center"><span class="brz-cp-color7">WEBSITES</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading4 brz-text-lg-center"><span class="brz-cp-color7">VOTES</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0
