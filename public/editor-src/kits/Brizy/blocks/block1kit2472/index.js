                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-text-lg-center brz-tp-heading1"><span class="brz-cp-color2">Our Office Day to Day</span></h1>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-subtitle brz-text-lg-center"><em class="brz-cp-color7">Our headquarters in just a couple of pictures</em></p>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "d2d5e5207f2ee44bf69d70c6007403951b840e3f.jpeg",
                                    imageWidth: 445,
                                    imageHeight: 334,
                                    height: 101,
                                    mobileHeight: 80,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">The Relax Room</span></h4>'
                                  }
                                }
                              ],
                              marginLeft: 50
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-left"><span class="brz-cp-color7" style="background-color: transparent;"><span>Bring vibrance to your site by setting color &amp; transparency&nbsp;with our color overlays options.&nbsp;Simple, fast &amp; stylish only with this, the easiest builder for WordPress!</span></span></p>'
                                  }
                                }
                              ],
                    ...
                    },
                    {
                      ...
                      value: {
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "b5f89facac0a75ea1e684fcd05290be13dda89ac.jpeg",
                                    imageWidth: 445,
                                    imageHeight: 334,
                                    height: 101,
                                    mobileHeight: 80,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">The Work Room</span></h4>'
                                  }
                                }
                              ],
                              marginLeft: 50
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color7" style="background-color: transparent;">Let\'s not get technical! Create up-to-date designs without writing a single line of code. Build clean, minimalistic websites.</span></p><p class="brz-ff-noto_serif brz-fw-400 brz-lh-lg-1_7"><span style="background-color: transparent;" class="brz-cp-color7">This is our clean &amp; minimalistic office.&nbsp;</span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                        ...
                        bgColorHex: "",
                        bgColorOpacity: 1,
                        tempBorderTopLeftRadius: 26,
                        tempBorderTopRightRadius: 26,
                        tempBorderBottomRightRadius: 26,
                        tempBorderBottomLeftRadius: 26,
                        paddingLeft: 0,
                        padding: 0,
                        paddingBottom: 0,
                        paddingRight: 0,
