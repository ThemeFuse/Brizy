                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mb-lg-15 brz-mt-lg-0 brz-text-lg-left brz-tp-button"><span class="brz-cp-color8">LIVE MUSIC &amp; TRAVEL</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-fw-xs-900 brz-fs-xs-38 brz-fs-sm-50 brz-fw-sm-900 brz-mb-lg-20 brz-lh-lg-1_3 brz-ff-montserrat brz-fw-lg-900 brz-fs-lg-53 brz-ls-lg-0 brz-mt-lg-10 brz-mb-xs-0"><span class="brz-cp-color8">BURNING MAN FESTIVAL EXPERIENCE</span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
