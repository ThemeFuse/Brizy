                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color8">Complexity Made Easy</span></h1>'
                      }
                    }
                  ]
                }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h4 class="brz-mb-lg-10 brz-tp-heading4"><span style="opacity: 1;" class="brz-cp-color8">Jobs Done Fast</span></h4><p class="brz-tp-paragraph"><span class="brz-cp-color7">Create up-to-date designs without writing a single line of code. Build clean, minimalistic websites perfectly fit for any device.</span></p>'
                                        }
                                      },
                                      {
                                        type: "Cloneable",
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-tp-heading4 brz-mb-lg-10"><span style="opacity: 1;" class="brz-cp-color8">Drag &amp; Drop</span></h4><p class="brz-tp-paragraph"><span class="brz-cp-color7">No matter if you\'ve used a visual page builder before, with Brizy you\'ll be a pro the second you start using it. It\'s easy with Brizy.</span></p>',
                                          customCSS: ""
                                        }
                                      },
                                      {
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-mb-lg-10 brz-tp-heading4"><span style="opacity: 1;" class="brz-cp-color8">Latest Tech</span></h4><p class="brz-tp-paragraph"><span class="brz-cp-color7">Our user interface was built on React - the most efficient JavaScript library. We guarantee you will love the difference in performance.</span></p>',
                                          customCSS: ""
                                        }
                                      },
                                      {
