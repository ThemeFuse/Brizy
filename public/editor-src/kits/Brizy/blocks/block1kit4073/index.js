                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-heading5"><span style="color: rgb(255, 255, 255);">OTHER POPULAR ARTICLES</span></p>'
                      }
                    }
                  ]
                }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-heading5"><span style="color: rgb(255, 255, 255);">Lorem Ipsum Dolor Sit Amet Consectetur</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-mt-lg-0 brz-tp-paragraph"><span style="color: rgb(255, 255, 255); opacity: 0.68;"> The Kurykans, a Siberian tribe who inhabited the area in the sixth century, gave it a name that translates to \u201cmuch water\u201d.</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-heading5"><span class="brz-cp-color2">Best 5 examples of Digital Photography of the modern world</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mt-lg-0 brz-text-lg-center brz-tp-paragraph"><span style="opacity: 0.5;" class="brz-cp-color2"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna ali.</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mt-lg-0 brz-text-lg-center brz-tp-paragraph"><span style="opacity: 0.68; color: rgb(255, 255, 255);"> The Kurykans, a Siberian tribe who inhabited the area in the sixth century, gave it a name that translates to \u201cmuch water\u201d.</span></p>'
                                  }
                                }
                              ]
                            }
