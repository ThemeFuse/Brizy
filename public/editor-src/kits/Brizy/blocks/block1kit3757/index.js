                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-left brz-tp-heading4"><span class="brz-cp-color2">"Composition for me is a very connected and therapeutic process, and something I immensely enjoy. I have experienced however that if I don\u2019t enjoy styling, the joy in styling and shooting is diluted"&nbsp;</span></p>'
                                  }
                                }
                              ],
                              paddingType: "grouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><span class="brz-cp-color7" style="opacity: 0.8;">Quote by&nbsp;</span><strong class="brz-cp-color3" style="opacity: 0.8;">Arabella Ozols</strong></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-fs-sm-30 brz-ls-lg-m_1_5 brz-ff-montserrat brz-fs-lg-99 brz-fw-lg-400 brz-lh-lg-1 brz-text-lg-left brz-fs-xs-30"><span class="brz-cp-color1" style="opacity: 0.15;">02</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-left brz-tp-button"><strong class="brz-cp-color1" style="opacity: 0.15;">AESTHETICS</strong></p>'
                                  }
                                }
                              ],
                              marginTop: 10,
