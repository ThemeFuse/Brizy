                  ...
                  items: [
                    {
                      ...
                      value: {
                        ...
                        bgImageHeight: 1280,
                        bgImageSrc:
                          "32e337b41879df109a4cc8b1be35e8bb581772c9.jpeg",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">Complexity Made Easy</span></h4>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>Many of us have back problems, it is a very wide problem for people, ever since we started walking on our tow legs and raised our backs.</span></span></p>'
                                  }
                                }
                              ]
                            }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        ...
                        bgImageHeight: 1280,
                        bgImageSrc:
                          "a5bbdeab4982089f49a221146659a19505a40f5d.jpeg",
                        mobileBgImageWidth: 1920,
                        mobileBgImageHeight: 1280,
                        mobileBgImageSrc:
                          "a5bbdeab4982089f49a221146659a19505a40f5d.jpeg",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">Web Design, Reinvented</span></h4>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>The rules of travel have altered so much in the last few years, with strict regulation regarding air travel, questionable car searches.</span></span></p>'
                                  }
                                }
                              ]
                            }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        ...
                        bgImageHeight: 1266,
                        bgImageSrc:
                          "e87a1945a807932aac959161cda05e364a7c2670.jpeg",
                        mobileBgImageWidth: 1920,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">Premade items</span></h4>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>Every former smoker can tell you just how hard it is to stop smoking cigarettes. However, there are a range of stop smoking commodities.</span></span></p>'
                                  }
                                }
                              ]
                            }
