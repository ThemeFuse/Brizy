module.exports = {
  ...
  keywords: "contact,forms,full width,image background,text,two columns",
  cat: [4509, 100],
  type: 1,
                  ...
                  items: [
                    {
                      ...
                      value: {
                        ...
                        bgImageHeight: 573,
                        bgImageSrc:
                          "10573d26fd465888b424d1f02d1d11c705c48071.jpeg",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-text-xs-center brz-tp-heading2 brz-text-lg-left"><span class="brz-cp-color8">We Love Your Feedback</span></h2>'
                                  }
                                }
                              ],
                              marginBottom: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mb-lg-0 brz-mb-xs-15 brz-tp-paragraph brz-text-xs-center"><span class="brz-cp-color7"><span>With this, you can create beautiful WordPress pages in minutes by adding pre-made design elements, called items to the page and then edit everything within. You can even start from scratch and build your own items.</span></span></p>'
                                  }
                                }
                              ],
                              marginRight: 70
