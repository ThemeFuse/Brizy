                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1 brz-text-lg-center brz-mb-lg-0"><span style="color: rgb(255, 255, 255);">Grid Gallery</span></h1>'
                      }
                    }
                  ],
                  marginBottom: 5,
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h5 class="brz-text-lg-center brz-tp-subtitle brz-mb-lg-40"><em class="brz-cp-color5">Click the images for a full view with our Lightbox feature</em></h5>'
                      }
                    }
                  ],
                  marginTop: 0,
                        ...
                        items: [
                          ...
                          },
                          {
                            ...
                            value: {
                              ...
                              imageHeight: 1059,
                              imageSrc:
                                "bb2e1eb56e2d9f65d7f79001c7cb295faf8a77d5.jpeg",
                              height: 158,
                              positionX: 50,
                              positionY: 50,
                              imagePopulation: "",
