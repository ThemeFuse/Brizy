module.exports = {
  ...
  keywords: "button,call to action,features,projects,services,two columns",
  cat: [4447, 100],
  type: 0,
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-text-lg-center brz-tp-heading1"><span class="brz-cp-color2">Side by Side</span></h1>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-subtitle"><em style="background-color: transparent;" class="brz-cp-color7">No more buffering - create, style and enjoy. Our user interface was built on React - the most efficient JavaScript library.</em></p>'
                      }
                    }
                  ],
                  marginRight: 300,
                  ...
                  items: [
                    {
                      ...
                      value: {
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color8">Drag &amp; Drop</span></h2>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span style="background-color: transparent;" class="brz-cp-color8">Just click &amp; drag to create beautiful pages in a matter of minutes.</span></p>'
                                  }
                                }
                              ]
                            }
                        ...
                        bgImageHeight: 1920,
                        bgImageSrc:
                          "82113f8951f40b7fde688919813e23358e0d2217.jpeg",
                    ...
                    },
                    {
                      ...
                      value: {
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color8">Easy To Use</span></h2>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span style="background-color: transparent;" class="brz-cp-color8">Let\'s not get technical! Create up-to-date designs without writing a single line of code.&nbsp;</span></p>'
                                  }
                                }
                              ]
                            }
                        ...
                        bgImageHeight: 1280,
                        bgImageSrc:
                          "51099d3339e6661e5c487fd385a353cb42f95196.jpeg",
