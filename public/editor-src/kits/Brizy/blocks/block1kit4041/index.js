                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    ...
                                    imageHeight: 300,
                                    imageSrc:
                                      "dccd64b8ebdefb1c756c56ea6412a8d5.jpg",
                                    height: 100,
                                    positionX: 36,
                                    positionY: 58,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-button brz-text-lg-center"><span class="brz-cp-color3">SILVYE&nbsp;</span></p><p class="brz-tp-button brz-text-lg-center"><span class="brz-cp-color3">MARTENS</span></p>'
                                  }
                                }
                              ],
                              marginBottom: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mb-lg-13 brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color4">Travel Author</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading5"><span style="opacity: 1;" class="brz-cp-color6">C</span><span class="brz-cp-color6">onsectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</span><span style="opacity: 1;" class="brz-cp-color6">&nbsp;</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading5 brz-mb-lg-10 brz-mt-lg-20"><span class="brz-cp-color5">Mountains &amp; Silence</span></p><p class="brz-tp-paragraph"><span class="brz-cp-color6">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officias.</span></p>'
                                  }
                                }
                              ]
                            }
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-paragraph brz-mb-lg-0 brz-mt-lg-0"><em class="brz-cp-color6">Sesinlem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</em></p>'
                                              }
                                            }
                                          ]
                                        }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-fs-im-30 brz-fs-lg-31 brz-lh-im-1_3 brz-lh-lg-1_4 brz-ls-im-0 brz-ls-lg-m_1 brz-fw-im-400 brz-fw-lg-400 brz-ff-pt_serif brz-text-lg-left"><span class="brz-cp-color3">Amet Consectetur Adipisicing Elit Sed Doscipito Eiusmod Tempor Incididunt Ut Labore</span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mt-lg-10 brz-tp-paragraph"><span class="brz-cp-color6">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim</span></p>'
                                  }
                                }
                              ]
                            }
