                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">No Skills Required</span></h4>'
                                  }
                                }
                              ],
                              marginLeft: 50
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">Easy To Use</span></h4>'
                                  }
                                }
                              ],
                              marginLeft: 50
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">Color Overlays</span></h4>'
                                  }
                                }
                              ],
                              marginLeft: 50
