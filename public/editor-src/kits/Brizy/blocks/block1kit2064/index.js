                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-tp-heading1 brz-text-xs-center brz-text-lg-center"><span class="brz-cp-color2">Quick Preview</span></h1>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-xs-center brz-text-lg-center"><span class="brz-cp-color2" style="opacity: 0.65;"><span>With this, you can create beautiful WordPress pages in minutes by adding pre-made design elements.</span></span></p>'
                                  }
                                }
                              ]
                            }
