module.exports = {
  ...
  keywords: "button,features,progress,two columns",
  cat: [4447, 100],
  type: 1,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-tp-heading2 brz-text-lg-left brz-text-xs-center brz-mt-lg-0"><span class="brz-cp-color8">Our Expertise</span></h2>'
                                  }
                                }
                              ],
                              marginBottom: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-subtitle brz-text-lg-left"><em class="brz-cp-color3">Support service is always there for you!</em></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mb-lg-10 brz-mb-xs-15 brz-tp-paragraph brz-text-xs-center"><span class="brz-cp-color7"><span>With this, you can create beautiful WordPress pages in minutes by adding pre-made design elements, called items to the page and then edit everything within.&nbsp;</span></span></p>'
                                  }
                                }
                              ]
                            }
