module.exports = {
  ...
  keywords: "Blog,Content,header,Post",
  cat: [4395, 100],
  type: 1,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mb-lg-20 brz-tp-button"><span class="brz-cp-color5">DESTINATIONS / TRAVEL</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-fw-xs-700 brz-fs-xs-30 brz-mb-lg-10 brz-lh-lg-1_3 brz-ls-lg-m_1_5 brz-ff-montserrat brz-fw-lg-800 brz-fs-lg-60 brz-fs-sm-40 brz-fw-sm-700"><span style="color: rgb(255, 255, 255);">Why I continued my round-the-world cycling trip even after losing myself</span></h1>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-left brz-tp-paragraph"><span class="brz-cp-color6" style="opacity: 0.7;">The experience did, however, give me a different perspective that challenged the expected \u201cnorm\u201d that I\u2019d find if I just read news headlines.</span></p>'
                                  }
                                }
                              ],
                                                ...
                                                items: [
                                                  ...
                                                  },
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<p class="brz-tp-button"><span class="brz-cp-color8">SEP 8, 2018</span></p>'
                                                    }
                                                  }
                                                ],
                                                iconSpacing: 7
                                                ...
                                                items: [
                                                  ...
                                                  },
                                                  {
                                                    ...
                                                    value: {
                                                      ...
                                                      text:
                                                        '<p class="brz-tp-button"><span class="brz-cp-color8">469</span></p>'
                                                    }
                                                  }
                                                ],
                                                iconSpacing: 7
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-tp-heading3"><span class="brz-cp-color8">The world looks different at night</span></h3>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span class="brz-cp-color7" style="opacity: 1;">C</span><span class="brz-cp-color7">onsectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</span><span class="brz-cp-color7" style="opacity: 1;">&nbsp;</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0,
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                ...
                                                imageHeight: 400,
                                                imageSrc:
                                                  "1ce72f3e257a3c8cfd6be5f3fc202db9.jpg",
                                                height: 100,
                                                positionX: 50,
                                                positionY: 50,
                                                imagePopulation: "",
                                          ...
                                          items: [
                                            {
                                              ...
                                              value: {
                                                _styles: ["richText"],
                                                text:
                                                  '<p class="brz-tp-subtitle brz-text-lg-center"><span class="brz-cp-color7">Director</span></p>'
                                              }
                                            }
                                          ]
                                        }
