                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-abovetitle"><span class="brz-cp-color3">CHECK OUT THE LATEST</span></p>'
                      }
                    }
                  ],
                  marginBottom: 0
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color8">Gallery Showcase</span></h2>'
                      }
                    }
                  ]
                }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "9187740844aafc988b1b069b296ea0d5cf7c8f83.jpeg",
                                    imageWidth: 1567,
                                    imageHeight: 1920,
                                    height: 54,
                                    positionY: 32,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><em class="brz-cp-color7">Great and unique architecture</em></p>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><em class="brz-cp-color7">Simple to use &amp; Easy to build complex structuring</em></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "e56d84636cb6ef8f29561e37c9d4b9e199c69f38.jpeg",
                                    imageWidth: 1920,
                                    imageHeight: 1280,
                                    zoom: 200,
                                    mobileZoom: 200,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><em class="brz-cp-color7">Click and drag items to create beautiful pages, instantly</em></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "3b98e2255077c0264852a07333bfc726d54237f8.jpeg",
                                    imageWidth: 1920,
                                    imageHeight: 1271,
                                    zoom: 131,
                                    mobileZoom: 131,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><em class="brz-cp-color7">Replace any image or text easily with a few clicks</em></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><em class="brz-cp-color7">Bring vibrance to your site by setting colors &amp; transparency</em></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><em class="brz-cp-color7">No more buffering!</em></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
