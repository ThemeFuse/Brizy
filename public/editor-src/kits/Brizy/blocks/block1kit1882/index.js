                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-mb-lg-10 brz-tp-button brz-text-lg-center"><span class="brz-cp-color5">INTERFACE  | &nbsp;UI &amp; UX  |&nbsp;DESIGN  | &nbsp;LIFESTYLE&nbsp;</span></p>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-mb-lg-10 brz-fs-lg-74 brz-fw-lg-200 brz-ff-montserrat brz-ls-lg-m_1_5 brz-lh-lg-1_3 brz-text-lg-center brz-fs-sm-65 brz-fs-xs-40"><span style="color: rgb(255, 255, 255);">Title of the blog post</span></p>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-subtitle"><em class="brz-cp-color7">Just click &amp; drag to create beautiful pagesad in a matter of minutes.&nbsp;</em></p>'
                      }
                    }
                  ]
                }
