                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-subtitle"><em class="brz-cp-color3">Brizy support is always there for you!</em></p>'
                      }
                    }
                  ]
                }
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      _styles: ["richText"],
                                                      text:
                                                        '<h2 class="brz-text-lg-left brz-tp-heading2 brz-text-xs-center"><span class="brz-cp-color8">Easy with Brizy</span></h2>'
                                                    }
                                                  }
                                                ],
                                                marginBottom: 0,
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      _styles: ["richText"],
                                                      text:
                                                        '<p class="brz-mb-lg-20 brz-text-xs-center brz-tp-paragraph brz-mb-xs-15"><span class="brz-cp-color7">The bread &amp; butter of our platform are the pre-built design sections, called items. These can be added to your landing page in a couple of clicks and every text, image, icon or button that make up the Block. It\'s easy with Brizy.</span></p>'
                                                    }
                                                  }
                                                ]
                                              }
                                                ...
                                                items: [
                                                  {
                                                    ...
                                                    value: {
                                                      _styles: ["richText"],
                                                      text:
                                                        '<p class="brz-mb-lg-20 brz-text-xs-center brz-tp-paragraph brz-mb-xs-15"><span class="brz-cp-color7">Just click &amp; drag to create beautiful pages in a matter of minutes. No designer talent, developer wits or coding skills necessary. No matter if you\'ve used a visual page builder before, with Brizy you\'ll be a pro the second you start using it.&nbsp;</span></p>'
                                                    }
                                                  }
                                                ]
                                              }
