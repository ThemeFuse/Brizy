module.exports = {
  ...
  keywords: "button,cover,features,header,icons,image background",
  cat: [4395, 100],
  type: 0,
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color2" style="background-color: transparent;">Beautiful world</span></h1>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-subtitle"><em class="brz-cp-color7">Parties and family gatherings are popular this time of year. Whether you\u2019re celebrating an anniversary, a birthday, graduation.</em></p>'
                      }
                    }
                  ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-lg-center"><span class="brz-cp-color2" style="opacity: 1;">Focus Groups</span></h5>'
                                  }
                                }
                              ],
                              marginBottom: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color7"><span>Without a doubt there is something very relaxing and pleasurable about cooking.</span></span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-lg-center"><span class="brz-cp-color2" style="opacity: 1;">Pressure Sensitive</span></h5>'
                                  }
                                }
                              ],
                              marginBottom: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color7"><span>Increasing prosperity in our lives can be accomplished by having the right frame of mind.</span></span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-lg-center"><span class="brz-cp-color2">Smartwatch Ready</span></h5>'
                                  }
                                }
                              ],
                              marginBottom: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color7"><span>The truth is, our thoughts are very powerful. They are capable of influencing.</span></span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-lg-center"><span class="brz-cp-color2" style="opacity: 1;">Perfect On Mobiles</span></h5>'
                                  }
                                }
                              ],
                              marginBottom: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color7"><span>There are not many cities that have experienced such social and political extremes.</span></span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
