                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-tp-heading2 brz-text-lg-center"><span class="brz-cp-color2">Easiest Way to Build Sites</span></h2>'
                      }
                    }
                  ]
                }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h4 class="brz-mb-lg-15 brz-tp-heading4 brz-mb-xs-15"><span class="brz-cp-color2">Jobs Done Fast</span></h4><p class="brz-tp-paragraph brz-mb-lg-15 brz-mb-xs-15"><span class="brz-cp-color7">Create up-to-date designs without writing a single line of code. Build clean, minimalistic websites.</span></p>'
                                        }
                                      },
                                      {
                                        type: "Cloneable",
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-mb-lg-15 brz-tp-heading4 brz-mb-xs-15"><span class="brz-cp-color2">Latest Tech</span></h4><p class="brz-tp-paragraph brz-mb-lg-15 brz-mb-xs-15"><span class="brz-cp-color7">Our user interface was built on React - the most efficient JavaScript library. We guarantee you will love it.</span></p>',
                                          customCSS: ""
                                        }
                                      },
                                      {
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-mb-xs-15 brz-mb-lg-15 brz-tp-heading4"><span class="brz-cp-color2"><span>Drag &amp; Drop</span></span></h4><p class="brz-mb-xs-15 brz-mb-lg-15 brz-tp-paragraph"><span class="brz-cp-color7"><span>No matter if you\'ve used a visual page builder before, with this you\'ll be a pro the second you start using it.</span></span></p>',
                                          customCSS: ""
                                        }
                                      },
                                      {
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h4 class="brz-mb-xs-15 brz-tp-heading4 brz-mb-lg-15"><span class="brz-cp-color2"><span>No Docs Needed</span></span></h4><p class="brz-mb-xs-15 brz-tp-paragraph brz-mb-lg-15"><span class="brz-cp-color7"><span>No matter if you\'ve used a visual page builder before, with this you\'ll be a pro the second you start using it.</span></span></p>',
                                          customCSS: ""
                                        }
                                      },
                                      {
