                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    ...
                                    borderRadius: 83,
                                    imageSrc:
                                      "8f9b687a54952c01f9989bcf9724bc746460d439.jpeg"
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-subtitle"><em class="brz-cp-color7" style="background-color: transparent;">"No matter if you\'ve used a visual page builder before, with this you\'ll be a pro the second you start using it. Let\'s not get technical! Create up-to-date designs without writing a single line of code."</em></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-abovetitle brz-text-xs-center"><strong class="brz-cp-color3">MARY JANE STRODE</strong></p>'
                                  }
                                }
                              ]
                            }
