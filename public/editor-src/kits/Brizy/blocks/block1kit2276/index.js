                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-left brz-text-xs-center"><span class="brz-cp-color7" style="background-color: transparent;">Brizy is a front-end page builder where what you see is what you get.</span></p>'
                                  }
                                }
                              ],
