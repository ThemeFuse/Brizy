                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color8">Our Process</span></h2>'
                      }
                    }
                  ]
                }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-xs-center"><span class="brz-cp-color8">Concept</span></h5>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-xs-center"><span class="brz-cp-color8">Creation</span></h5>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-left brz-text-xs-center"><span class="brz-cp-color7" style="background-color: transparent;">No more buffering - create and enjoy. Our UI was built on&nbsp;</span><strong style="background-color: transparent;" class="brz-cp-color8">React JS</strong><span style="background-color: transparent;" class="brz-cp-color8">.</span></p>'
                                  }
                                }
                              ],
                              mobilePaddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-xs-center"><span class="brz-cp-color8">Testing</span></h5>'
                                  }
                                }
                              ]
                            }
