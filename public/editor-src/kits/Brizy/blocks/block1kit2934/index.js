                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading4"><span class="brz-cp-color8">"Life is full of inspiring writings, verses and people who have made a difference. With simple sentences, sayings and quotes you can make other people think and inspire."</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading5"><span class="brz-cp-color8">At vero eos et accusamus</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading4"><span class="brz-cp-color8">Sharing is caring</span></p>'
                                  }
                                }
                              ]
                            }
