                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-heading1"><span style="color: rgb(255, 255, 255);">Onboarding Users Of Your Product From Trial To Payment</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-fs-lg-18 brz-fs-im-17 brz-ff-noto_serif brz-fw-lg-300 brz-fw-im-300 brz-ls-lg-0_5 brz-ls-im-3 brz-lh-lg-1_7 brz-lh-im-1_7"><span class="brz-cp-color3">by&nbsp;Davide Schussler</span></p>'
                                  }
                                }
                              ]
                            }
