                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color2">Want to work together?</span></h2>'
                      }
                    }
                  ]
                }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "c5e102f7fffb631e16bd0dd1643669237b263bc3.png",
                                    imageWidth: 220,
                                    imageHeight: 65,
                                    resize: 42,
                                    mobileResize: 48,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "112c4a06d63dbcafc76567de3eca331b691ece4e.png",
                                    imageWidth: 220,
                                    imageHeight: 65,
                                    mobileHeight: 109,
                                    resize: 70,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "128c50f61cae87d57bf0c3016c62def283e2075f.png",
                                    imageWidth: 220,
                                    imageHeight: 65,
                                    resize: 70,
                                    mobileResize: 50,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "b8c3a82e285b61a65be400507efe4111704c669d.png",
                                    imageWidth: 220,
                                    imageHeight: 65,
                                    resize: 42,
                                    height: 54,
