                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-fs-sm-30 brz-text-xs-left brz-text-lg-right brz-ls-lg-m_1_5 brz-ff-montserrat brz-fs-lg-99 brz-fw-lg-400 brz-lh-lg-1 brz-fs-xs-30"><span class="brz-cp-color6" style="opacity: 0.7;">&nbsp;03</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-left brz-tp-button brz-text-lg-right"><strong style="opacity: 1;" class="brz-cp-color3">BEAUTY &amp; ART</strong></p>'
                                  }
                                }
                              ],
                              marginTop: 10,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    ...
                                    imageHeight: 1080,
                                    imageSrc:
                                      "2902172d547eaaa4b89f5a7e0c1a29a5.jpg",
                                    height: 121,
                                    positionX: 50,
                                    positionY: 88,
                                    resize: 100,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading3 brz-text-lg-left"><span class="brz-cp-color8">"Composition for me is a very connected and therapeutic process, and something I greaty enjoy. I don\u2019t enjoy styling in general"&nbsp;</span></p>'
                                  }
                                }
                              ],
                              paddingType: "grouped",
