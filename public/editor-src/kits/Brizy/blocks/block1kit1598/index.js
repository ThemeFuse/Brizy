module.exports = {
  ...
  keywords:
    "call to action,cover,hero,icon,image background,promo,slider,video",
  cat: [4395, 100],
  type: 0,
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color2">Great Styling For Headers And Hero Images</span></h1>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        ...
                        linkExternal:
                          "https://www.youtube.com/watch?v=8lQB3Had90A",
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-text-lg-center brz-tp-heading1"><span class="brz-cp-color2">The Best Features In Our Modern Software</span></h1>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-subtitle"><em class="brz-cp-color7">No more buffering: create, style and enjoy. The UI - user interface - was built on React the most efficient JavaScript library.&nbsp;</em></p>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color2"><span>Be The Webdesigner! It Gives You T&nbsp;he Power</span></span></h1>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-subtitle"><em class="brz-cp-color7">Every editing option is extremely well-thought to make it easy for&nbsp;you to find and work with - it will shorten the time needed to build your dream website.</em></p>'
                      }
                    }
                  ]
                }
