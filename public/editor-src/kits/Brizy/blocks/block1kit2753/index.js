                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-abovetitle"><span class="brz-cp-color3">GET TO KNOW</span></p>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color2">Our Founders</span></h2>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        ...
                        bgImageHeight: 1280,
                        bgImageSrc:
                          "7cec295a6bae37e1dfbfe05f7f417473961b0529.jpeg",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-left"><span class="brz-cp-color7" style="background-color: transparent;"><span>It is a front-end page builder where what you see is what you get. We designed it so you can be in complete control of your website.</span></span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">James Sully</span></h4>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><em class="brz-cp-color3">Chairman</em></p>'
                                  }
                                }
                              ]
                            }
                    ...
                    },
                    {
                      ...
                      value: {
                        ...
                        bgImageHeight: 1920,
                        bgImageSrc:
                          "65432ca76b31fd9a39f7fa9ae3dba4e5f6f611c9.jpeg",
                        ...
                        tabletWidth: 50.4,
                        tabletTabsState: "",
                        tabletBgPositionX: 39,
                        tabletBgPositionY: 24,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span style="background-color: transparent;" class="brz-cp-color7">No more buffering - create, style and enjoy. Our user interface was built on React, the most efficient JavaScript library.</span></p>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color2">Carmen Lee</span></h4>'
                                  }
                                }
                              ],
                              mobileMarginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><em class="brz-cp-color3">Director</em></p>'
                                  }
                                }
                              ]
                            }
