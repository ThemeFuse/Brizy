module.exports = {
  ...
  keywords: "call to action,cover,header,image background,promo,testimonial",
  cat: [4395, 100],
  type: 1,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color8"><span>Only&nbsp;</span></span><span class="brz-cp-color3">passion</span><span class="brz-cp-color8"> &amp;&nbsp;</span><span class="brz-cp-color3">hard work</span><span class="brz-cp-color8"> are keys of our success. This is the result!</span></h2>'
                                  }
                                }
                              ]
                            }
