                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color8" style="background-color: transparent;">Beautiful world</span></h1>'
                      }
                    }
                  ]
                }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-text-lg-center brz-tp-heading5"><span style="opacity: 1;" class="brz-cp-color8">Focus Groups</span></h5>'
                                  }
                                }
                              ],
                              marginBottom: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-center"><span class="brz-cp-color7"><span>Without a doubt there is something very relaxing and pleasurable about cooking.</span></span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-text-lg-center brz-tp-heading5"><span style="opacity: 1;" class="brz-cp-color8">Pressure Sensitive</span></h5>'
                                  }
                                }
                              ],
                              marginBottom: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-center"><span class="brz-cp-color7"><span>Increasing prosperity in our lives can be accomplished by having the right frame of mind.</span></span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-lg-center"><span class="brz-cp-color8">Smartwatch Ready</span></h5>'
                                  }
                                }
                              ],
                              marginBottom: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-center"><span class="brz-cp-color7"><span>The truth is, our thoughts are very powerful. They are capable of influencing.</span></span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-text-lg-center brz-tp-heading5"><span style="opacity: 1;" class="brz-cp-color8">Perfect On Mobiles</span></h5>'
                                  }
                                }
                              ],
                              marginBottom: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-center"><span class="brz-cp-color7"><span>There are not many cities that have experienced such social and political extremes.</span></span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
