        ...
        items: [
            {
                ...
                value: {
                                ...
                                items: [
                                    {
                                        ...
                                        value: {
                                            ...
                                            text: "<p class=\"brz-mb-lg-10 brz-tp-button brz-text-lg-center\"><span class=\"brz-cp-color5\">INTERFACE  | &nbsp;UI &amp; UX  |&nbsp;DESIGN  | &nbsp;LIFESTYLE&nbsp;</span></p>"
                                        }
                                    }
                                ]
                            }
                                ...
                                items: [
                                    {
                                        ...
                                        value: {
                                            ...
                                            text: "<p class=\"brz-text-lg-center brz-lh-lg-1_3 brz-lh-im-1_3 brz-ls-lg-m_1_5 brz-ls-im-m_1 brz-ff-montserrat brz-fw-lg-200 brz-fw-im-200 brz-fs-lg-74 brz-fs-im-52 brz-mb-lg-10\"><span style=\"color: rgb(255, 255, 255);\">Title of the blog post</span></p>"
                                        }
                                    }
                                ]
                            }
                    ...
                    bgColorHex: "#142850",
                    bgColorOpacity: 0.57999999999999996003197111349436454474925994873046875,
                    tempBgColorOpacity: 0.57999999999999996003197111349436454474925994873046875,
                    padding: 250,
                    paddingTop: 136,
                    paddingBottom: 102,
                    bgImageWidth: 1920,
                    bgImageHeight: 1440,
                    bgImageSrc: "538cdf96841e95021bca90807bd95c19.jpg",
                    bgPositionX: 85,
                    bgPositionY: 74,
                                ...
                                items: [
                                    {
                                        ...
                                        value: {
                                            ...
                                            text: "<p class=\"brz-fs-lg-80 brz-ff-montserrat brz-ls-lg-m_1_5 brz-fs-xs-34 brz-lh-xs-1_3 brz-lh-lg-1_3 brz-text-lg-right\"><span class=\"brz-cp-color2\">Be&nbsp;</span><strong class=\"brz-cp-color2\">The Webdesigner!</strong><span class=\"brz-cp-color2\"> Brizy</span></p><p class=\"brz-fs-lg-80 brz-ff-montserrat brz-ls-lg-m_1_5 brz-fs-xs-34 brz-lh-xs-1_3 brz-lh-lg-1_3 brz-text-lg-right\"><span class=\"brz-cp-color2\"> Gives You The Power</span></p>"
                                        }
                                    }
                                ],
                                paddingType: "ungrouped",
                                ...
                                items: [
                                    {
                                        ...
                                        value: {
                                            ...
                                            text: "<p class=\"brz-tp-subtitle brz-text-lg-right\"><em class=\"brz-cp-color7\">Every editing option is extremely well-thought to make it easy for you to find and work with.&nbsp;</em></p>"
                                        }
                                    }
                                ]
                            }
