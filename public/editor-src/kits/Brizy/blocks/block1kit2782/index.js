                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color2">Testimonials</span></h2>'
                      }
                    }
                  ]
                }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-text-lg-center brz-tp-heading6"><span class="brz-cp-color2">Susan Whiting</span></h6>'
                                  }
                                }
                              ],
                              tabletMarginBottomSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    ...
                                    borderRadius: 40,
                                    imageSrc:
                                      "182511c469294bad878d06871b2fcd8505457b9d.jpeg"
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h6 class="brz-text-lg-center brz-tp-heading6"><span class="brz-cp-color2">Frank Simons</span></h6>'
                                  }
                                }
                              ],
                              tabletMarginBottomSuffix: "px",
