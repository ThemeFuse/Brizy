                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-tp-heading1 brz-text-lg-center"><span class="brz-cp-color8">Get In Touch</span></h2>'
                      }
                    }
                  ],
                  marginTop: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mb-lg-0 brz-text-xs-center brz-tp-heading6 brz-mb-xs-0"><span class="brz-cp-color3" style="background-color: transparent;">ADDRESS:</span></p>'
                                  }
                                }
                              ],
                              marginBottom: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading6 brz-text-xs-center brz-mb-lg-0 brz-mb-xs-0"><span class="brz-cp-color3" style="background-color: transparent;">OPENING HOURS:</span></p>'
                                  }
                                }
                              ],
                              marginBottom: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mb-lg-0 brz-text-xs-center brz-tp-heading6 brz-mb-xs-0"><span class="brz-cp-color3" style="background-color: transparent;">PHONE NUMBERS:</span></p>'
                                  }
                                }
                              ],
                              marginBottom: 0
