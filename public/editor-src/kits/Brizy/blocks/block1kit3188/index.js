                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    ...
                                    mobilePositionX: 51,
                                    imageSrc:
                                      "a239afd333059ec360b152d9088dbe962766ac7c.jpeg",
                                    positionX: 37,
                                    positionY: 53,
                                    mobilePositionY: 53
                                  }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-tp-abovetitle"><span class="brz-cp-color3">GET IN TOUCH</span></p>'
                                  }
                                }
                              ],
                              marginBottom: 0
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h3 class="brz-text-xs-center brz-tp-heading2"><span class="brz-cp-color8">Share Your Project</span></h3>'
                                  }
                                }
                              ],
                              marginBottom: 0
