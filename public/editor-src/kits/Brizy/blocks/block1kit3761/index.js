                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-heading4 brz-text-lg-left"><span class="brz-cp-color8">"Composition for me is a very connected and therapeutic process, and something I immensely enjoy. I have experienced however that if I don\u2019t enjoy styling, the joy in styling and shooting is diluted"&nbsp;</span></p>'
                                  }
                                }
                              ],
                              paddingType: "grouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-fs-sm-30 brz-text-lg-left brz-lh-lg-1 brz-fw-lg-400 brz-fs-lg-99 brz-ff-montserrat brz-ls-lg-m_1_5 brz-fs-xs-30"><span class="brz-cp-color6" style="opacity: 0.7;">02</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-button brz-text-lg-left"><strong style="opacity: 1;" class="brz-cp-color3">AESTHETICS</strong></p>'
                                  }
                                }
                              ],
                              marginTop: 10,
