module.exports = {
  ...
  keywords: "features,Gallery,grid,image background,masonry,projects",
  cat: [4561, 100],
  type: 1,
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-text-lg-center brz-tp-heading2"><span style="opacity: 1;" class="brz-cp-color8">Web Design, Reinvented</span></h2>'
                      }
                    }
                  ],
                  marginBottom: 20,
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-tp-subtitle brz-text-lg-center"><em class="brz-cp-color7">Bring vibrance to your site by setting color &amp; transparency&nbsp;with our color overlays options. Simple, fast &amp; stylish. No matter if you\'ve used a visual page builder before, with this you\'ll be a pro the second you start using it.</em></p>'
                      }
                    }
                  ],
                  paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "0948204a546a2476ec275d2a1f956071bad6ff95.jpeg",
                                    imageWidth: 370,
                                    imageHeight: 370,
                                    mobileResize: 90
                                  }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "43ac9dc51d49623d64315969cafb11c81d2716ee.jpeg",
                                    imageWidth: 770,
                                    imageHeight: 370,
                                    mobileResize: 90
                                  }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "61598acd0ab9e4490a075862635b55c1c31e3a51.jpeg",
                                    imageWidth: 770,
                                    imageHeight: 370,
                                    tabletResize: 95,
                                    mobileResize: 90
