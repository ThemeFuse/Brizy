                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-tp-heading2 brz-mt-lg-20 brz-text-lg-center"><span class="brz-cp-color2">Lorem Ipsum Dolor Sit Amet Consectetur Adipisicing Elit Sed Do Eiusm&nbsp;</span></h1>'
                      }
                    }
                  ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<p class="brz-tp-subtitle brz-text-lg-right"><em class="brz-cp-color2">25 Comments</em></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10,
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<p class="brz-tp-subtitle brz-text-lg-left"><em class="brz-cp-color2">August 28, 2018</em></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 12
