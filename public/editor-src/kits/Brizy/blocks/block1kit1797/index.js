                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-mt-lg-10 brz-mb-lg-0 brz-tp-button brz-text-lg-center"><span class="brz-cp-color8">RAMIRA LOPEZ</span></p>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-text-lg-center brz-tp-paragraph brz-mt-lg-0 brz-mb-lg-0"><em style="opacity: 0.75;" class="brz-cp-color5">Author &amp; Co-founder</em></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-heading4"><span class="brz-cp-color3">Are Yokocho &amp; Izakaya alleyways worth it for bar Hopping in Tokyo?</span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
