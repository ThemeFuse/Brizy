module.exports = {
  ...
  keywords:
    "features,Gallery,grid,icon box,icons,images,services,three columns",
  cat: [4447, 100],
  type: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h2 class="brz-text-lg-left brz-tp-heading2"><span class="brz-cp-color2">Our Studio</span></h2>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-subtitle"><em class="brz-cp-color7" style="background-color: transparent;">With it you can enjoy creating, building your dream website!</em></p>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "80dc91c2d62894a53b15a2a5f5742b7b9253c10c.jpeg",
                                    imageWidth: 1000,
                                    imageHeight: 660,
                                    height: 90,
                                    mobileHeight: 90,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "55bc5c8474d726ab0a17c8f7d745a99d5b3bab55.jpeg",
                                    imageWidth: 1000,
                                    imageHeight: 660,
                                    height: 90,
                                    mobileHeight: 90,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "fd5920cf260b05ddc8c049d7f499d9c3ac4b8835.jpeg",
                                    imageWidth: 1000,
                                    imageHeight: 660,
                                    height: 90,
                                    mobileHeight: 90,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "111a8c1bcf828e9962dd6da636944f99927bf156.jpeg",
                                    imageWidth: 1000,
                                    imageHeight: 660,
                                    height: 90,
                                    mobileHeight: 90,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-lg-center"><strong class="brz-cp-color2">Vector Icons &amp; Shapes</strong></h5>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-center"><span class="brz-cp-color7"><span>It is a front-end page builder where what you see is what you get.</span></span></p>'
                                  }
                                }
                              ],
                              marginRight: 15,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-text-lg-center brz-tp-heading5"><strong class="brz-cp-color2">No Coding Skills Required</strong></h5>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-lg-center brz-tp-paragraph"><span class="brz-cp-color7">Let\'s not get technical! Create up-to-date designs without writing any code.</span></p>'
                                  }
                                }
                              ],
                              marginRight: 15,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-lg-center"><strong class="brz-cp-color2">Latest Web Technologies</strong></h5>'
                                  }
                                }
                              ],
                              marginTop: 0,
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-center"><span class="brz-cp-color7">Every editing option iswell-thought to make it easy for you to work with.</span></p>'
                                  }
                                }
                              ],
                              marginRight: 15,
