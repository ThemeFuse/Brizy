                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<h2 class=\"brz-text-lg-left brz-tp-heading2\"><span class=\"brz-cp-color2\">Our Studio</span></h2>"
                                                                }
                                                            }
                                                        ]
                                                    }
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<h5 class=\"brz-tp-heading5 brz-text-lg-center\"><strong class=\"brz-cp-color2\">Vector Icons &amp; Shapes</strong></h5>"
                                                                }
                                                            }
                                                        ],
                                                        "marginTop": 0,
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<h5 class=\"brz-text-lg-center brz-tp-heading5\"><strong class=\"brz-cp-color2\">No Coding Skills Required</strong></h5>"
                                                                }
                                                            }
                                                        ],
                                                        "marginTop": 0,
                                                        ...
                                                        "items": [
                                                            {
                                                                ...
                                                                "value": {
                                                                    ...
                                                                    "text": "<h5 class=\"brz-tp-heading5 brz-text-lg-center\"><strong class=\"brz-cp-color2\">Latest Web Technologies</strong></h5>"
                                                                }
                                                            }
                                                        ],
                                                        "marginTop": 0,
