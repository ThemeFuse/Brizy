                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-text-lg-center brz-mt-lg-20 brz-tp-heading2"><span class="brz-cp-color8">Lorem Ipsum Dolor Sit Amet Consectetur Adipisicing Elit Sed Do Eiusm&nbsp;</span></h1>'
                      }
                    }
                  ],
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<p class="brz-tp-subtitle brz-text-lg-right brz-text-xs-right"><em style="color: rgb(255, 255, 255);">25 Comments</em></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 10,
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<p class="brz-text-lg-left brz-tp-subtitle"><em style="color: rgb(255, 255, 255);">August 28, 2018</em></p>'
                                        }
                                      }
                                    ],
                                    iconSpacing: 12
