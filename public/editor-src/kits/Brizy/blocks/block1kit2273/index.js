module.exports = {
  ...
  keywords: "image background,projects,services,text,three columns",
  cat: [4447, 100],
  type: 0,
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-lg-center brz-tp-abovetitle"><span class="brz-cp-color3">BUILDING MADE EASY</span></p>'
                      }
                    }
                  ]
                }
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h2 class="brz-text-lg-center brz-tp-heading2"><span class="brz-cp-color2">Our Process</span></h2>'
                      }
                    }
                  ]
                }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-text-lg-center brz-tp-heading1"><span class="brz-cp-color3">01</span></h1>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-xs-center"><span class="brz-cp-color2">Concept</span></h5>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-text-xs-center brz-text-lg-left brz-tp-paragraph"><span class="brz-cp-color7" style="background-color: transparent;"><span>It is a front-end page builder where what you see is what you get.</span></span></p>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-text-lg-center brz-tp-heading1"><span class="brz-cp-color3">02</span></h1>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-xs-center"><span class="brz-cp-color2">Creation</span></h5>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-left brz-text-xs-center"><span class="brz-cp-color7" style="background-color: transparent;">No more buffering - create and enjoy. Our UI was built on&nbsp;</span><strong class="brz-cp-color2" style="background-color: transparent;">React JS</strong><span class="brz-cp-color7" style="background-color: transparent;">.</span></p>'
                                  }
                                }
                              ],
                              mobilePaddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h1 class="brz-text-lg-center brz-tp-heading1"><span class="brz-cp-color3">03</span></h1>'
                                  }
                                }
                              ],
                              marginRightSuffix: "px",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h5 class="brz-tp-heading5 brz-text-xs-center"><span class="brz-cp-color2">Testing</span></h5>'
                                  }
                                }
                              ]
                            }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-left brz-text-xs-center"><span class="brz-cp-color7" style="background-color: transparent;">Every text, image, icon or button can be easily edited or replaced.</span></p>'
                                  }
                                }
                              ],
                              mobilePaddingType: "ungrouped",
