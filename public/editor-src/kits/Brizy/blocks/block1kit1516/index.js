module.exports = {
  ...
  keywords: "button,call to action,cover,header,hero,icon,image background",
  cat: [4395, 100],
  type: 0,
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-ls-lg-m_3 brz-ff-montserrat brz-text-lg-center brz-lh-lg-1_3 brz-lh-xs-1_3 brz-fs-xs-34 brz-fs-lg-80 brz-text-xs-center"><span style="opacity: 1;" class="brz-cp-color3">Websites&nbsp;Fast &amp; Easy</span></h1><p class="brz-ls-lg-m_3 brz-ff-montserrat brz-text-lg-center brz-lh-lg-1_3 brz-lh-xs-1_3 brz-fs-xs-34 brz-fs-lg-80 brz-text-xs-center"><span style="opacity: 1;" class="brz-cp-color8">Only&nbsp;With Our Builder</span></p>'
                      }
                    }
                  ],
                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<p class="brz-text-xs-center brz-text-lg-center brz-tp-subtitle"><em class="brz-cp-color8" style="opacity: 0.8;">No coding skills required,&nbsp;</em></p>'
                      }
                    }
                  ]
                }
