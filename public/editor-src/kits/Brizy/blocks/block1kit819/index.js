                  ...
                  items: [
                    {
                      ...
                      value: {
                        _styles: ["richText"],
                        text:
                          '<h1 class="brz-text-lg-center brz-tp-heading1 brz-mb-lg-0"><span class="brz-cp-color2">Build Websites Fast &amp; Easy</span></h1>'
                      }
                    }
                  ]
                }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          ...
                                          text:
                                            '<h5 class="brz-tp-heading5 brz-mb-lg-10"><span class="brz-cp-color2">Strategy &amp; Planning</span></h5><p class="brz-tp-paragraph"><span class="brz-cp-color7">Every text, image, icon or button can be edited or replaced simply by selecting.</span></p>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5 brz-mb-lg-10"><span class="brz-cp-color2"><span>Release &amp; Marketing</span></span></h5><p class="brz-tp-paragraph"><span class="brz-cp-color7"><span>This will shorten the time needed to build your dream website. It\u2019s easy!</span></span></p>'
                                        }
                                      }
                                    ]
                                  }
                                    ...
                                    items: [
                                      ...
                                      },
                                      {
                                        ...
                                        value: {
                                          _styles: ["text", "iconText--text"],
                                          text:
                                            '<h5 class="brz-tp-heading5 brz-mb-lg-10"><span class="brz-cp-color2">Design &amp; Development</span></h5><p class="brz-tp-paragraph"><span class="brz-cp-color7">Every editing option is extremely well-thought to make it easy for you to find.</span></p>'
                                        }
                                      }
                                    ]
                                  }
