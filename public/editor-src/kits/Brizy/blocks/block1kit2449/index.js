                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "1ff804978ef79c94e77b812192a7fb0c4d4b0b1d.jpeg",
                                    imageWidth: 350,
                                    imageHeight: 334,
                                    mobileResize: 92
                                  }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">No Skills Required</span></h4>'
                                  }
                                }
                              ],
                              marginLeft: 50
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph brz-text-lg-left"><span class="brz-cp-color7" style="background-color: transparent;"><span>Bring vibrance to your site by setting color &amp; transparency&nbsp;with our color overlays options.&nbsp;Simple, fast &amp; stylish only with our builder!</span></span></p>'
                                  }
                                }
                              ],
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">Easy To Use</span></h4>'
                                  }
                                }
                              ],
                              marginLeft: 50
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<p class="brz-tp-paragraph"><span style="background-color: transparent;" class="brz-cp-color7">Let\'s not get technical! Create up-to-date designs without writing a single line of code. Build clean, minimalistic websites.</span></p>'
                                  }
                                }
                              ],
                              paddingType: "ungrouped",
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "fe48943e12fd81a902d93ef33784430a516c26b1.jpeg",
                                    imageWidth: 350,
                                    imageHeight: 334,
                                    mobileResize: 92
                                  }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["image"],
                                    imageSrc:
                                      "4f9f824ff21fb76c7b2317c392924a789b133b97.jpeg",
                                    imageWidth: 350,
                                    imageHeight: 334,
                                    mobileResize: 92
                                  }
                              ...
                              items: [
                                {
                                  ...
                                  value: {
                                    _styles: ["richText"],
                                    text:
                                      '<h4 class="brz-tp-heading4"><span class="brz-cp-color8">Color Overlays</span></h4>'
                                  }
                                }
                              ],
                              marginLeft: 50
