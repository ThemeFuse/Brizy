...
keywords: "services, projects, three columns, features, image background, button, icon box",
cat: [0, 7, 5, 3],
type: 1,
                                ...
                                items: [
                                    {
                                        ...
                                        value: {
                                            ...
                                            text: "<p class=\"brz-tp-abovetitle brz-text-lg-center\"><span class=\"brz-cp-color3\">FEATURES &amp; SERVICES</span></p>"
                                        }
                                    }
                                ],
                                marginBottom: 0
                                ...
                                items: [
                                    {
                                        ...
                                        value: {
                                            ...
                                            text: "<h2 class=\"brz-text-lg-center brz-tp-heading2\"><span class=\"brz-cp-color8\">Services We Can Help You With</span></h2>"
                                        }
                                    }
                                ]
                            }
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<h4 class=\"brz-text-lg-center brz-tp-heading4\"><span class=\"brz-cp-color8\">Web Design</span></h4>"
                                                                }
                                                            }
                                                        ]
                                                    }
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<p class=\"brz-text-lg-center brz-tp-paragraph\"><span style=\"background-color: transparent;\" class=\"brz-cp-color7\">Brizy is a front-end page builder where what you see is what you get. We designed it so you can be in control.</span></p>"
                                                                }
                                                            }
                                                        ]
                                                    }
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<h4 class=\"brz-text-lg-center brz-tp-heading4\"><span class=\"brz-cp-color8\">Development</span></h4>"
                                                                }
                                                            }
                                                        ]
                                                    }
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<p class=\"brz-text-lg-center brz-tp-paragraph\"><span style=\"background-color: transparent;\" class=\"brz-cp-color7\">No more buffering - create, style and enjoy. Our user interface was built on React - the most efficient library.</span></p>"
                                                                }
                                                            }
                                                        ]
                                                    }
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<h4 class=\"brz-text-lg-center brz-tp-heading4\"><span class=\"brz-cp-color8\">Consulting</span></h4>"
                                                                }
                                                            }
                                                        ]
                                                    }
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                value: {
                                                                    ...
                                                                    text: "<p class=\"brz-text-lg-center brz-tp-paragraph\"><span style=\"background-color: transparent;\" class=\"brz-cp-color7\">Let's not get technical! Create up-to-date designs without writing a single line of code. Build clean websites.</span></p>"
                                                                }
                                                            }
                                                        ]
                                                    }
