...
<html lang="en">
    ...
    <body class="brz brz-ed" style="display: flex; justify-content: center;">
        ...
        <div class="brz-ed-resizer-left__container"><div class="brz-ed-resizer brz-ed-resizer-left"></div></div>
        <iframe id="brz-ed-iframe" class="brz-iframe brz-ed-iframe--desktop" style="border: 0; width: 100%;" src="<?php echo $iframe_url; ?>"></iframe>
        <div class="brz-ed-resizer-right__container"><div class="brz-ed-resizer brz-ed-resizer-right"></div></div>
        <div class="brz-ed-resizer-bottom__container"><div class="brz-ed-resizer brz-ed-resizer-bottom"></div ></div>
