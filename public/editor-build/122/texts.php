...
class Brizy_Public_EditorBuild_122_Texts {
	public static function get_editor_texts() {
		return apply_filters('brizy_editor_config_texts', array(
			...
			"Close Button" => __("Close Button", "brizy"),
			...
			"Show After" => __("Show After", "brizy"),
