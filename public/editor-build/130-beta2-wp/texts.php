...
class Brizy_Public_EditorBuild_130Beta2Wp_Texts {
	public static function get_editor_texts() {
		return apply_filters('brizy_editor_config_texts', array(
			...
			"After spacing" => __("After spacing", "brizy"),
			...
			"Enable text" => __("Enable text", "brizy"),
			...
			"Screen Name" => __("Screen Name", "brizy"),
			...
			"Show Count" => __("Show Count", "brizy"),
			...
			"Spacing After" => __("Spacing After", "brizy"),
			...
			"Style 3" => __("Style 3", "brizy"),
			"Style 4" => __("Style 4", "brizy"),
