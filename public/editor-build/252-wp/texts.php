...
class Brizy_Public_EditorBuild_252Wp_Texts {
	public static function get_editor_texts() {
		return apply_filters('brizy_editor_config_texts', array(
			...
			"<div class='..'" => __("<div class='..'", "brizy"),
			"<div class='trusted-...'" => __("<div class='trusted-...'", "brizy"),
			"<div data-att.." => __("<div data-att..", "brizy"),
			"<div data-fera..." => __("<div data-fera...", "brizy"),
			"? (%s)" => __("? (%s)", "brizy"),
			...
			"Buy Button" => __("Buy Button", "brizy"),
			...
			"ColorBurn" => __("ColorBurn", "brizy"),
			"ColorDodge" => __("ColorDodge", "brizy"),
			...
			"Count Per Page" => __("Count Per Page", "brizy"),
			...
			"Detail" => __("Detail", "brizy"),
			"Detail Button" => __("Detail Button", "brizy"),
			"Detail Page" => __("Detail Page", "brizy"),
			"Details" => __("Details", "brizy"),
			...
			"Dots" => __("Dots", "brizy"),
			"Down" => __("Down", "brizy"),
			"DownLeft" => __("DownLeft", "brizy"),
			"DownRight" => __("DownRight", "brizy"),
			"DownUp" => __("DownUp", "brizy"),
			"Download Button" => __("Download Button", "brizy"),
			...
			"Embed FormID" => __("Embed FormID", "brizy"),
			...
			"File" => __("File", "brizy"),
			"File too large." => __("File too large.", "brizy"),
			"File upload error" => __("File upload error", "brizy"),
			...
			"Get your tracking page URL in the Tracking pages session of AfterShip application." => __("Get your tracking page URL in the Tracking pages session of AfterShip application.", "brizy"),
			...
			"HoverOpacity" => __("HoverOpacity", "brizy"),
			"How many" => __("How many", "brizy"),
			"Howmany" => __("Howmany", "brizy"),
			"Hue" => __("Hue", "brizy"),
			...
			"If this is selected the Non Features option does not apply." => __("If this is selected the Non Features option does not apply.", "brizy"),
			...
			"Item" => __("Item", "brizy"),
			"Items Per Page" => __("Items Per Page", "brizy"),
			...
			"Like" => __("Like", "brizy"),
			"Like Button" => __("Like Button", "brizy"),
			...
			"Non features" => __("Non features", "brizy"),
			"None" => __("None", "brizy"),
			...
			"Pre-display Button" => __("Pre-display Button", "brizy"),
			...
			"Slides to show" => __("Slides to show", "brizy"),
			"Slug" => __("Slug", "brizy"),
			...
			"URL of event detail page. If used will add a link to the heading and image to take the user to the event detail page. Requires the \"Event Detail\" widget to be placed on a page and that page url/slug placed in this field." => __("URL of event detail page. If used will add a link to the heading and image to take the user to the event detail page. Requires the \"Event Detail\" widget to be placed on a page and that page url/slug placed in this field.", "brizy"),
			...
			"Unable to upload" => __("Unable to upload", "brizy"),
			...
			"Up" => __("Up", "brizy"),
			"UpDown" => __("UpDown", "brizy"),
			"UpLeft" => __("UpLeft", "brizy"),
			"UpRight" => __("UpRight", "brizy"),
			...
			"Use only one widget per page among Widget, HomePage Review, Showcase Review" => __("Use only one widget per page among Widget, HomePage Review, Showcase Review", "brizy"),
			"User" => __("User", "brizy"),
			...
			"Wide Bundle" => __("Wide Bundle", "brizy"),
			...
			"Works if PRO Plan" => __("Works if PRO Plan", "brizy"),
			"X" => __("X", "brizy"),
			"Y" => __("Y", "brizy"),
