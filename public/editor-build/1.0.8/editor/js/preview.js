!function(t,e){function i(t,e,i,r){var l=function(t){!t&&(t=a.event);var e={originalEvent:t,target:t.target||t.srcElement,type:"wheel",deltaMode:"MozMousePixelScroll"==t.type?0:1,deltaX:0,deltaZ:0,notRealWheel:1,preventDefault:function(){t.preventDefault?t.preventDefault():t.returnValue=!1}};return"mousewheel"==s?(e.deltaY=-.025*t.wheelDelta,t.wheelDeltaX&&(e.deltaX=-.025*t.wheelDeltaX)):e.deltaY=t.detail/3,i(e)};t[n](o+e,"wheel"==s?i:l,r||!1)}var n,s,o="";t.addEventListener?n="addEventListener":(n="attachEvent",o="on"),s="onwheel"in e.createElement("div")?"wheel":"undefined"!=typeof e.onmousewheel?"mousewheel":"DOMMouseScroll",t.addWheelListener=function(t,e,n){i(t,s,e,n),"DOMMouseScroll"==s&&i(t,"MozMousePixelScroll",e,n)}}(window,document),function(t,e,i,n){"use strict";function s(t,n){this.isMobile()||(this.$elem=$(t),this.options=$.extend({bgClass:"parallax-bg",wheelIgnoreClass:[],items:[],baseElement:e,windowHeight:Math.max(i.documentElement.clientHeight,e.innerHeight||0),r:0,u:0,v:0,s:!1,F:!1},n),this._handleScrollBound=this._handleScroll.bind(this),this._handleWheelBound=this._handleWheel.bind(this),this._handleResizeBound=this._handleResize.bind(this),this._init())}var o="parallax",r="plugin_"+o;$.extend(s.prototype,{_init:function(){this.options.windowHeight=Math.max(i.documentElement.clientHeight,e.innerHeight||0),this.profileParallaxElements(),this._attachEvents(),this.d()},_attachEvents:function(){this.options.baseElement.addEventListener("scroll",this._handleScrollBound,!1),e.addEventListener("wheel",this._handleWheelBound,!1),e.addEventListener("resize",this._handleResizeBound,!1)},_detachEvents:function(){this.options.baseElement.removeEventListener("scroll",this._handleScrollBound,!1),e.removeEventListener("wheel",this._handleWheelBound,!1),e.removeEventListener("resize",this._handleResizeBound,!1)},_handleScroll:function(t){this.options.F=!0},_handleWheel:function(t){var e=2,i=4;return this.options.wheelIgnoreClass&&this.options.wheelIgnoreClass.length>0&&$(t.target).closest("."+this.options.wheelIgnoreClass.join(", .")).length>0?null:(t.preventDefault&&t.preventDefault(),this.options.v=t.notRealWheel?-t.deltaY/4:1==t.deltaMode?-t.deltaY/3:100===Math.abs(t.deltaY)?-t.deltaY/120:-t.deltaY/40,this.options.v=-e>this.options.v?-e:this.options.v,this.options.v=this.options.v>e?e:this.options.v,this.options.s=!0,this.options.u=i,void 0)},_handleResize:function(){this.options.windowHeight=Math.max(i.documentElement.clientHeight,e.innerHeight||0),this.options.r=this.b(),this.profileParallaxElements()},profileParallaxElements:function(){var t=this.$elem,e=this;this.options.items=[],this.options.r=this.b(),t.find("."+this.options.bgClass).each(function(){var i=t,n=i.offset().top,s=e.getHeight(i),o=!1;s&&e.setHeight(i,s),e.options.items.push({section:i.get(0),outerHeight:i.outerHeight(),elemTop:n,elemBottom:n+i.outerHeight(),isFirstSection:!!o,imageHolder:this}),e.mr_setTranslate3DTransform($(this).get(0),(e.f()+e.options.windowHeight-n)/2)})},setHeight:function(t,e){$(t).find("."+this.options.bgClass).css({height:100*e+"vh"})},getHeight:function(t){var e=$(t),i=$(this.options.baseElement).height(),n=e.height(),s=n/i;return n>i?s:null},getTransformStyle:function(t){for(var e=0;e<t.length;e++)if("undefined"!=typeof i.body.style[t[e]])return t[e];return null},getScrollingState:function(){return this.options.u>0},getCurrentElement:function(t){for(var e=0,i=this.options.items.length;this.options.items[e]&&this.options.items[e].section!==t;e++);return e===i?-1:e},isFunction:function(t){var e={};return t&&"[object Function]"===e.toString.call(t)},isMobile:function(){return/Android|iPad|iPhone|iPod|BlackBerry|Windows Phone/i.test(navigator.userAgent||navigator.vendor||e.opera)},requestAnimationFrame:function(t){var e=this.options.baseElement.requestAnimationFrame||this.options.baseElement.mozRequestAnimationFrame||this.options.baseElement.webkitRequestAnimationFrame||this.options.baseElement.msRequestAnimationFrame;return e(t)},mr_setTranslate3DTransform:function(t,e){var i=this.getTransformStyle(["transform","msTransform","webkitTransform","mozTransform","oTransform"]);t.style[i]="translate3d(0,"+e+"px,0)"},refresh:function(t){this.profileParallaxElements()},destroy:function(t){this._detachEvents(),this.$elem.removeData(r),this.$elem.find("."+this.options.bgClass).css({height:"",transform:""})},e:function(t,e){var i=this.isVariant();i?e+this.options.windowHeight-this.options.r>t.elemTop&&e-this.options.r<t.elemBottom&&(t.isFirstSection?this.mr_setTranslate3DTransform(t.imageHolder,e/2):this.mr_setTranslate3DTransform(t.imageHolder,e-t.elemTop-this.options.r)/2):e+this.options.windowHeight>t.elemTop&&e<t.elemBottom&&(t.isFirstSection?this.mr_setTranslate3DTransform(t.imageHolder,e/2):this.mr_setTranslate3DTransform(t.imageHolder,(e+this.options.windowHeight-t.elemTop)/2))},c:function(t,e,i,n){var s=t-1;return s/=n,t/=n,s--,t--,i*(t*t*t*t*t+1)+e-(i*(s*s*s*s*s+1)+e)},d:function(){var t=300,e=1,i=30,n=0;if(this.options.F){for(var s=this.options.items.length,o=this.f();s--;)this.e(this.options.items[s],o);this.options.F=!1}this.options.s&&(n+=-this.options.v*this.c(this.options.u,0,t,i),(n>e||-e>n)&&(this.options.baseElement.scrollBy(0,n),n=0),this.options.u++,this.options.u>i&&(this.options.u=0,this.options.s=!1,this.options.v=0,n=0)),this.requestAnimationFrame.call(this,this.d.bind(this))},isVariant:function(){return!1},b:function(){return $(this.options.baseElement).outerHeight(!0)},f:function(){return this.options.baseElement!=e?this.options.baseElement.scrollTop:0===i.documentElement.scrollTop?i.body.scrollTop:i.documentElement.scrollTop}}),$.fn[o]=function(t){if(t===n||"object"==typeof t)return this.each(function(){$.data(this,r)||$.data(this,r,new s(this,t))});if("string"==typeof t&&"_"!==t[0]&&"init"!==t){var e=Array.prototype.slice.call(arguments,1);return this.each(function(){var i=$.data(this,r);i instanceof s&&"function"==typeof i[t]&&i[t].apply(i,e)})}}}(jQuery,window,document);
!function(t,i,e,n){"use strict";function s(i,e){this.$elem=t(i),this.settings=t.extend({},a,e),this._handleIframeLoad=this._updateSettings.bind(this),this.handleVisibilitychange=this._updateSettings.bind(this),this._handleWindowResize=function(){this.refresh()}.bind(this),this._init()}var h="plugin_backgroundVideo",a={autoResize:!0,type:"youtube",mute:null,quality:null},o={youtube:function(t){var i=void 0===t.mute?null:t.mute,e=void 0===t.quality?null:t.quality;null!==i&&this.contentWindow.postMessage(JSON.stringify({event:"command",func:i?"mute":"unMute"}),"*"),null!==e&&this.contentWindow.postMessage(JSON.stringify({event:"command",func:"setPlaybackQuality",args:["hd"+e,!0]}),"*")},vimeo:function(t){(void 0===t.mute?null:t.mute)&&this.contentWindow.postMessage(JSON.stringify({method:"setVolume",value:0}),"*")}};t.extend(s.prototype,{_init:function(){this._resizePlayer(),this._attachEvents()},_updateSettings:function(){var t=this.$elem.find("iframe");o[this.settings.type].call(t.get(0),this.settings)},_resizePlayer:function(){var t=this.$elem.find("iframe"),i=function(){var t=this.$elem.width(),i=this.$elem.height();if(t/1.78<i){var e=Math.ceil(1.78*i);return{width:e,height:i,left:(t-e)/2,top:0}}var n=Math.ceil(t/1.78);return{width:t,height:n,left:0,top:(i-n)/2}}.call(this);t.width(i.width).height(i.height).css({left:i.left,top:i.top})},_attachEvents:function(){this.$elem.find("iframe").on("load",this._handleIframeLoad),t(i).on("visibilitychange",this.handleVisibilitychange),this.settings.autoResize&&t(i).on("resize",this._handleWindowResize)},_detachEvents:function(){this.$elem.find("iframe").off("load",this._handleIframeLoad),t(i).on("visibilitychange",this.handleVisibilitychange),this.settings.autoResize&&t(i).off("resize",this._resizeHandler)},refresh:function(i){this.settings=t.extend({},a,this.settings,i),this._updateSettings(),this._resizePlayer()},destroy:function(){this._detachEvents(),this.$elem.removeData(h),this.$elem=null,this.settings=null,this._handleIframeLoad=null,this._handleWindowResize=null}}),t.fn.backgroundVideo=function(i){if(void 0===i||"object"==typeof i)return this.each(function(){t.data(this,h)||t.data(this,h,new s(this,i))});if("string"==typeof i&&"_"!==i[0]){var e=Array.prototype.slice.call(arguments,1);return this.each(function(){var n=t.data(this,h);n instanceof s&&"function"==typeof n[i]&&n[i].apply(n,e)})}}}(jQuery,window,document);
!function(t,e,i,s){function n(t){"use strict";this.settings=$.extend({now:(new Date).getTime()},t),this._startTime=(new Date).getTime(),this.start(),this.tick()}var a="countdown";$.extend(n.prototype,{start:function(){this.intervalId=setInterval(this.tick.bind(this),this.settings.tickInterval)},update:function(t){this.settings=$.extend({},this.settings,t),this.intervalId||this.start(),this.tick()},tick:function(){var t=this.settings.now+((new Date).getTime()-this._startTime),e=Number(this.settings.endDate)+Number(this.settings.timeZoneOffset),i=this.settings.language,s=e-t,n=s>0,a=n?Math.floor(s/864e5):0,o=n?Math.floor(s%864e5/36e5):0,h=n?Math.floor(s%864e5/6e4)%60:0,r=n?Math.floor(s%864e5/1e3)%60%60:0;this.settings.onTick({days:{title:i.whichLabels(a)[3],amount:a},hours:{title:i.whichLabels(o)[4],amount:o},minutes:{title:i.whichLabels(h)[5],amount:h},seconds:{title:i.whichLabels(r)[6],amount:r}}),n||this.destroy()},destroy:function(){clearInterval(this.intervalId),this.intervalId=null}}),$.fn[a]=function(t){var e="plugin_"+a;return t===s||"object"==typeof t?this.each(function(){$.data(this,e)?$.data(this,e).update(t):$.data(this,e,new n(t))}):"string"==typeof t&&"_"!==t[0]&&"init"!==t?this.each(function(){var i=$.data(this,e);i instanceof n&&"function"==typeof i[t]&&i[t].apply(i,Array.prototype.slice.call(arguments,1))}):void 0}}(jQuery,window,document);
