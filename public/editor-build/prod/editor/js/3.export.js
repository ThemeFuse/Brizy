...
const IS_IOS = HAS_NAVIGATOR && (/iPad|iPhone|iPod/.test(navigator.userAgent) || IS_IPAD_PRO) && !undefined.MSStream;
const IS_SAFARI = HAS_NAVIGATOR && /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && !undefined.MSStream;
  ...
  load(url) {
    ...
    if (url instanceof Array) {
      ...
      try {
        ...
        this.player.src = undefined.URL.createObjectURL(url);
      }
    }
  }
  play() {
