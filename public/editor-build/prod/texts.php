...
class Brizy_Public_EditorBuild_Prod_Texts {
	public static function get_editor_texts() {
		return apply_filters('brizy_editor_config_texts', array(
			...
			"Manage the fonts that will be imported here by adding or removing them to the kit, in your Adobe account." => __("Manage the fonts that will be imported here by adding or removing them to the kit, in your Adobe account.", "brizy"),
			...
			"Type to search" => __("Type to search", "brizy"),
			"Typekit Key" => __("Typekit Key", "brizy"),
			"Typography" => __("Typography", "brizy"),
