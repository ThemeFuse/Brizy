...
class Brizy_Public_EditorBuild_Prod_Texts {
	public static function get_editor_texts() {
		return apply_filters('brizy_editor_config_texts', array(
			...
			"Failed to upload file. Please upload a valid JPG, PNG, SVG, GIF or WEBP image." => __("Failed to upload file. Please upload a valid JPG, PNG, SVG, GIF or WEBP image.", "brizy"),
			...
			"Invalid Icon name" => __("Invalid Icon name", "brizy"),
			"Invalid _thumbnailHeight" => __("Invalid _thumbnailHeight", "brizy"),
			"Invalid _thumbnailSrc" => __("Invalid _thumbnailSrc", "brizy"),
			"Invalid _thumbnailWidth" => __("Invalid _thumbnailWidth", "brizy"),
			"Invalid api data" => __("Invalid api data", "brizy"),
			"Invalid blockId" => __("Invalid blockId", "brizy"),
			...
			"Invalid type" => __("Invalid type", "brizy"),
