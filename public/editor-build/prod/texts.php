...
class Brizy_Public_EditorBuild_282Wp_Texts {
	public static function get_editor_texts() {
		return apply_filters('brizy_editor_config_texts', array(
			...
			"Error fetching fonts:" => __("Error fetching fonts:", "brizy"),
			...
			"Failed to fetch fonts" => __("Failed to fetch fonts", "brizy"),
			...
			"Invalid response format. Expected an array." => __("Invalid response format. Expected an array.", "brizy"),
