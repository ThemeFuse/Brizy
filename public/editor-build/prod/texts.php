...
class Brizy_Public_EditorBuild_Prod_Texts {
	public static function get_editor_texts() {
		return apply_filters('brizy_editor_config_texts', array(
			...
			"Fail to compile" => __("Fail to compile", "brizy"),
			"Fail to compile the page" => __("Fail to compile the page", "brizy"),
			...
			"The token are missing" => __("The token are missing", "brizy"),
