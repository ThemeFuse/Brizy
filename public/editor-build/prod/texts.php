...
class Brizy_Public_EditorBuild_Prod_Texts {
	public static function get_editor_texts() {
		return apply_filters('brizy_editor_config_texts', array(
			...
			"Exclude headings from specific containers by selector. .Can be used multiple selectors, divided by \",\"" => __("Exclude headings from specific containers by selector. .Can be used multiple selectors, divided by \",\"", "brizy"),
			...
			"Search headings inside specific containers by selector. Can be used multiple selectors, divided by \",\"" => __("Search headings inside specific containers by selector. Can be used multiple selectors, divided by \",\"", "brizy"),
