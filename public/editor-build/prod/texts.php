...
class Brizy_Public_EditorBuild_Prod_Texts {
	public static function get_editor_texts() {
		return apply_filters('brizy_editor_config_texts', array(
			" already exists in the project." => __(" already exists in the project.", "brizy"),
			"#popup-id" => __("#popup-id", "brizy"),
			"% of page height" => __("% of page height", "brizy"),
			"%s Selected" => __("%s Selected", "brizy"),
			"(Global Block)" => __("(Global Block)", "brizy"),
			...
			"1" => __("1", "brizy"),
			"12-hour" => __("12-hour", "brizy"),
			"2" => __("2", "brizy"),
			"24-hour" => __("24-hour", "brizy"),
			"3" => __("3", "brizy"),
			"3D Rotate" => __("3D Rotate", "brizy"),
			...
			"API: No Kits getKits() found." => __("API: No Kits getKits() found.", "brizy"),
			...
			"API: No Layouts getPages() found." => __("API: No Layouts getPages() found.", "brizy"),
			...
			"API: No Remove Featured Image found." => __("API: No Remove Featured Image found.", "brizy"),
			...
			"API: No Stories getPages() found." => __("API: No Stories getPages() found.", "brizy"),
			"API: No Update Featured Image Focal Point found." => __("API: No Update Featured Image Focal Point found.", "brizy"),
			"API: No Update Featured Image found." => __("API: No Update Featured Image found.", "brizy"),
			"API: No authors found." => __("API: No authors found.", "brizy"),
			"API: No checkCompatibility handler found." => __("API: No checkCompatibility handler found.", "brizy"),
			"API: No getMenus found." => __("API: No getMenus found.", "brizy"),
			"API: No globalBlocks create found." => __("API: No globalBlocks create found.", "brizy"),
			"API: No globalBlocks delete found." => __("API: No globalBlocks delete found.", "brizy"),
			"API: No globalPopups create found." => __("API: No globalPopups create found.", "brizy"),
			"API: No group list found." => __("API: No group list found.", "brizy"),
			"API: No logout handler found." => __("API: No logout handler found.", "brizy"),
			"API: No popupConditions save found." => __("API: No popupConditions save found.", "brizy"),
			"API: No posts found." => __("API: No posts found.", "brizy"),
			"API: No posts group list found." => __("API: No posts group list found.", "brizy"),
			"API: No posts taxonomies found." => __("API: No posts taxonomies found.", "brizy"),
			"API: No publish handler found." => __("API: No publish handler found.", "brizy"),
			"API: No recoveryEmail handler found." => __("API: No recoveryEmail handler found.", "brizy"),
			"API: No regenerate color found." => __("API: No regenerate color found.", "brizy"),
			"API: No regenerate typography found." => __("API: No regenerate typography found.", "brizy"),
			"API: No rules list found." => __("API: No rules list found.", "brizy"),
			...
			"API: No shortcodeContent found." => __("API: No shortcodeContent found.", "brizy"),
			"API: No sidebars found." => __("API: No sidebars found.", "brizy"),
			"API: No signIn handler found." => __("API: No signIn handler found.", "brizy"),
			"API: No signUp handler found." => __("API: No signUp handler found.", "brizy"),
			"API: No sync handler found." => __("API: No sync handler found.", "brizy"),
			"API: No terms found." => __("API: No terms found.", "brizy"),
			"APPS" => __("APPS", "brizy"),
			"AUD" => __("AUD", "brizy"),
			"About Text" => __("About Text", "brizy"),
			...
			"Add New Widget" => __("Add New Widget", "brizy"),
			"Add New item" => __("Add New item", "brizy"),
			...
			"Addable Widgets" => __("Addable Widgets", "brizy"),
			...
			"Adds an accessible label for the hamburger menu button so screen readers can announce its purpose (this text is not visible on screen)." => __("Adds an accessible label for the hamburger menu button so screen readers can announce its purpose (this text is not visible on screen).", "brizy"),
			"Adobe Fonts" => __("Adobe Fonts", "brizy"),
			...
			"Agree Terms" => __("Agree Terms", "brizy"),
			...
			"All" => __("All", "brizy"),
			"All %s selected" => __("All %s selected", "brizy"),
			...
			"Allow us to access your Brevo account via API access" => __("Allow us to access your Brevo account via API access", "brizy"),
			...
			"Allow us to access your Constant Contact account via API access" => __("Allow us to access your Constant Contact account via API access", "brizy"),
			...
			"Allow us to access your HubSpot account via Service Key" => __("Allow us to access your HubSpot account via Service Key", "brizy"),
			...
			"Allow us to connect to your Adobe" => __("Allow us to connect to your Adobe", "brizy"),
			"Allowed File Types" => __("Allowed File Types", "brizy"),
			"Alphabet" => __("Alphabet", "brizy"),
			...
			"An unexpected error occurred" => __("An unexpected error occurred", "brizy"),
			"Animals" => __("Animals", "brizy"),
			"Animals/Nature" => __("Animals/Nature", "brizy"),
			"Animate" => __("Animate", "brizy"),
			"Animated" => __("Animated", "brizy"),
			"Animated Gradient" => __("Animated Gradient", "brizy"),
			"Animated Headline" => __("Animated Headline", "brizy"),
			"Animation" => __("Animation", "brizy"),
			"Any Amount" => __("Any Amount", "brizy"),
			...
			"Are you sure you want to delete your email connection ?" => __("Are you sure you want to delete your email connection ?", "brizy"),
			"Are you sure you want to disconnect Adobe Fonts integration?" => __("Are you sure you want to disconnect Adobe Fonts integration?", "brizy"),
			"Aria Label" => __("Aria Label", "brizy"),
			"Arrangement" => __("Arrangement", "brizy"),
			"Arriving" => __("Arriving", "brizy"),
			"Arriving From" => __("Arriving From", "brizy"),
			"Arrow" => __("Arrow", "brizy"),
			"Arrow Bg." => __("Arrow Bg.", "brizy"),
			"Arrows" => __("Arrows", "brizy"),
			"Arrows Spacing" => __("Arrows Spacing", "brizy"),
			"Article" => __("Article", "brizy"),
			"Article Detail" => __("Article Detail", "brizy"),
			"Article Featured" => __("Article Featured", "brizy"),
			"Article Layout" => __("Article Layout", "brizy"),
			"Article List" => __("Article List", "brizy"),
			"Artwork" => __("Artwork", "brizy"),
			"Asc" => __("Asc", "brizy"),
			"Aside" => __("Aside", "brizy"),
			"Aspect Ratio" => __("Aspect Ratio", "brizy"),
			"Assets List" => __("Assets List", "brizy"),
			"Astronomy" => __("Astronomy", "brizy"),
			...
			"Auto" => __("Auto", "brizy"),
			"Auto Generate" => __("Auto Generate", "brizy"),
			"Auto Renewal" => __("Auto Renewal", "brizy"),
			"Auto-Draft" => __("Auto-Draft", "brizy"),
			"AutoPlay" => __("AutoPlay", "brizy"),
			"Automotive" => __("Automotive", "brizy"),
			"Autoplay" => __("Autoplay", "brizy"),
			"Available formatting styles can be found" => __("Available formatting styles can be found", "brizy"),
			"Avatar" => __("Avatar", "brizy"),
			"BLOCKS" => __("BLOCKS", "brizy"),
			"BRL" => __("BRL", "brizy"),
			"Back" => __("Back", "brizy"),
			"Back Pulse" => __("Back Pulse", "brizy"),
			...
			"Bg" => __("Bg", "brizy"),
			"Bg Icon" => __("Bg Icon", "brizy"),
			"Bg Size" => __("Bg Size", "brizy"),
			"Bg Star" => __("Bg Star", "brizy"),
			"Bg Text" => __("Bg Text", "brizy"),
			"Bg. Color" => __("Bg. Color", "brizy"),
			"Big" => __("Big", "brizy"),
			"Big Image" => __("Big Image", "brizy"),
			"Billing Cycle" => __("Billing Cycle", "brizy"),
			"Billing Cycle Duration" => __("Billing Cycle Duration", "brizy"),
			"Black" => __("Black", "brizy"),
			"Blending Mode" => __("Blending Mode", "brizy"),
			"Blinds" => __("Blinds", "brizy"),
			...
			"CZK" => __("CZK", "brizy"),
			"Calculated" => __("Calculated", "brizy"),
			"Calendar View" => __("Calendar View", "brizy"),
			"Calendly" => __("Calendly", "brizy"),
			"Camping" => __("Camping", "brizy"),
			"Cancel" => __("Cancel", "brizy"),
			"Canvas" => __("Canvas", "brizy"),
			"Captioned" => __("Captioned", "brizy"),
			"Captions" => __("Captions", "brizy"),
			"Captions (CC)" => __("Captions (CC)", "brizy"),
			...
			"Cc" => __("Cc", "brizy"),
			"Cell Phone" => __("Cell Phone", "brizy"),
			...
			"Change page status" => __("Change page status", "brizy"),
			"Charity" => __("Charity", "brizy"),
			"Chart" => __("Chart", "brizy"),
			"Chart Items" => __("Chart Items", "brizy"),
			"Charts & Diagrams" => __("Charts & Diagrams", "brizy"),
			"Check your email address" => __("Check your email address", "brizy"),
			"Checkbox" => __("Checkbox", "brizy"),
			"Checkmark" => __("Checkmark", "brizy"),
			"Checkout" => __("Checkout", "brizy"),
			"Childcare" => __("Childcare", "brizy"),
			"Childhood" => __("Childhood", "brizy"),
			"Chinese" => __("Chinese", "brizy"),
			"Circle" => __("Circle", "brizy"),
			"Classic" => __("Classic", "brizy"),
			"Clear" => __("Clear", "brizy"),
			"Clear Layout" => __("Clear Layout", "brizy"),
			"Clear formatting" => __("Clear formatting", "brizy"),
			"Click" => __("Click", "brizy"),
			"Click Outside to Close" => __("Click Outside to Close", "brizy"),
			"Click on the button to edit the items." => __("Click on the button to edit the items.", "brizy"),
			"Click to copy" => __("Click to copy", "brizy"),
			"Client" => __("Client", "brizy"),
			"Clip" => __("Clip", "brizy"),
			"Close" => __("Close", "brizy"),
			"Close Drawer Icon" => __("Close Drawer Icon", "brizy"),
			"Close Popup" => __("Close Popup", "brizy"),
			"Clothes/Accessories" => __("Clothes/Accessories", "brizy"),
			"Clothing & Fashion" => __("Clothing & Fashion", "brizy"),
			"Cloud" => __("Cloud", "brizy"),
			"Code" => __("Code", "brizy"),
			"Coding" => __("Coding", "brizy"),
			"Collaborate" => __("Collaborate", "brizy"),
			"Collapse" => __("Collapse", "brizy"),
			"Collapse All" => __("Collapse All", "brizy"),
			"Collapsible" => __("Collapsible", "brizy"),
			"Collections" => __("Collections", "brizy"),
			"Color" => __("Color", "brizy"),
			"Color Burn" => __("Color Burn", "brizy"),
			"Color Dodge" => __("Color Dodge", "brizy"),
			"Color HEX" => __("Color HEX", "brizy"),
			"Color Icon" => __("Color Icon", "brizy"),
			"Color Text" => __("Color Text", "brizy"),
			"Color of item" => __("Color of item", "brizy"),
			"Colors" => __("Colors", "brizy"),
			"Column" => __("Column", "brizy"),
			"Columns" => __("Columns", "brizy"),
			"Columns Gap" => __("Columns Gap", "brizy"),
			"Comment" => __("Comment", "brizy"),
			"Comment Count" => __("Comment Count", "brizy"),
			"Comments" => __("Comments", "brizy"),
			"Communication" => __("Communication", "brizy"),
			...
			"Configure Layout" => __("Configure Layout", "brizy"),
			"Confirm Password" => __("Confirm Password", "brizy"),
			"Connect" => __("Connect", "brizy"),
			"Connect a new account" => __("Connect a new account", "brizy"),
			"Connectivity" => __("Connectivity", "brizy"),
			"Construction" => __("Construction", "brizy"),
			"Contain" => __("Contain", "brizy"),
			"Content" => __("Content", "brizy"),
			"Content Gap" => __("Content Gap", "brizy"),
			"Content Padding" => __("Content Padding", "brizy"),
			"Content Type" => __("Content Type", "brizy"),
			"Contents" => __("Contents", "brizy"),
			"Context" => __("Context", "brizy"),
			"Context Type" => __("Context Type", "brizy"),
			"Continue" => __("Continue", "brizy"),
			"Continue with Free" => __("Continue with Free", "brizy"),
			"Contract Sidebar" => __("Contract Sidebar", "brizy"),
			...
			"Corner Tooltip" => __("Corner Tooltip", "brizy"),
			"Cost" => __("Cost", "brizy"),
			...
			"Could not save scheduled" => __("Could not save scheduled", "brizy"),
			"Could not switch to draft" => __("Could not switch to draft", "brizy"),
			"Couldn't complete the upload as the font named " => __("Couldn't complete the upload as the font named ", "brizy"),
			...
			"Create Symbol" => __("Create Symbol", "brizy"),
			"Create a Search Engine" => __("Create a Search Engine", "brizy"),
			...
			"Curly" => __("Curly", "brizy"),
			"Currency" => __("Currency", "brizy"),
			"Current Date" => __("Current Date", "brizy"),
			"Current Page" => __("Current Page", "brizy"),
			"Current Page URL" => __("Current Page URL", "brizy"),
			"Current Style" => __("Current Style", "brizy"),
			"Current Video Channel" => __("Current Video Channel", "brizy"),
			"Currently, a font from Adobe Fonts is set as default. Replace it with a non-Adobe font and try again to disconnect your account" => __("Currently, a font from Adobe Fonts is set as default. Replace it with a non-Adobe font and try again to disconnect your account", "brizy"),
			...
			"Custom Label" => __("Custom Label", "brizy"),
			"Custom Page" => __("Custom Page", "brizy"),
			"Custom Text" => __("Custom Text", "brizy"),
			"Custom Video" => __("Custom Video", "brizy"),
			"Custom code" => __("Custom code", "brizy"),
			"Customizes the spinner displayed while the content is loading" => __("Customizes the spinner displayed while the content is loading", "brizy"),
			"Cut description" => __("Cut description", "brizy"),
			"D. Height" => __("D. Height", "brizy"),
			"D. Indent" => __("D. Indent", "brizy"),
			"DD-MM-YYYY" => __("DD-MM-YYYY", "brizy"),
			"DELETE" => __("DELETE", "brizy"),
			"DKK" => __("DKK", "brizy"),
			"Daily" => __("Daily", "brizy"),
			"Dark" => __("Dark", "brizy"),
			"Darken" => __("Darken", "brizy"),
			"Darken image background" => __("Darken image background", "brizy"),
			"Data Labels Typography" => __("Data Labels Typography", "brizy"),
			"Date" => __("Date", "brizy"),
			"Date Format" => __("Date Format", "brizy"),
			"Day" => __("Day", "brizy"),
			"Days" => __("Days", "brizy"),
			"Default" => __("Default", "brizy"),
			"Default Category" => __("Default Category", "brizy"),
			"Default Country" => __("Default Country", "brizy"),
			"Default Roles" => __("Default Roles", "brizy"),
			"Default Value" => __("Default Value", "brizy"),
			...
			"Delete" => __("Delete", "brizy"),
			"Delete Anyway" => __("Delete Anyway", "brizy"),
			"Deleting this global block is permanent and cannot be undone. Proceed only if you are sure you no longer need it." => __("Deleting this global block is permanent and cannot be undone. Proceed only if you are sure you no longer need it.", "brizy"),
			"Desc" => __("Desc", "brizy"),
			...
			"Design" => __("Design", "brizy"),
			"Design/Development" => __("Design/Development", "brizy"),
			"Desktop" => __("Desktop", "brizy"),
			"Desktop view" => __("Desktop view", "brizy"),
			"Detail Button" => __("Detail Button", "brizy"),
			"Detail Link" => __("Detail Link", "brizy"),
			"Devices & Hardware" => __("Devices & Hardware", "brizy"),
			"Diagonal" => __("Diagonal", "brizy"),
			"Diamond" => __("Diamond", "brizy"),
			"Difference" => __("Difference", "brizy"),
			"Direct" => __("Direct", "brizy"),
			"Direction" => __("Direction", "brizy"),
			"Disable on" => __("Disable on", "brizy"),
			"Disables the default loading spinner that appears while the content is loading." => __("Disables the default loading spinner that appears while the content is loading.", "brizy"),
			"Disables the placeholder completely." => __("Disables the placeholder completely.", "brizy"),
			"Disaster" => __("Disaster", "brizy"),
			...
			"Displays captions from the Instagram Post. If set to false, it provides a cleaner view of the embedded content without additional text." => __("Displays captions from the Instagram Post. If set to false, it provides a cleaner view of the embedded content without additional text.", "brizy"),
			"Disqus" => __("Disqus", "brizy"),
			"Divide" => __("Divide", "brizy"),
			"Dividers" => __("Dividers", "brizy"),
			"Don't have items" => __("Don't have items", "brizy"),
			"Don't have tags" => __("Don't have tags", "brizy"),
			"Donation" => __("Donation", "brizy"),
			"Donation Amount" => __("Donation Amount", "brizy"),
			"Done" => __("Done", "brizy"),
			"Done, your library has synced" => __("Done, your library has synced", "brizy"),
			"Dots" => __("Dots", "brizy"),
			"Double" => __("Double", "brizy"),
			"Double Underline" => __("Double Underline", "brizy"),
			"Down" => __("Down", "brizy"),
			...
			"Dynamic Text No. of Lines" => __("Dynamic Text No. of Lines", "brizy"),
			"EMAIL" => __("EMAIL", "brizy"),
			"EOT File" => __("EOT File", "brizy"),
			"EUR" => __("EUR", "brizy"),
			"Ease" => __("Ease", "brizy"),
			"Ease Fast" => __("Ease Fast", "brizy"),
			"Ease In" => __("Ease In", "brizy"),
			"Ease In Fast" => __("Ease In Fast", "brizy"),
			"Ease In Out" => __("Ease In Out", "brizy"),
			"Ease In Out Fast" => __("Ease In Out Fast", "brizy"),
			"Ease In Out Slow" => __("Ease In Out Slow", "brizy"),
			"Ease In Slow" => __("Ease In Slow", "brizy"),
			"Ease Out" => __("Ease Out", "brizy"),
			"Ease Out Fast" => __("Ease Out Fast", "brizy"),
			"Ease Out Slow" => __("Ease Out Slow", "brizy"),
			"Ease Slow" => __("Ease Slow", "brizy"),
			"Edit" => __("Edit", "brizy"),
			"Edit page" => __("Edit page", "brizy"),
			"Editable Text" => __("Editable Text", "brizy"),
			"Editing" => __("Editing", "brizy"),
			...
			"Email to recover password" => __("Email to recover password", "brizy"),
			"Email to recover password cannot be empty" => __("Email to recover password cannot be empty", "brizy"),
			"Embed" => __("Embed", "brizy"),
			"Embed code is no longer running in the editor. Code that already ran may still be active — reload the page to fully stop it." => __("Embed code is no longer running in the editor. Code that already ran may still be active — reload the page to fully stop it.", "brizy"),
			"Emoji" => __("Emoji", "brizy"),
			"Emoticons" => __("Emoticons", "brizy"),
			"Empty" => __("Empty", "brizy"),
			"Empty message" => __("Empty message", "brizy"),
			"Enable Tags" => __("Enable Tags", "brizy"),
			"Enable Tooltip" => __("Enable Tooltip", "brizy"),
			"Enable custom HTML" => __("Enable custom HTML", "brizy"),
			"Enable custom HTML to add custom HTML to the field." => __("Enable custom HTML to add custom HTML to the field.", "brizy"),
			"Enable on" => __("Enable on", "brizy"),
			"Enable on Click" => __("Enable on Click", "brizy"),
			"Enable tags" => __("Enable tags", "brizy"),
			"Enable tooltip on click instead of hover" => __("Enable tooltip on click instead of hover", "brizy"),
			"Encryption" => __("Encryption", "brizy"),
			"End" => __("End", "brizy"),
			"Energy" => __("Energy", "brizy"),
			"Energy/Environment" => __("Energy/Environment", "brizy"),
			"English" => __("English", "brizy"),
			"Enter API key" => __("Enter API key", "brizy"),
			"Enter Search Keyword" => __("Enter Search Keyword", "brizy"),
			"Enter a link ending in .mp4" => __("Enter a link ending in .mp4", "brizy"),
			"Enter address" => __("Enter address", "brizy"),
			"Enter custom text" => __("Enter custom text", "brizy"),
			"Enter descriptive Aria Label..." => __("Enter descriptive Aria Label...", "brizy"),
			"Enter item Name" => __("Enter item Name", "brizy"),
			...
			"Enter the default value for the field." => __("Enter the default value for the field.", "brizy"),
			"Enter the default value for the field. If needed, use a comma-separated list. For example, 'Option 1,Option 2'" => __("Enter the default value for the field. If needed, use a comma-separated list. For example, 'Option 1,Option 2'", "brizy"),
			"Enter the labels, separated by a comma ( Label1, Label2, ... )." => __("Enter the labels, separated by a comma ( Label1, Label2, ... ).", "brizy"),
			"Enter the search engine ID to use for the Google Search engine." => __("Enter the search engine ID to use for the Google Search engine.", "brizy"),
			...
			"Enter the values, separated by a comma ( Value1, Value2, ... )." => __("Enter the values, separated by a comma ( Value1, Value2, ... ).", "brizy"),
			...
			"Expand All" => __("Expand All", "brizy"),
			"Expand Sidebar" => __("Expand Sidebar", "brizy"),
			"Explorer" => __("Explorer", "brizy"),
			...
			"Expression" => __("Expression", "brizy"),
			...
			"Extract headings from specific containers. Containers can be selected by CSS class name without the .dot, example: .container1, .container2" => __("Extract headings from specific containers. Containers can be selected by CSS class name without the .dot, example: .container1, .container2", "brizy"),
			"FIELDS" => __("FIELDS", "brizy"),
			"FMS Forms" => __("FMS Forms", "brizy"),
			...
			"Fail to authenticate" => __("Fail to authenticate", "brizy"),
			"Failed to delete icon" => __("Failed to delete icon", "brizy"),
			"Failed to get DynamicContent placeholders" => __("Failed to get DynamicContent placeholders", "brizy"),
			...
			"Failed to upload icon" => __("Failed to upload icon", "brizy"),
			"Favorites" => __("Favorites", "brizy"),
			...
			"Fetch Priority" => __("Fetch Priority", "brizy"),
			"Field" => __("Field", "brizy"),
			"Field Name" => __("Field Name", "brizy"),
			"Field Type" => __("Field Type", "brizy"),
			"Field is empty" => __("Field is empty", "brizy"),
			"Fields" => __("Fields", "brizy"),
			"Fields Required" => __("Fields Required", "brizy"),
			...
			"Fields are required" => __("Fields are required", "brizy"),
			"File" => __("File", "brizy"),
			"File size error message" => __("File size error message", "brizy"),
			"File type error message" => __("File type error message", "brizy"),
			"FileUpload" => __("FileUpload", "brizy"),
			"Files" => __("Files", "brizy"),
			"Files/Folders" => __("Files/Folders", "brizy"),
			"Fill" => __("Fill", "brizy"),
			"Filled" => __("Filled", "brizy"),
			"Film & Video" => __("Film & Video", "brizy"),
			"Filter" => __("Filter", "brizy"),
			"Filter By" => __("Filter By", "brizy"),
			"Filters" => __("Filters", "brizy"),
			"Find Page" => __("Find Page", "brizy"),
			"Find the post,click the 3 dots and select \"Embed this post\", then copy the src link" => __("Find the post,click the 3 dots and select \"Embed this post\", then copy the src link", "brizy"),
			"First Image" => __("First Image", "brizy"),
			...
			"Flip" => __("Flip", "brizy"),
			"Flip Box" => __("Flip Box", "brizy"),
			"Flip Horizontal" => __("Flip Horizontal", "brizy"),
			"Flip Vertical" => __("Flip Vertical", "brizy"),
			"Flipbox" => __("Flipbox", "brizy"),
			"Folder" => __("Folder", "brizy"),
			"Follow" => __("Follow", "brizy"),
			"Follow Button" => __("Follow Button", "brizy"),
			...
			"Food" => __("Food", "brizy"),
			"Food & Beverage" => __("Food & Beverage", "brizy"),
			"Footer" => __("Footer", "brizy"),
			"Forgot Password" => __("Forgot Password", "brizy"),
			"Form" => __("Form", "brizy"),
			"Form2FieldOption" => __("Form2FieldOption", "brizy"),
			...
			"Fruits & Vegetables" => __("Fruits & Vegetables", "brizy"),
			"Full" => __("Full", "brizy"),
			"Full Email" => __("Full Email", "brizy"),
			...
			"Gender" => __("Gender", "brizy"),
			"German" => __("German", "brizy"),
			"Get Shop Add-On" => __("Get Shop Add-On", "brizy"),
			...
			"Glyph" => __("Glyph", "brizy"),
			"Go Back" => __("Go Back", "brizy"),
			"Go to" => __("Go to", "brizy"),
			"Go to Checkout" => __("Go to Checkout", "brizy"),
			"Go to Google Programmable Search Engine, select your project and copy the Search Engine ID. Then paste it in the toolbar settings of this element." => __("Go to Google Programmable Search Engine, select your project and copy the Search Engine ID. Then paste it in the toolbar settings of this element.", "brizy"),
			"Go to Google Search Console and verify your domain ownership by adding a DNS record through your domain provider. Google CSE only works on custom domains that are indexed by Google." => __("Go to Google Search Console and verify your domain ownership by adding a DNS record through your domain provider. Google CSE only works on custom domains that are indexed by Google.", "brizy"),
			"Go to checkout" => __("Go to checkout", "brizy"),
			"Google Fonts" => __("Google Fonts", "brizy"),
			"Google Search" => __("Google Search", "brizy"),
			"Google Search Setup Required" => __("Google Search Setup Required", "brizy"),
			...
			"HUF" => __("HUF", "brizy"),
			"Halloween" => __("Halloween", "brizy"),
			"Hamburger Icon Aria Label" => __("Hamburger Icon Aria Label", "brizy"),
			"Handle" => __("Handle", "brizy"),
			"Hands" => __("Hands", "brizy"),
			"Hang" => __("Hang", "brizy"),
			"Head" => __("Head", "brizy"),
			"Header" => __("Header", "brizy"),
			"Header Padding" => __("Header Padding", "brizy"),
			"Heading" => __("Heading", "brizy"),
			"Healthcare/Medical" => __("Healthcare/Medical", "brizy"),
			...
			"Holidays" => __("Holidays", "brizy"),
			"Home/Buildings" => __("Home/Buildings", "brizy"),
			...
			"Household" => __("Household", "brizy"),
			"Hover" => __("Hover", "brizy"),
			"Hover Transition" => __("Hover Transition", "brizy"),
			"Hover Zoom" => __("Hover Zoom", "brizy"),
			"How can we help?" => __("How can we help?", "brizy"),
			"Hue" => __("Hue", "brizy"),
			"Humanitarian" => __("Humanitarian", "brizy"),
			"I have deselected \"Verify the origins of reCAPTCHA solutions and clicked \"Save Changes\" under \"Key Settings > Advanced Settings\" in my Google reCAPTCHA page" => __("I have deselected \"Verify the origins of reCAPTCHA solutions and clicked \"Save Changes\" under \"Key Settings > Advanced Settings\" in my Google reCAPTCHA page", "brizy"),
			"ID" => __("ID", "brizy"),
			"ILS" => __("ILS", "brizy"),
			"Icon" => __("Icon", "brizy"),
			"Icon & Text" => __("Icon & Text", "brizy"),
			"Icon Animation" => __("Icon Animation", "brizy"),
			"Icon Box" => __("Icon Box", "brizy"),
			"Icon Container" => __("Icon Container", "brizy"),
			...
			"If this is selected and you would like the image to be a fallback when no video is available make sure to select 'Display Image'." => __("If this is selected and you would like the image to be a fallback when no video is available make sure to select 'Display Image'.", "brizy"),
			"If this is selected and you would like the image to be a fallback when no video is available make sure to select 'Display Images'." => __("If this is selected and you would like the image to be a fallback when no video is available make sure to select 'Display Images'.", "brizy"),
			"If this is selected and you would like the image to be a fallback when no video is available make sure to select 'Image'." => __("If this is selected and you would like the image to be a fallback when no video is available make sure to select 'Image'.", "brizy"),
			...
			"Ignore headings selection from specific containers. Containers can be selected by CSS class name without the .dot, example: .container1, .container2" => __("Ignore headings selection from specific containers. Containers can be selected by CSS class name without the .dot, example: .container1, .container2", "brizy"),
			"Image" => __("Image", "brizy"),
			"Image Compare" => __("Image Compare", "brizy"),
			...
			"In order to view and select them in this screen, please add blogs to your shop." => __("In order to view and select them in this screen, please add blogs to your shop.", "brizy"),
			"In order to view and select them in this screen, please add collections to your shop." => __("In order to view and select them in this screen, please add collections to your shop.", "brizy"),
			"In order to view and select them in this screen, please add products to your shop." => __("In order to view and select them in this screen, please add products to your shop.", "brizy"),
			"In out" => __("In out", "brizy"),
			"In your Adobe account, find \"My Adobe Fonts\" on the right hand side. Click the Web Projects tab, copy the Project ID and paste it here in the field below." => __("In your Adobe account, find \"My Adobe Fonts\" on the right hand side. Click the Web Projects tab, copy the Project ID and paste it here in the field below.", "brizy"),
			"In your CSE settings, go to Look and Feel > Layout and select \"Results only\" for the component to work correctly." => __("In your CSE settings, go to Look and Feel > Layout and select \"Results only\" for the component to work correctly.", "brizy"),
			...
			"Index Your Website" => __("Index Your Website", "brizy"),
			"Infinite Animation" => __("Infinite Animation", "brizy"),
			"Infinite Loop" => __("Infinite Loop", "brizy"),
			...
			"Insert SKU" => __("Insert SKU", "brizy"),
			"Inset" => __("Inset", "brizy"),
			"Instagram" => __("Instagram", "brizy"),
			"Instagram Feed" => __("Instagram Feed", "brizy"),
			"Integrations: No addAccount handler found." => __("Integrations: No addAccount handler found.", "brizy"),
			"Integrations: No addRecaptcha handler found." => __("Integrations: No addRecaptcha handler found.", "brizy"),
			"Integrations: No createIntegrationAccount handler found." => __("Integrations: No createIntegrationAccount handler found.", "brizy"),
			"Integrations: No createIntegrationList handler found." => __("Integrations: No createIntegrationList handler found.", "brizy"),
			"Integrations: No deleteAccount handler found." => __("Integrations: No deleteAccount handler found.", "brizy"),
			"Integrations: No deleteIntegration handler found." => __("Integrations: No deleteIntegration handler found.", "brizy"),
			"Integrations: No getAccounts handler found." => __("Integrations: No getAccounts handler found.", "brizy"),
			"Integrations: No getForm handler found." => __("Integrations: No getForm handler found.", "brizy"),
			"Integrations: No getIntegration handler found." => __("Integrations: No getIntegration handler found.", "brizy"),
			"Integrations: No getIntegrationAccountApiKey handler found." => __("Integrations: No getIntegrationAccountApiKey handler found.", "brizy"),
			"Integrations: No getSmtpIntegration handler found." => __("Integrations: No getSmtpIntegration handler found.", "brizy"),
			"Integrations: No updateForm handler found." => __("Integrations: No updateForm handler found.", "brizy"),
			"Integrations: No updateIntegration handler found." => __("Integrations: No updateIntegration handler found.", "brizy"),
			"Integrations: No updateSmtpIntegration handler found." => __("Integrations: No updateSmtpIntegration handler found.", "brizy"),
			"Internal Links" => __("Internal Links", "brizy"),
			"Intro" => __("Intro", "brizy"),
			"Invalid Dynamic Option" => __("Invalid Dynamic Option", "brizy"),
			"Invalid Search Engine ID format. The ID should contain only letters, numbers, colons and hyphens (e.g. \"012345678901234567890:abcdefghij\")." => __("Invalid Search Engine ID format. The ID should contain only letters, numbers, colons and hyphens (e.g. \"012345678901234567890:abcdefghij\").", "brizy"),
			"Invalid editor config" => __("Invalid editor config", "brizy"),
			"Invalid form config thirdPartyOption" => __("Invalid form config thirdPartyOption", "brizy"),
			"Invalid message" => __("Invalid message", "brizy"),
			"Invalid uid" => __("Invalid uid", "brizy"),
			"It's a sample" => __("It's a sample", "brizy"),
			"Italian" => __("Italian", "brizy"),
			"Italic" => __("Italic", "brizy"),
			"Italic Version" => __("Italic Version", "brizy"),
			"Item" => __("Item", "brizy"),
			...
			"Left" => __("Left", "brizy"),
			"Left End" => __("Left End", "brizy"),
			"Left Start" => __("Left Start", "brizy"),
			...
			"Link will display if text is entered and a detail page selected." => __("Link will display if text is entered and a detail page selected.", "brizy"),
			"Linkedin" => __("Linkedin", "brizy"),
			"Linkedin Feed" => __("Linkedin Feed", "brizy"),
			...
			"Load" => __("Load", "brizy"),
			"Load this image only when it's about to enter the viewport" => __("Load this image only when it's about to enter the viewport", "brizy"),
			"Load this image with priority" => __("Load this image with priority", "brizy"),
			"Loaders" => __("Loaders", "brizy"),
			"Loading..." => __("Loading...", "brizy"),
			"Location" => __("Location", "brizy"),
			"Locked" => __("Locked", "brizy"),
			"Logged" => __("Logged", "brizy"),
			"Login" => __("Login", "brizy"),
			"Logistics" => __("Logistics", "brizy"),
			...
			"Lowercase" => __("Lowercase", "brizy"),
			"Luminosity" => __("Luminosity", "brizy"),
			"MM/DD/YYYY" => __("MM/DD/YYYY", "brizy"),
			"MXN" => __("MXN", "brizy"),
			"MYR" => __("MYR", "brizy"),
			"Main" => __("Main", "brizy"),
			...
			"Map" => __("Map", "brizy"),
			"Maps" => __("Maps", "brizy"),
			"Maps/Location" => __("Maps/Location", "brizy"),
			"Margin" => __("Margin", "brizy"),
			"Maritime" => __("Maritime", "brizy"),
			"Marker" => __("Marker", "brizy"),
			"Marker Size" => __("Marker Size", "brizy"),
			"Marker Type" => __("Marker Type", "brizy"),
			...
			"Mathematics" => __("Mathematics", "brizy"),
			"Max" => __("Max", "brizy"),
			"Max Date" => __("Max Date", "brizy"),
			"Max Height" => __("Max Height", "brizy"),
			"Max Time" => __("Max Time", "brizy"),
			"Max error message" => __("Max error message", "brizy"),
			"Max. File Size" => __("Max. File Size", "brizy"),
			"Media" => __("Media", "brizy"),
			"Media & Playback" => __("Media & Playback", "brizy"),
			"Media Corner" => __("Media Corner", "brizy"),
			"Media Links" => __("Media Links", "brizy"),
			"Medical & Health" => __("Medical & Health", "brizy"),
			...
			"Meta Icons" => __("Meta Icons", "brizy"),
			"Meta Key" => __("Meta Key", "brizy"),
			"Meta Value" => __("Meta Value", "brizy"),
			"Metafield" => __("Metafield", "brizy"),
			"Middle Left" => __("Middle Left", "brizy"),
			"Middle Right" => __("Middle Right", "brizy"),
			"Min" => __("Min", "brizy"),
			"Min Date" => __("Min Date", "brizy"),
			"Min Time" => __("Min Time", "brizy"),
			"Min error message" => __("Min error message", "brizy"),
			"Minimal" => __("Minimal", "brizy"),
			"Minimized" => __("Minimized", "brizy"),
			"Ministry Content - Article Detail - module fields have been updated." => __("Ministry Content - Article Detail - module fields have been updated.", "brizy"),
			"Ministry Content - Article Featured - module fields have been updated." => __("Ministry Content - Article Featured - module fields have been updated.", "brizy"),
			"Ministry Content - Article Layout - module fields have been updated." => __("Ministry Content - Article Layout - module fields have been updated.", "brizy"),
			"Ministry Content - Article List - module fields have been updated." => __("Ministry Content - Article List - module fields have been updated.", "brizy"),
			...
			"Ministry Content - Staff Detail - module fields have been updated." => __("Ministry Content - Staff Detail - module fields have been updated.", "brizy"),
			"Ministry Content - Staff Featured - module fields have been updated." => __("Ministry Content - Staff Featured - module fields have been updated.", "brizy"),
			"Ministry Content - Staff List - module fields have been updated." => __("Ministry Content - Staff List - module fields have been updated.", "brizy"),
			...
			"Missing Page Component" => __("Missing Page Component", "brizy"),
			"Missing Page Components" => __("Missing Page Components", "brizy"),
			"Missing PagePopup Component" => __("Missing PagePopup Component", "brizy"),
			"Missing PagePopup Components" => __("Missing PagePopup Components", "brizy"),
			"Missing PageStory Component" => __("Missing PageStory Component", "brizy"),
			"Missing PageStory Components" => __("Missing PageStory Components", "brizy"),
			"Missing addMediaGallery key in config.api" => __("Missing addMediaGallery key in config.api", "brizy"),
			"Missing adobe fonts in api config" => __("Missing adobe fonts in api config", "brizy"),
			"Missing api collection types info handler in config" => __("Missing api collection types info handler in config", "brizy"),
			"Missing api collectionItems handler in config" => __("Missing api collectionItems handler in config", "brizy"),
			"Missing api collectionTypes.loadCollectionTypes.handler in config" => __("Missing api collectionTypes.loadCollectionTypes.handler in config", "brizy"),
			"Missing api conditional items handler in config" => __("Missing api conditional items handler in config", "brizy"),
			"Missing api conditional types handler in config" => __("Missing api conditional types handler in config", "brizy"),
			"Missing api getCollectionItemById handler in config" => __("Missing api getCollectionItemById handler in config", "brizy"),
			"Missing app data" => __("Missing app data", "brizy"),
			"Missing app id" => __("Missing app id", "brizy"),
			"Missing app inside context" => __("Missing app inside context", "brizy"),
			"Missing create screenshots in api config" => __("Missing create screenshots in api config", "brizy"),
			"Missing deleteFonts handler inside api config" => __("Missing deleteFonts handler inside api config", "brizy"),
			"Missing dynamicContent inside config api" => __("Missing dynamicContent inside config api", "brizy"),
			"Missing getCollectionSourceItems in config" => __("Missing getCollectionSourceItems in config", "brizy"),
			"Missing getDynamicContent inside api Config" => __("Missing getDynamicContent inside api Config", "brizy"),
			"Missing getEcwidProducts api handler in config" => __("Missing getEcwidProducts api handler in config", "brizy"),
			"Missing getPageRelations api handler in config" => __("Missing getPageRelations api handler in config", "brizy"),
			"Missing getUploadedFonts inside api config" => __("Missing getUploadedFonts inside api config", "brizy"),
			"Missing google fonts json" => __("Missing google fonts json", "brizy"),
			"Missing menuSimple dynamicContent inside api Config" => __("Missing menuSimple dynamicContent inside api Config", "brizy"),
			"Missing page data in config" => __("Missing page data in config", "brizy"),
			"Missing placeholder props" => __("Missing placeholder props", "brizy"),
			"Missing project data in config" => __("Missing project data in config", "brizy"),
			"Missing regenerate methods in config.api" => __("Missing regenerate methods in config.api", "brizy"),
			"Missing searchEcwidCategories api handler in config" => __("Missing searchEcwidCategories api handler in config", "brizy"),
			"Missing searchEcwidProducts api handler in config" => __("Missing searchEcwidProducts api handler in config", "brizy"),
			"Missing sendHandler inside config api" => __("Missing sendHandler inside config api", "brizy"),
			"Missing shopifyBlogItems handler" => __("Missing shopifyBlogItems handler", "brizy"),
			"Missing shopifySyncArticle handler" => __("Missing shopifySyncArticle handler", "brizy"),
			"Missing shopifySyncPage handler" => __("Missing shopifySyncPage handler", "brizy"),
			"Missing shopifySyncRules handler" => __("Missing shopifySyncRules handler", "brizy"),
			"Missing shopifyUnpublishPage handler" => __("Missing shopifyUnpublishPage handler", "brizy"),
			"Missing takeOver handler inside config api" => __("Missing takeOver handler inside config api", "brizy"),
			"Missing update screenshots in api config" => __("Missing update screenshots in api config", "brizy"),
			"Missing uploadFonts handler inside api config" => __("Missing uploadFonts handler inside api config", "brizy"),
			"Mobile" => __("Mobile", "brizy"),
			"Mobile view" => __("Mobile view", "brizy"),
			"Modified" => __("Modified", "brizy"),
			"Money" => __("Money", "brizy"),
			"Monthly" => __("Monthly", "brizy"),
			...
			"Moving" => __("Moving", "brizy"),
			"Multi Step" => __("Multi Step", "brizy"),
			"Multi-Language" => __("Multi-Language", "brizy"),
			"Multimedia" => __("Multimedia", "brizy"),
			"Multiple Selection" => __("Multiple Selection", "brizy"),
			"Multiply" => __("Multiply", "brizy"),
			"Music & Audio" => __("Music & Audio", "brizy"),
			...
			"Nature" => __("Nature", "brizy"),
			"Nav" => __("Nav", "brizy"),
			"Navigation" => __("Navigation", "brizy"),
			"Navigation Padding" => __("Navigation Padding", "brizy"),
			"Need help" => __("Need help", "brizy"),
			"Network" => __("Network", "brizy"),
			"New Style #%s" => __("New Style #%s", "brizy"),
			"Next post" => __("Next post", "brizy"),
			...
			"No headings were found." => __("No headings were found.", "brizy"),
			...
			"Number of Lines" => __("Number of Lines", "brizy"),
			...
			"Numbers" => __("Numbers", "brizy"),
			"OK" => __("OK", "brizy"),
			"Odd Bg" => __("Odd Bg", "brizy"),
			"Off" => __("Off", "brizy"),
			"Official" => __("Official", "brizy"),
			"Offset" => __("Offset", "brizy"),
			"OffsetX" => __("OffsetX", "brizy"),
			"OffsetY" => __("OffsetY", "brizy"),
			...
			"One side" => __("One side", "brizy"),
			"Only select if \"Display Video\" is not selected." => __("Only select if \"Display Video\" is not selected.", "brizy"),
			"Only select if 'Display Video' is not selected." => __("Only select if 'Display Video' is not selected.", "brizy"),
			"Only select if Video' is not selected." => __("Only select if Video' is not selected.", "brizy"),
			"Open CSE Console" => __("Open CSE Console", "brizy"),
			"Open In New Tab" => __("Open In New Tab", "brizy"),
			"Open Media Library" => __("Open Media Library", "brizy"),
			"Open Paypal in new Tab" => __("Open Paypal in new Tab", "brizy"),
			"Open Search Console" => __("Open Search Console", "brizy"),
			"Open in Lightbox" => __("Open in Lightbox", "brizy"),
			"Operating System" => __("Operating System", "brizy"),
			"Opposite" => __("Opposite", "brizy"),
			"Option" => __("Option", "brizy"),
			...
			"Parameters" => __("Parameters", "brizy"),
			...
			"Paste your Pinterest profile, board or pin URL depending on the add-on type." => __("Paste your Pinterest profile, board or pin URL depending on the add-on type.", "brizy"),
			"Paste your text here" => __("Paste your text here", "brizy"),
			"Pause" => __("Pause", "brizy"),
			"Payment" => __("Payment", "brizy"),
			"Paypal" => __("Paypal", "brizy"),
			...
			"Perspective" => __("Perspective", "brizy"),
			"Phone" => __("Phone", "brizy"),
			"Phone Cell" => __("Phone Cell", "brizy"),
			"Phone Number" => __("Phone Number", "brizy"),
			"Phone Work" => __("Phone Work", "brizy"),
			"Photos & Images" => __("Photos & Images", "brizy"),
			"Pie" => __("Pie", "brizy"),
			"Pin Elements" => __("Pin Elements", "brizy"),
			"Pin Widget" => __("Pin Widget", "brizy"),
			"Pinned" => __("Pinned", "brizy"),
			"Pinterest" => __("Pinterest", "brizy"),
			"Pinterest URL (profile, board or pin)" => __("Pinterest URL (profile, board or pin)", "brizy"),
			"Placeholder" => __("Placeholder", "brizy"),
			"Placeholder spinner" => __("Placeholder spinner", "brizy"),
			"Placement" => __("Placement", "brizy"),
			...
			"Please add your PayPal email address" => __("Please add your PayPal email address", "brizy"),
			"Please fill in the required fields" => __("Please fill in the required fields", "brizy"),
			"Please note: with this option enabled, embed code runs directly inside the editor, not just on the published page. Running third-party code in the editor environment carries an extra security risk, so it's off by default — the editor shows a placeholder and the code runs on the published page. We recommend enabling it only if you trust the code being added to your pages." => __("Please note: with this option enabled, embed code runs directly inside the editor, not just on the published page. Running third-party code in the editor environment carries an extra security risk, so it's off by default — the editor shows a placeholder and the code runs on the published page. We recommend enabling it only if you trust the code being added to your pages.", "brizy"),
			"Please provide a valid PayPal account!" => __("Please provide a valid PayPal account!", "brizy"),
			"Pocket" => __("Pocket", "brizy"),
			"Polish" => __("Polish", "brizy"),
			"Political" => __("Political", "brizy"),
			"Pop" => __("Pop", "brizy"),
			"Popularity" => __("Popularity", "brizy"),
			"Popup" => __("Popup", "brizy"),
			"Popup Close Icon" => __("Popup Close Icon", "brizy"),
			"Popup Thumbnail" => __("Popup Thumbnail", "brizy"),
			"Popups" => __("Popups", "brizy"),
			"Port" => __("Port", "brizy"),
			"Portuguese" => __("Portuguese", "brizy"),
			...
			"Prayer Widget" => __("Prayer Widget", "brizy"),
			"Pre-filled cart" => __("Pre-filled cart", "brizy"),
			"PreProduct" => __("PreProduct", "brizy"),
			"Preacher" => __("Preacher", "brizy"),
			"Prefix" => __("Prefix", "brizy"),
			"Prefix & Suffix" => __("Prefix & Suffix", "brizy"),
			"Preserve size" => __("Preserve size", "brizy"),
			...
			"Prevents the automatic loading of the script that is required for embedding content." => __("Prevents the automatic loading of the script that is required for embedding content.", "brizy"),
			...
			"Previous post" => __("Previous post", "brizy"),
			...
			"Profile" => __("Profile", "brizy"),
			"Profile Widget" => __("Profile Widget", "brizy"),
			...
			"Punctuation & Symbols" => __("Punctuation & Symbols", "brizy"),
			"Push" => __("Push", "brizy"),
			"Quantity" => __("Quantity", "brizy"),
			"Query" => __("Query", "brizy"),
			"Query Source" => __("Query Source", "brizy"),
			"RSS Feed" => __("RSS Feed", "brizy"),
			"RUB" => __("RUB", "brizy"),
			"Radial" => __("Radial", "brizy"),
			"Radial In" => __("Radial In", "brizy"),
			"Radial Out" => __("Radial Out", "brizy"),
			...
			"Read More" => __("Read More", "brizy"),
			"Recent Articles" => __("Recent Articles", "brizy"),
			"Recent Events" => __("Recent Events", "brizy"),
			"Recent Groups" => __("Recent Groups", "brizy"),
			"Recent Sermons" => __("Recent Sermons", "brizy"),
			"Recent Staff" => __("Recent Staff", "brizy"),
			"Recommend" => __("Recommend", "brizy"),
			"Rectangle In" => __("Rectangle In", "brizy"),
			"Rectangle Out" => __("Rectangle Out", "brizy"),
			"Reddit" => __("Reddit", "brizy"),
			...
			"Redirect after successful payment!" => __("Redirect after successful payment!", "brizy"),
			"Redo" => __("Redo", "brizy"),
			"Redo (ctrl+shift+Z)" => __("Redo (ctrl+shift+Z)", "brizy"),
			"Refresh" => __("Refresh", "brizy"),
			"Regenerate" => __("Regenerate", "brizy"),
			...
			"Right End" => __("Right End", "brizy"),
			"Right Start" => __("Right Start", "brizy"),
			"Roles" => __("Roles", "brizy"),
			"Roll In" => __("Roll In", "brizy"),
			"Romanian" => __("Romanian", "brizy"),
			"Room" => __("Room", "brizy"),
			"Rotate" => __("Rotate", "brizy"),
			"RotateX" => __("RotateX", "brizy"),
			"RotateY" => __("RotateY", "brizy"),
			"Rotation" => __("Rotation", "brizy"),
			"Round" => __("Round", "brizy"),
			"Row" => __("Row", "brizy"),
			"Rows" => __("Rows", "brizy"),
			"Rows Gap" => __("Rows Gap", "brizy"),
			"Rubber Band" => __("Rubber Band", "brizy"),
			"Russian" => __("Russian", "brizy"),
			"S. Bottom" => __("S. Bottom", "brizy"),
			"S. Top" => __("S. Top", "brizy"),
			"SEK" => __("SEK", "brizy"),
			...
			"Save Scheduled" => __("Save Scheduled", "brizy"),
			...
			"ScaleX" => __("ScaleX", "brizy"),
			"ScaleY" => __("ScaleY", "brizy"),
			"School/Education" => __("School/Education", "brizy"),
			"Science" => __("Science", "brizy"),
			"Science Fiction" => __("Science Fiction", "brizy"),
			"Screen" => __("Screen", "brizy"),
			"Script load" => __("Script load", "brizy"),
			"Scroll" => __("Scroll", "brizy"),
			"Scroll Page Behind" => __("Scroll Page Behind", "brizy"),
			"Search" => __("Search", "brizy"),
			"Search Engine ID" => __("Search Engine ID", "brizy"),
			"Search Filter" => __("Search Filter", "brizy"),
			"Search Text..." => __("Search Text...", "brizy"),
			"Search element" => __("Search element", "brizy"),
			"Search fonts" => __("Search fonts", "brizy"),
			"Second Image" => __("Second Image", "brizy"),
			"Seconds" => __("Seconds", "brizy"),
			"Section" => __("Section", "brizy"),
			"Security" => __("Security", "brizy"),
			...
			"Select a recent article as an example to style/setup. Since this is the article detail landing page this article will be replaced with the linked article." => __("Select a recent article as an example to style/setup. Since this is the article detail landing page this article will be replaced with the linked article.", "brizy"),
			"Select a recent article. Use only if you are not using \"Article Slug\" below and \"Latest\" is set to \"Off\"." => __("Select a recent article. Use only if you are not using \"Article Slug\" below and \"Latest\" is set to \"Off\".", "brizy"),
			...
			"Select a recent staff member as an example to style/setup.  Since this is the staff detail landing page this member will be replaced with the linked staff." => __("Select a recent staff member as an example to style/setup.  Since this is the staff detail landing page this member will be replaced with the linked staff.", "brizy"),
			...
			"Select the content type you want to search for." => __("Select the content type you want to search for.", "brizy"),
			"Select the language used by the date picker." => __("Select the language used by the date picker.", "brizy"),
			"Selected" => __("Selected", "brizy"),
			"Selection" => __("Selection", "brizy"),
			"Selector of container" => __("Selector of container", "brizy"),
			"Semi Bold" => __("Semi Bold", "brizy"),
			"Send a support ticket" => __("Send a support ticket", "brizy"),
			...
			"Set the maximum height for the column. If the content exceeds this height, it will become scrollable." => __("Set the maximum height for the column. If the content exceeds this height, it will become scrollable.", "brizy"),
			"Set the number of lines to show in the excerpt. If set to 0, it will show the full content." => __("Set the number of lines to show in the excerpt. If set to 0, it will show the full content.", "brizy"),
			...
			"Shapes" => __("Shapes", "brizy"),
			"Share" => __("Share", "brizy"),
			"Share Button" => __("Share Button", "brizy"),
			"Share Button Item" => __("Share Button Item", "brizy"),
			"Share Buttons" => __("Share Buttons", "brizy"),
			"Shipping" => __("Shipping", "brizy"),
			"Shipping Price" => __("Shipping Price", "brizy"),
			...
			"Show Messages" => __("Show Messages", "brizy"),
			...
			"Show full email address instead of a mail icon" => __("Show full email address instead of a mail icon", "brizy"),
			"Show icons when Meta Headings are enabled" => __("Show icons when Meta Headings are enabled", "brizy"),
			...
			"Shows, in preview only, the content that renders outside the element box." => __("Shows, in preview only, the content that renders outside the element box.", "brizy"),
			"Shrink" => __("Shrink", "brizy"),
			"Shutter In Horizontal" => __("Shutter In Horizontal", "brizy"),
			"Shutter In Vertical" => __("Shutter In Vertical", "brizy"),
			"Shutter Out Horizontal" => __("Shutter Out Horizontal", "brizy"),
			"Shutter Out Vertical" => __("Shutter Out Vertical", "brizy"),
			"Sidebar" => __("Sidebar", "brizy"),
			"Sidebar align" => __("Sidebar align", "brizy"),
			...
			"SkewX" => __("SkewX", "brizy"),
			"SkewY" => __("SkewY", "brizy"),
			"Skin" => __("Skin", "brizy"),
			...
			"Skip" => __("Skip", "brizy"),
			"Skype" => __("Skype", "brizy"),
			"Slide" => __("Slide", "brizy"),
			"Slide Down" => __("Slide Down", "brizy"),
			"Slide Left" => __("Slide Left", "brizy"),
			"Slide Right" => __("Slide Right", "brizy"),
			"Slide Up" => __("Slide Up", "brizy"),
			"Slider" => __("Slider", "brizy"),
			"Slider Type" => __("Slider Type", "brizy"),
			"Slides" => __("Slides", "brizy"),
			"Sling" => __("Sling", "brizy"),
			"Slug" => __("Slug", "brizy"),
			"Slug of article (my-article-name). Use only if you are not selecting from the \"Recent Articles\" above and \"Latest\" is set to \"Off\"." => __("Slug of article (my-article-name). Use only if you are not selecting from the \"Recent Articles\" above and \"Latest\" is set to \"Off\".", "brizy"),
			...
			"Slug..." => __("Slug...", "brizy"),
			"Social" => __("Social", "brizy"),
			"Social Media" => __("Social Media", "brizy"),
			"Social Networks" => __("Social Networks", "brizy"),
			"Softness" => __("Softness", "brizy"),
			...
			"Something went wrong column resize" => __("Something went wrong column resize", "brizy"),
			"Something went wrong missing app id" => __("Something went wrong missing app id", "brizy"),
			...
			"Something went wrong on getting data" => __("Something went wrong on getting data", "brizy"),
			...
			"Something went wrong on getting pages" => __("Something went wrong on getting pages", "brizy"),
			...
			"Something went wrong when creating an account" => __("Something went wrong when creating an account", "brizy"),
			"Something went wrong!" => __("Something went wrong!", "brizy"),
			...
			"Spin" => __("Spin", "brizy"),
			"Spinners" => __("Spinners", "brizy"),
			"Sport" => __("Sport", "brizy"),
			"Sports & Fitness" => __("Sports & Fitness", "brizy"),
			"Square" => __("Square", "brizy"),
			"Squash" => __("Squash", "brizy"),
			"Staff Detail" => __("Staff Detail", "brizy"),
			"Staff Featured" => __("Staff Featured", "brizy"),
			"Staff Layout" => __("Staff Layout", "brizy"),
			"Staff List" => __("Staff List", "brizy"),
			...
			"Stop animation" => __("Stop animation", "brizy"),
			"Stories" => __("Stories", "brizy"),
			"Story" => __("Story", "brizy"),
			"Strike" => __("Strike", "brizy"),
			"Strike Through" => __("Strike Through", "brizy"),
			...
			"Subscribe to Event" => __("Subscribe to Event", "brizy"),
			...
			"Subscript" => __("Subscript", "brizy"),
			"Subscription" => __("Subscription", "brizy"),
			...
			"Superscript" => __("Superscript", "brizy"),
			"Surcharge" => __("Surcharge", "brizy"),
			"Swedish" => __("Swedish", "brizy"),
			"Sweep To Bottom" => __("Sweep To Bottom", "brizy"),
			"Sweep To Left" => __("Sweep To Left", "brizy"),
			"Sweep To Right" => __("Sweep To Right", "brizy"),
			"Sweep To Top" => __("Sweep To Top", "brizy"),
			"Swing" => __("Swing", "brizy"),
			"Swirl" => __("Swirl", "brizy"),
			...
			"Table of Contents" => __("Table of Contents", "brizy"),
			...
			"Tax" => __("Tax", "brizy"),
			"Tax Percentage" => __("Tax Percentage", "brizy"),
			"Technology" => __("Technology", "brizy"),
			"Tel (Deprecated)" => __("Tel (Deprecated)", "brizy"),
			"Telegram" => __("Telegram", "brizy"),
			"Tell AI what to write in any language ..." => __("Tell AI what to write in any language ...", "brizy"),
			"Text" => __("Text", "brizy"),
			"Text & Formatting" => __("Text & Formatting", "brizy"),
			"Text After" => __("Text After", "brizy"),
			"Text Before" => __("Text Before", "brizy"),
			"Text Bg. Color" => __("Text Bg. Color", "brizy"),
			"Text Editing" => __("Text Editing", "brizy"),
			"Text Field" => __("Text Field", "brizy"),
			"Text Highlighted" => __("Text Highlighted", "brizy"),
			"Text Shadow" => __("Text Shadow", "brizy"),
			"Thai" => __("Thai", "brizy"),
			"The Facebook Comments API has been deprecated. For more details, see the" => __("The Facebook Comments API has been deprecated. For more details, see the", "brizy"),
			"The Facebook Groups API has been deprecated. For more details, see the" => __("The Facebook Groups API has been deprecated. For more details, see the", "brizy"),
			"The Facebook Like Button API has been deprecated. For more details, see the" => __("The Facebook Like Button API has been deprecated. For more details, see the", "brizy"),
			"The Twitter embed has been deprecated. Please use the Twitter Follow Button instead." => __("The Twitter embed has been deprecated. Please use the Twitter Follow Button instead.", "brizy"),
			"The Web Open Font Format (EOT) is a format used in web pages by modern browsers." => __("The Web Open Font Format (EOT) is a format used in web pages by modern browsers.", "brizy"),
			"The Web Open Font Format (TTF) is a format used in web pages by modern browsers." => __("The Web Open Font Format (TTF) is a format used in web pages by modern browsers.", "brizy"),
			"The Web Open Font Format (WOFF) is a format used in web pages by modern browsers." => __("The Web Open Font Format (WOFF) is a format used in web pages by modern browsers.", "brizy"),
			"The Web Open Font Format (WOFF2) is a format used in web pages by modern browsers." => __("The Web Open Font Format (WOFF2) is a format used in web pages by modern browsers.", "brizy"),
			...
			"The embed code is not running in the editor. It works normally in preview." => __("The embed code is not running in the editor. It works normally in preview.", "brizy"),
			...
			"The font can only be deleted if you disconnect from Adobe Fonts. This will remove all fonts added with this integration." => __("The font can only be deleted if you disconnect from Adobe Fonts. This will remove all fonts added with this integration.", "brizy"),
			...
			"The text displayed as a link to view the content." => __("The text displayed as a link to view the content.", "brizy"),
			"The time format to display in the event calendar." => __("The time format to display in the event calendar.", "brizy"),
			"Theme Header & Footer" => __("Theme Header & Footer", "brizy"),
			"There are no choices" => __("There are no choices", "brizy"),
			"Thin" => __("Thin", "brizy"),
			"This changes what visitors see on the live website: publishing makes the page public, switching it to draft removes it from the live site." => __("This changes what visitors see on the live website: publishing makes the page public, switching it to draft removes it from the live site.", "brizy"),
			...
			"This is a sample caption of the audio content" => __("This is a sample caption of the audio content", "brizy"),
			"This option automatically shows the latest article and overrides the 'Recent Articles' and 'Article Slug' options." => __("This option automatically shows the latest article and overrides the 'Recent Articles' and 'Article Slug' options.", "brizy"),
			...
			"This option does not affect your cart in preview. This option is only required to allow you to customize the cart element in different states." => __("This option does not affect your cart in preview. This option is only required to allow you to customize the cart element in different states.", "brizy"),
			"This option only applies to 'Latest' and if this is selected the 'Featured' option does not apply." => __("This option only applies to 'Latest' and if this is selected the 'Featured' option does not apply.", "brizy"),
			"This option only applies to 'Latest' and if this is selected the 'No featured' option does not apply." => __("This option only applies to 'Latest' and if this is selected the 'No featured' option does not apply.", "brizy"),
			"This option only applies to 'Latest'." => __("This option only applies to 'Latest'.", "brizy"),
			...
			"This option only works in editor mode for styling purposes." => __("This option only works in editor mode for styling purposes.", "brizy"),
			"This page is currently a Draft. To enable it on your website, choose Publish after clicking the Up Arrow button." => __("This page is currently a Draft. To enable it on your website, choose Publish after clicking the Up Arrow button.", "brizy"),
			"This page is currently set to Scheduled. If you want to publish it now, please change the status from the page settings." => __("This page is currently set to Scheduled. If you want to publish it now, please change the status from the page settings.", "brizy"),
			...
			"This should be a comma separate list of category slugs without spaces eg. if you wanted to use the categories 'Category Example 1' and 'Category Example 2' the list would be 'category-example-1,category-example-2'. This option removes the parent filter options." => __("This should be a comma separate list of category slugs without spaces eg. if you wanted to use the categories 'Category Example 1' and 'Category Example 2' the list would be 'category-example-1,category-example-2'. This option removes the parent filter options.", "brizy"),
			"This type was removed, please remove this item!" => __("This type was removed, please remove this item!", "brizy"),
			"Thumbnail" => __("Thumbnail", "brizy"),
			"Thumbs" => __("Thumbs", "brizy"),
			"Tilt" => __("Tilt", "brizy"),
			"Time" => __("Time", "brizy"),
			"Time Format" => __("Time Format", "brizy"),
			...
			"Tip: You can browse the Adobe font library here" => __("Tip: You can browse the Adobe font library here", "brizy"),
			...
			"To be able to display and customize these steps, you need to configure shipping, address and payment in CMS or Ecwid store" => __("To be able to display and customize these steps, you need to configure shipping, address and payment in CMS or Ecwid store", "brizy"),
			"To element" => __("To element", "brizy"),
			"Toggle" => __("Toggle", "brizy"),
			"Toggle Menu" => __("Toggle Menu", "brizy"),
			"Tone" => __("Tone", "brizy"),
			"Tooltip" => __("Tooltip", "brizy"),
			"Tooltip Bg." => __("Tooltip Bg.", "brizy"),
			"Top" => __("Top", "brizy"),
			"Top Center" => __("Top Center", "brizy"),
			"Top End" => __("Top End", "brizy"),
			"Top Left" => __("Top Left", "brizy"),
			"Top Right" => __("Top Right", "brizy"),
			"Top Start" => __("Top Start", "brizy"),
			"Total" => __("Total", "brizy"),
			"Touch Gestures" => __("Touch Gestures", "brizy"),
			"Tracking by Omega" => __("Tracking by Omega", "brizy"),
			"Transform" => __("Transform", "brizy"),
			"Transition" => __("Transition", "brizy"),
			"Transition Type" => __("Transition Type", "brizy"),
			"Translation" => __("Translation", "brizy"),
			"Transparency" => __("Transparency", "brizy"),
			"Transportation" => __("Transportation", "brizy"),
			"Trash" => __("Trash", "brizy"),
			"Travel" => __("Travel", "brizy"),
			"Travel & Hotel" => __("Travel & Hotel", "brizy"),
			"Trigger" => __("Trigger", "brizy"),
			"Trigger On" => __("Trigger On", "brizy"),
			...
			"Tumblr" => __("Tumblr", "brizy"),
			"Turkish" => __("Turkish", "brizy"),
			"Turn" => __("Turn", "brizy"),
			"Tweet" => __("Tweet", "brizy"),
			"Twirl" => __("Twirl", "brizy"),
			"Twitter" => __("Twitter", "brizy"),
			"Twitter(X)" => __("Twitter(X)", "brizy"),
			"Type" => __("Type", "brizy"),
			"Type name" => __("Type name", "brizy"),
			"Type to Search ..." => __("Type to Search ...", "brizy"),
			"Type to search" => __("Type to search", "brizy"),
			"Types" => __("Types", "brizy"),
			"Typing" => __("Typing", "brizy"),
			"Typography" => __("Typography", "brizy"),
			"UPLOAD" => __("UPLOAD", "brizy"),
			"UPLOAD FONT" => __("UPLOAD FONT", "brizy"),
			"URL" => __("URL", "brizy"),
			"URL of article detail page. If used a link to the heading and an image will be added to take the user to the article detail page. Requires the \"Article Detail\" widget to be placed on a page and that page url/slug placed in this field ." => __("URL of article detail page. If used a link to the heading and an image will be added to take the user to the article detail page. Requires the \"Article Detail\" widget to be placed on a page and that page url/slug placed in this field .", "brizy"),
			"URL of article detail page. If used will add a link to the heading to take the user to the article detail page.  Requires the \"Article Detail\" widget to be placed on a page and that page url/slug placed in this field ." => __("URL of article detail page. If used will add a link to the heading to take the user to the article detail page.  Requires the \"Article Detail\" widget to be placed on a page and that page url/slug placed in this field .", "brizy"),
			"URL of article detail page. If used will add a link to the heading to take the user to the article detail page. Requires the \"Article Detail\" widget to be placed on a page and that page url/slug placed in this field." => __("URL of article detail page. If used will add a link to the heading to take the user to the article detail page. Requires the \"Article Detail\" widget to be placed on a page and that page url/slug placed in this field.", "brizy"),
			...
			"URL of sermon detail page. If used will add a link to the heading to take the user to the sermon detail page. Requires the 'Sermon Detail' widget to be placed on a page and that page url/slug placed in this field ." => __("URL of sermon detail page. If used will add a link to the heading to take the user to the sermon detail page. Requires the 'Sermon Detail' widget to be placed on a page and that page url/slug placed in this field .", "brizy"),
			"URL of staff detail page. If used will add a link to the heading to take the user to the staff detail page. Requires the \"Staff Detail\" widget to be placed on a page and that page url/slug placed in this field." => __("URL of staff detail page. If used will add a link to the heading to take the user to the staff detail page. Requires the \"Staff Detail\" widget to be placed on a page and that page url/slug placed in this field.", "brizy"),
			"URL of staff detail page. If used will add a link to the heading to take the user to the staff detail page. Requires the 'Staff Detail' widget to be placed on a page and that page url/slug placed in this field ." => __("URL of staff detail page. If used will add a link to the heading to take the user to the staff detail page. Requires the 'Staff Detail' widget to be placed on a page and that page url/slug placed in this field .", "brizy"),
			"URL of staff list page. If used will add a link to the heading to take the user to the staff list page. Requires the 'Staff List' widget to be placed on a page and that page url/slug placed in this field ." => __("URL of staff list page. If used will add a link to the heading to take the user to the staff list page. Requires the 'Staff List' widget to be placed on a page and that page url/slug placed in this field .", "brizy"),
			"USD" => __("USD", "brizy"),
			"USE CUSTOM TEMPLATE" => __("USE CUSTOM TEMPLATE", "brizy"),
			"Ukrainian" => __("Ukrainian", "brizy"),
			...
			"Underline Zigzag" => __("Underline Zigzag", "brizy"),
			"Undo" => __("Undo", "brizy"),
			"Undo (ctrl+Z)" => __("Undo (ctrl+Z)", "brizy"),
			"Unique Id" => __("Unique Id", "brizy"),
			"Unknow COMPILER_TYPE" => __("Unknow COMPILER_TYPE", "brizy"),
			...
			"Upload Icon" => __("Upload Icon", "brizy"),
			"Upload a .vtt file with captions for your video" => __("Upload a .vtt file with captions for your video", "brizy"),
			...
			"Use label names for fields to calculate values, e.g., {{Label1}} + {{Label2}}. Supports types: number, radio, select, checkbox." => __("Use label names for fields to calculate values, e.g., {{Label1}} + {{Label2}}. Supports types: number, radio, select, checkbox.", "brizy"),
			...
			"User Agreement" => __("User Agreement", "brizy"),
			"User Interface" => __("User Interface", "brizy"),
			"Username" => __("Username", "brizy"),
			"Users" => __("Users", "brizy"),
			"Users & People" => __("Users & People", "brizy"),
			"VARIABLE" => __("VARIABLE", "brizy"),
			"VK" => __("VK", "brizy"),
			...
			"Vietnamese" => __("Vietnamese", "brizy"),
			"View" => __("View", "brizy"),
			"View Favorites" => __("View Favorites", "brizy"),
			"View as" => __("View as", "brizy"),
			"View on Instagram" => __("View on Instagram", "brizy"),
			"View on LinkedIn" => __("View on LinkedIn", "brizy"),
			...
			"Wave" => __("Wave", "brizy"),
			"Weather" => __("Weather", "brizy"),
			"Web Project ID" => __("Web Project ID", "brizy"),
			"Website" => __("Website", "brizy"),
			"Weekly" => __("Weekly", "brizy"),
			"Weight" => __("Weight", "brizy"),
			"WhatsApp" => __("WhatsApp", "brizy"),
			"When Finished" => __("When Finished", "brizy"),
			"When enabled, clicking pause stops the animation and slider until play is clicked" => __("When enabled, clicking pause stops the animation and slider until play is clicked", "brizy"),
			...
			"Word Wrap" => __("Word Wrap", "brizy"),
			"WordPress" => __("WordPress", "brizy"),
			"Work Phone" => __("Work Phone", "brizy"),
			"Works only in the product page" => __("Works only in the product page", "brizy"),
			"Writing" => __("Writing", "brizy"),
			"X" => __("X", "brizy"),
			"X Anchor Point" => __("X Anchor Point", "brizy"),
			"XING" => __("XING", "brizy"),
			"Y" => __("Y", "brizy"),
			"Y Anchor Point" => __("Y Anchor Point", "brizy"),
			...
			"Yearly" => __("Yearly", "brizy"),
			"YotPo Product Review" => __("YotPo Product Review", "brizy"),
			"You are about to delete a global block that is still in use. Removing it could distort affected pages, so be sure you want to continue." => __("You are about to delete a global block that is still in use. Removing it could distort affected pages, so be sure you want to continue.", "brizy"),
			...
			"You do not have any option" => __("You do not have any option", "brizy"),
			"You have no items yet" => __("You have no items yet", "brizy"),
			"You have reached the maximum number of published pages for the Free plan. Continue creating drafts or upgrade to PRO to unlock unlimited published pages." => __("You have reached the maximum number of published pages for the Free plan. Continue creating drafts or upgrade to PRO to unlock unlimited published pages.", "brizy"),
			...
			"You need the Shop Add-on to use this" => __("You need the Shop Add-on to use this", "brizy"),
			"YouTube" => __("YouTube", "brizy"),
			"Your AppId is no valid, re check and try again" => __("Your AppId is no valid, re check and try again", "brizy"),
			...
			"Your email was not sent" => __("Your email was not sent", "brizy"),
			"Your email was sent successfully" => __("Your email was sent successfully", "brizy"),
			"Your link is not correct" => __("Your link is not correct", "brizy"),
			"Youtube" => __("Youtube", "brizy"),
			"Z-index" => __("Z-index", "brizy"),
			"Zoom" => __("Zoom", "brizy"),
			"Zoom In" => __("Zoom In", "brizy"),
			"Zoom Out" => __("Zoom Out", "brizy"),
			"account via API access " => __("account via API access ", "brizy"),
			...
			"e.g. Open menu" => __("e.g. Open menu", "brizy"),
			"element" => __("element", "brizy"),
			"element .child-element" => __("element .child-element", "brizy"),
			"element { CSS goes here }" => __("element { CSS goes here }", "brizy"),
			"email" => __("email", "brizy"),
			...
			"ms" => __("ms", "brizy"),
			"none" => __("none", "brizy"),
			"official announcement." => __("official announcement.", "brizy"),
			...
			"useEditorProvider must be used within useEditorProvider" => __("useEditorProvider must be used within useEditorProvider", "brizy"),
			"username" => __("username", "brizy"),
			"value" => __("value", "brizy"),
			"viewed pages" => __("viewed pages", "brizy"),
			"was not shown" => __("was not shown", "brizy"),
			"was shown" => __("was shown", "brizy"),
			"{{Label1}}+{{Label2}}" => __("{{Label1}}+{{Label2}}", "brizy")
		));
	}
}
