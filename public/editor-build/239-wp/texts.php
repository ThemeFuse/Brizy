...
class Brizy_Public_EditorBuild_239Wp_Texts {
	public static function get_editor_texts() {
		return apply_filters('brizy_editor_config_texts', array(
			...
			"Current Query" => __("Current Query", "brizy"),
			...
			"Ecwid Cart" => __("Ecwid Cart", "brizy"),
			"Ecwid My Account" => __("Ecwid My Account", "brizy"),
			"Edit" => __("Edit", "brizy"),
			...
			"Footer Color" => __("Footer Color", "brizy"),
