...
class Brizy_Public_EditorBuild_257Beta7Wp_Texts {
	public static function get_editor_texts() {
		return apply_filters('brizy_editor_config_texts', array(
			...
			"+ 4:30 (Afghanistan, Kabul)" => __("+ 4:30 (Afghanistan, Kabul)", "brizy"),
			...
			"BlogPostMeta" => __("BlogPostMeta", "brizy"),
			"Blur" => __("Blur", "brizy"),
			"Bob" => __("Bob", "brizy"),
			"Bold" => __("Bold", "brizy"),
			...
			"BottomRight" => __("BottomRight", "brizy"),
			...
			"Display as" => __("Display as", "brizy"),
			...
			"Product Metafield" => __("Product Metafield", "brizy"),
