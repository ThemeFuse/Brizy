...
class Brizy_Public_Main {
	...
	public function _action_enqueue_preview_assets() {
		...
		wp_add_inline_script( 'brizy-preview-config', "var __CONFIG__ = ${config_json};", 'before' );
		wp_add_inline_script( 'brizy-preview-jquery', "jQuery(document).ready(function(){window.Brizy.emit('init.dom',jQuery(document.body))});", 'after' );
