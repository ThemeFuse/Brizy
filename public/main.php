...
class Brizy_Public_Main
{
    ...
    public function previewMode()
    {
	    ...
	    remove_filter('the_content', 'shortcode_unautop');// insert the compiled head and content
    ...
    {
        return is_admin(
               ) && isset($_REQUEST['action']) && $_REQUEST['action'] == 'in-front-editor' && ($post ? $post->uses_editor(
            ) : true);
    }
