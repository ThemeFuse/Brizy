<div class="wrap brz-wrap-demodata">
    ...
    <script id="brz-demo-modal-content-success" type="text/template">
        <div class="brz-demo-modal-content-response">
            ...
            <a href="<?php echo admin_url('post.php?action=in-front-editor&post=5'); ?>" class="button button-primary js-demo-data-close-modal brz-demo-modal-content-button"><?php echo $l10n['t15']; ?></a>
        </div>
    </script>
