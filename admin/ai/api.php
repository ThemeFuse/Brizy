...
/**
 * AI API handler for Brizy admin
 * Manages AI session creation, data fetching, and website import from Brizy's AI service.
 */
class Brizy_Admin_Ai_Api {
    ...
    /**
     * AJAX Handler: Step 1 of the AI flow.
    ...
    /**
     * AJAX Handler: Step 2 of the AI flow.
    ...
    /**
     * AJAX Handler: Step 3 of the AI flow.
