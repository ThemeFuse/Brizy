jQuery(document).ready(function ($) {
    ...
    (function () {
        var classicEditorContainer = $('.brizy-buttons.is-classic-editor');

        if (!classicEditorContainer.length) {
            return;
        }
        ...
        if (typeof Brizy_Admin_Data === 'undefined' ||
            ...
            !Object.keys(Brizy_Admin_Data.aiActions).length) {
            return;
        }

        var isLicenseValid = typeof Brizy_Admin_Data.isLicenseValid !== 'undefined' ? Brizy_Admin_Data.isLicenseValid : false;
        var buttonStyle = isLicenseValid
            ? 'font-size: 11px; font-weight: 500; padding: 5px 10px; height: auto; background: rgb(30, 58, 138); color: rgb(255, 255, 255); border: none; border-radius: 3px; transition: 0.3s cubic-bezier(0.4, 0, 0.2, 1); display: inline-flex; align-items: center; gap: 4px; white-space: nowrap; align-self: flex-start; box-shadow: rgba(30, 58, 138, 0.2) 0px 1px 2px; margin-left: 8px; cursor: pointer;'
            : 'font-size: 11px; font-weight: 500; padding: 5px 10px; height: auto; background: rgb(156, 163, 175); color: rgb(255, 255, 255); border: none; border-radius: 3px; transition: 0.3s cubic-bezier(0.4, 0, 0.2, 1); display: inline-flex; align-items: center; gap: 4px; white-space: nowrap; align-self: flex-start; box-shadow: rgba(156, 163, 175, 0.2) 0px 1px 2px; margin-left: 8px; cursor: not-allowed; opacity: 0.6;';

        var generateAiButton = $('<a class="button button-primary brz-ai-button js-open-ai-selection-modal" href="#" title="' + (Brizy_Admin_Data.l10n.aiGenerateButton || 'Generate With Brizy - AI') + '" style="' + buttonStyle + '">' +
            '<span>' + (Brizy_Admin_Data.l10n.aiGenerateButton || 'Generate With Brizy - AI') + '</span>' +
        ...
        if (isLicenseValid) {
            ...
            generateAiButton.on('click', function (e) {
                e.preventDefault();
        ...
        classicEditorContainer.append(generateAiButton);
    })();
