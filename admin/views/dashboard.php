...
<p class="brizy-dashboard-widget-footer">
    ...
    |
    <a href="https://www.brizy.io/brizy-pro-pricing/?utm_source=wp-menu&utm_campaign=gopro&utm_medium=wp-dash/" target="_blank" class="brizy-dashboard-widget-footer__go-pro">
		<?php _e( 'Go PRO', 'brizy' ); ?>&nbsp;
