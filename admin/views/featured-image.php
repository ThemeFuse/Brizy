<div class="brizy-featured-image hide-if-no-js">
    <div class="wrapper">
        ...
        <div class="focal-point" style="left: <?php echo esc_attr( $focalPoint['x'] ); ?>%; top: <?php echo esc_attr( $focalPoint['y'] ); ?>%;"></div>
    ...
    <input type="hidden" id="_thumbnail_focal_point_x" name="_thumbnail_focal_point_x" value="<?php echo esc_attr( $focalPoint['x'] ); ?>"/>
    <input type="hidden" id="_thumbnail_focal_point_y" name="_thumbnail_focal_point_y" value="<?php echo esc_attr( $focalPoint['y'] ); ?>"/>
</div>
