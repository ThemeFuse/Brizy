...
class Brizy_Admin_Layouts_Api extends Brizy_Admin_AbstractApi {
	...
	public function actionGetLayoutByUid() {
		...
		try {
			...
			$this->success( Brizy_Editor_Layout::postData( Brizy_Editor_Layout::get( $layout ) ) );
	...
	public function actionGetLayouts() {
		...
		try {
			...
			$layouts = $layoutManager->getAllLayouts(  array(), array(
					'uid',
					'meta'
				)
			);
	...
	public function actionCreateLayout() {
		...
		try {
			...
			$this->success( Brizy_Editor_Layout::postData( $layout ) );
	...
	private function getLayout( $id ) {
		$postId = $this->getLayoutIdByUid( $id );
