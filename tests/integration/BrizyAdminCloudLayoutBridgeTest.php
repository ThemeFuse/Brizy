...
class BrizyAdminCloudLayoutBridgeTest extends \Codeception\TestCase\WPTestCase {
	...
	public function testImportInvalidMediaLayout() {

		$this->expectException( \Exception::class );

		$layoutObserver = $this->prophesize( Brizy_Editor_Layout::class );
