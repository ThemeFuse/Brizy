...
class Brizy_Content_Providers_FreeProvider extends Brizy_Content_Providers_AbstractProvider {
	public function __construct() {
		...
		$this->registerPlaceholder( new Brizy_Content_Placeholders_Simple( '', 'menu_current_item', function ( $context, $contentPlaceholder ) {
...
//	            }
		...
		$this->registerPlaceholder( new Brizy_Content_Placeholders_Simple( __( 'WooCommerce Notices', 'brizy' ), 'editor_woo_notice', function () use ( &$noticeHtml ) {
		...
		$this->registerPlaceholder( new Brizy_Content_Placeholders_Simple( '', 'editor_nonce', function ( Brizy_Content_Context $context, ContentPlaceholder $contentPlaceholder ) {
