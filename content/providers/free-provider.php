...
class Brizy_Content_Providers_FreeProvider extends Brizy_Content_Providers_AbstractProvider
{
    ...
    {
        $placeholders = parent::getAllPlaceholders(); // TODO: Change the autogenerated stub
        $placeholders[] = new Brizy_Content_Placeholders_Simple('Internal Display Block By User Role', 'display_by_roles', function (Brizy_Content_Context $context, ContentPlaceholder $contentPlaceholder) {
        ...
        $placeholders[] = new Brizy_Content_Placeholders_ImageTitleAttribute('Internal Title Attributes', 'brizy_dc_image_title');
        $placeholders[] = new Brizy_Content_Placeholders_ImageAltAttribute('Internal Alt Attributes', 'brizy_dc_image_alt');
        $placeholders[] = new Brizy_Content_Placeholders_UniquePageUrl('Uniquer page url', 'brizy_dc_current_page_unique_url');
        $placeholders[] = new Brizy_Content_Placeholders_Simple('WP Language', 'brizy_dc_page_language', get_locale());
        $placeholders[] = new Brizy_Content_Placeholders_Simple('Ajax Url', 'brizy_dc_ajax_url', admin_url('admin-ajax.php'));
        $placeholders[] = new Brizy_Content_Placeholders_Permalink();
        $placeholders[] = new Brizy_Content_Placeholders_Simple('', 'post_*', function ($context, $contentPlaceholder) {
        ...
        $placeholders[] = new Brizy_Content_Placeholders_Simple('', 'editor_navigation', function ($context, $contentPlaceholder) {

            $attrs = $contentPlaceholder->getAttributes();

            return $attrs['name'] ? wp_nav_menu(array('menu' => $attrs['name'], 'echo' => false)) : '';
        });
        $placeholders[] = new Brizy_Content_Placeholders_Simple('', 'editor_post_field', function ($context, $contentPlaceholder) {
        ...
        $placeholders[] = new Brizy_Content_Placeholders_Simple('', 'editor_post_info', function () {
        ...
        $placeholders[] = new Brizy_Content_Placeholders_Simple('', 'editor_posts', function ($context, $contentPlaceholder) {
        ...
        $placeholders[] = new Brizy_Content_Placeholders_Simple('Product Page', 'editor_product_page', function ($context, $contentPlaceholder) {
...
//	            }
        ...
        $placeholders[] = new Brizy_Content_Placeholders_Simple('Products Page', 'editor_product_products', function ($context, $contentPlaceholder) {
        ...
        $placeholders[] = new Brizy_Content_Placeholders_Simple('', 'editor_product_default_cart', function () {
            return do_shortcode('[woocommerce_cart]');
        });
        $placeholders[] = new Brizy_Content_Placeholders_Simple('', 'editor_product_checkout', function () {
            return do_shortcode('[woocommerce_checkout]');
        });
        $placeholders[] = new Brizy_Content_Placeholders_Simple('', 'editor_product_my_account', function () {
            return do_shortcode('[woocommerce_my_account]');
        });
        $placeholders[] = new Brizy_Content_Placeholders_Simple('', 'editor_product_order_tracking', function () {
