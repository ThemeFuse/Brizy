...
class Brizy_Content_Providers_FreeProvider extends Brizy_Content_Providers_AbstractProvider
{
    public function __construct()
    {
        ...
        $this->registerPlaceholder(
            new Brizy_Content_Placeholders_ImageAltAttribute(
                __('Internal Alt Attributes', 'brizy'),
                'brizy_dc_image_alt'
            )
        );
        $this->registerPlaceholder(
            new Brizy_Content_Placeholders_UniquePageUrl(
                __('Uniquer page url', 'brizy'),
        ...
        $this->registerPlaceholder(
            new Brizy_Content_Placeholders_Simple('', 'menu_current_item', function ($context, $contentPlaceholder) {
        ...
        $this->registerPlaceholder(
            new Brizy_Content_Placeholders_Simple('', 'editor_post_field', function ($context, $contentPlaceholder) {
                ...
                $post = ($context = Brizy_Content_ContextFactory::getGlobalContext()) ? $context->getWpPost(
                ) : get_post();
