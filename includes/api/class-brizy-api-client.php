...
class Brizy_API_Client {

	private $access_token;

	public function __construct( Brizy_API_Access_Token $token ) {
	...
	public function update_project( Brizy_API_Project $project, array $data ) {
	...
	public function create_page( $project_id, Brizy_API_Page $page ) {
		return $this->post( "projects/$project_id/pages", $page->export() )->get_body();
	}

	public function update_page( $project_id, $page_id, Brizy_API_Page $page ) {
