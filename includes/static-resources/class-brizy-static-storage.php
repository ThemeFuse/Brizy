...
class Brizy_Static_Storage {
	private $uploads;
	private $res;

	const DIR = 'static';

	public static function get( Brizy_Static $resource ) {
		return new self( $resource );
	}

	protected function __construct( Brizy_Static $resource ) {
		$this->uploads = new Brizy_Uploads_Dir();
		$this->res     = $resource;
	}
	...
	protected function validate_resource( Brizy_Static $res ) {
	...
	public static function resource_url( Brizy_Static $res ) {
		return self::get_uri()
		       . '/'
		       . $res->get_id()
		       . '-'
	...
	public static function resource_path( Brizy_Static $res ) {
