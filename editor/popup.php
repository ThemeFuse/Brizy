...
class Brizy_Editor_Popup extends Brizy_Editor_Post {
	...
	/**
	 * Brizy_Editor_Popup constructor.
	 *
	 * @param $wp_post_id
	 * @param null $uid
	 *
	...
	public function isGlobalPopup() {
		return $this->get_wp_post() instanceof WP_Post && $this->get_wp_post()->post_type == Brizy_Admin_Popups_Main::CP_GLOBAL_POPUP;
	}

	public function isSavedPopup() {
		return $this->get_wp_post() instanceof WP_Post && $this->get_wp_post()->post_type == Brizy_Admin_Popups_Main::CP_SAVED_POPUP;
	}
