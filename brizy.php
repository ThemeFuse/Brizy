...
define( 'BRIZY_VERSION', '2.7.3' );
define( 'BRIZY_MINIMUM_PRO_VERSION', '2.7.0' );
define( 'BRIZY_MINIMUM_COMPILER_VERSION', '315-wp' );
define( 'BRIZY_RECOMPILE_TAG', 1752844773 );
define( 'BRIZY_EDITOR_VERSION', BRIZY_DEVELOPMENT ? 'dev' : '325-beta1-wp' );
define( 'BRIZY_SYNC_VERSION', '325-beta1' );
