...
define( 'BRIZY_VERSION', '2.7.4' );
define( 'BRIZY_MINIMUM_PRO_VERSION', '2.7.0' );
define( 'BRIZY_MINIMUM_COMPILER_VERSION', '315-wp' );
define( 'BRIZY_RECOMPILE_TAG', 1753266850 );
define( 'BRIZY_EDITOR_VERSION', BRIZY_DEVELOPMENT ? 'dev' : '326-beta4-wp' );
define( 'BRIZY_SYNC_VERSION', '326-beta4' );
