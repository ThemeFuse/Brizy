...
define('BRIZY_VERSION', '2.4.38');
define('BRIZY_MINIMUM_PRO_VERSION', '2.4.15');
define('BRIZY_MINIMUM_COMPILER_VERSION', '275-wp');
define('BRIZY_EDITOR_VERSION', BRIZY_DEVELOPMENT ? 'dev' : '276-beta10-wp' );
define('BRIZY_SYNC_VERSION', '276-beta10');
