...
define('BRIZY_VERSION', '2.4.14');
define('BRIZY_MINIMUM_PRO_VERSION', '2.4.12');
define('BRIZY_EDITOR_VERSION', BRIZY_DEVELOPMENT ? 'dev' : '250-wp' );
define('BRIZY_SYNC_VERSION', '500');
