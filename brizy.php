...
define( 'BRIZY_VERSION', '2.6.15' );
define( 'BRIZY_MINIMUM_PRO_VERSION', '2.4.15' );
define( 'BRIZY_MINIMUM_COMPILER_VERSION', '313-wp' );
define( 'BRIZY_EDITOR_VERSION', BRIZY_DEVELOPMENT ? 'dev' : '314-beta0-wp' );
define( 'BRIZY_SYNC_VERSION', '314-beta0' );
