    ...
    stages {
        ...
        stage('Prepare SVN') {
            steps {
                ...
                sh 'cd ' + params.brizySvnPath + '/trunk && rm -rf ./vendor/select2/select2/docs'
                sh 'cd ' + params.brizySvnPath + '/trunk && rm -rf ./vendor/select2/select2/tests'
                sh 'cd ' + params.brizySvnPath + '/trunk && rm -rf ./vendor/shortpixel/shortpixel-php/test'
